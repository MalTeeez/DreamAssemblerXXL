...
> * ae2stuff
# Updated - AE2FluidCraft-Rework - 1.4.120-gtnh --> 1.5.88-gtnh
**Full Changelog**: https://github.com/GTNewHorizons/AE2FluidCraft-Rework/compare/1.4.120-gtnh...1.5.88-gtnh

## What's Changed:
>* Adapt to GUIColor changes by @Kogepan229 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/439 (1.5.88-gtnh)
...
>* Fix crash when draining Certus Quartz Tank with Large Steel Fluid Cell by @Luca-Guettinger in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/438 (1.5.84-gtnh)
>* remove by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/433 (1.5.83-gtnh)
>* optimize terminal packet by @czqwq in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/431 (1.5.82-gtnh)
>* Allow decode drops into fluid by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/430 (1.5.81-gtnh)
>* Add fluid packet description by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/429 (1.5.81-gtnh)
>* Cell Restriction rework by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/428 (1.5.81-gtnh)
>* Fluid Planes by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/424 (1.5.80-gtnh)
...
>* Improve level terminal button clarity by @Kogepan229 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/417 (1.5.73-gtnh)
>* Legacy stack type by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/416 (1.5.72-gtnh)
>* Fix storage bus not read fluid in configurated dual interface by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/415 (1.5.71-gtnh)
>* Fix storage bus not read fluid in configurated dual interface by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/415 (1.5.70-gtnh)
>* fix: correct error in TileFluidPacketDecoder closeInventory by @CaelixOrbit in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/414 (1.5.69-gtnh)
>* allow opencomputer robot placement for multiparts by @MarkinoTeck in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/412 (1.5.67-gtnh)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/411 (1.5.66-gtnh)
>* Fix magnet filter only checking first configured slot by @clawdbot-silly-waddle in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/410 (1.5.65-gtnh)
...
>* Adapt to AE2 Stack Type API changes by @Kogepan229 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/375 (1.5.57-gtnh)
>* Fix storage name fluid emitter by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/400 (1.5.55-gtnh)
>* fix storage name on exp by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/399 (1.5.54-gtnh)
>* Add priority in fluid storage bus tooltip  by @Eldrinn-Elantey in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/398 (1.5.52-gtnh)
...
>* Updated Super Stock Replenisher block texture by @Ranzuu in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/386 (1.5.39-gtnh)
...
>* Universal GUI by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/340 (1.5.30-gtnh)
>* [Memory-opti:fix leak] Fix world leak in SPacketMEUpdateBuffer by @Alexdoru in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/374 (1.5.29-gtnh)
>* replenisher fixes, 2.8 2.9 by @lc-1337 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/373 (1.5.27-gtnh)
...
>* remove IPatchedTextureAtlasSprite.markNeedsAnimationUpdate() calls by @danyadev in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/357 (1.5.22-gtnh)
>* don't integrate certus quartz tank with waila if WailaPlugins is present by @danyadev in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/361 (1.5.22-gtnh)
>* Resolves Multi-Fluid Distribution Limit Check Only Evaluating First 5 Partition Slots by @Litten95 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/362 (1.5.22-gtnh)
...
# Updated - AFSU - 1.3.1-GTNH --> 1.3.2-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/AFSU/compare/1.3.1-GTNH...1.3.2-GTNH

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/AFSU/pull/7 (1.3.2-GTNH)

# Updated - AdventureBackpack2 - 1.3.13-GTNH --> 1.4.21-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/AdventureBackpack2/compare/1.3.13-GTNH...1.4.21-GTNH

## What's Changed:
>* Update Portuguese localization for adventure backpack by @Xlr11 in https://github.com/GTNewHorizons/AdventureBackpack2/pull/50 (1.4.21-GTNH)
>* Compat with TinkersConstruct/modern-toolstation-behavior by @FrostyFire1 in https://github.com/GTNewHorizons/AdventureBackpack2/pull/51 (1.4.20-GTNH)
>* Allow scroll-wheel item transfer in backpack GUI by @Luca-Guettinger in https://github.com/GTNewHorizons/AdventureBackpack2/pull/49 (1.4.19-GTNH)
>* Fix jetpacks not working by @Caedis in https://github.com/GTNewHorizons/AdventureBackpack2/pull/48 (1.4.18-GTNH)
>* Partial revert of #37 and Crafting Dupe Glitch Fix by @UltraProdigy in https://github.com/GTNewHorizons/AdventureBackpack2/pull/47 (1.4.17-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/AdventureBackpack2/pull/46 (1.4.16-GTNH)
>* Include New Tools in Tool Cycling by @UltraProdigy in https://github.com/GTNewHorizons/AdventureBackpack2/pull/45 (1.4.15-GTNH)
>* Restore previous spawn when using Sleeping Bag from Backpack placed in world by @wlhlm in https://github.com/GTNewHorizons/AdventureBackpack2/pull/37 (1.4.14-GTNH)
>* Remove Villager backpack trade from Villagers that locks trading till MV/Alum by @imTheSupremeOne in https://github.com/GTNewHorizons/AdventureBackpack2/pull/44 (1.4.12-GTNH)
>* Fix adventure backpack GUI closing on double-click merging item stacks in inventory by @devpikachu in https://github.com/GTNewHorizons/AdventureBackpack2/pull/42 (1.4.12-GTNH)
>* Rename methods to clearly indicate that they have side effects by @devpikachu in https://github.com/GTNewHorizons/AdventureBackpack2/pull/41 (1.4.9-GTNH)
>* Update build script by @devpikachu in https://github.com/GTNewHorizons/AdventureBackpack2/pull/43 (1.4.9-GTNH)
>* Support Witchery's Sticky Items potion by @wlhlm in https://github.com/GTNewHorizons/AdventureBackpack2/pull/38 (1.4.7-GTNH)
>* Add tooltip to equip/unequip button in GUIs by @wlhlm in https://github.com/GTNewHorizons/AdventureBackpack2/pull/36 (1.4.6-GTNH)
...
# Updated - AkashicTome - 1.2.6 --> 1.2.7
**Full Changelog**: https://github.com/GTNewHorizons/AkashicTome/compare/1.2.6...1.2.7

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/AkashicTome/pull/21 (1.2.7)

# Updated - AlchemyGrate - 1.3.1-GTNH --> 1.3.2-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/AlchemyGrate/compare/1.3.1-GTNH...1.3.2-GTNH

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/AlchemyGrate/pull/8 (1.3.2-GTNH)

# Updated - Amazing-Trophies - 1.3.8 --> 1.4.2
**Full Changelog**: https://github.com/GTNewHorizons/Amazing-Trophies/compare/1.3.8...1.4.2

## What's Changed:
>* Fix two world leaks by @Alexdoru in https://github.com/GTNewHorizons/Amazing-Trophies/pull/20 (1.4.2)
...
>* Be more lazy by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1794 (2.1.30)
>* Match modern hand swap animations by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1816 (2.1.30)
>* Add double_plant handling to match modern by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1815 (2.1.30)
...
>* Fixes crash with FFP shader linking by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1780 (2.1.27)
>* Resolve generic compressed image formats by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1781 (2.1.27)
>* Properly do the fml/rfb registration for IsbrhTessellatorAbuseTransformer by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1770 (2.1.26)
>* Add view bobbing mode by @Apis035 in https://github.com/GTNewHorizons/Angelica/pull/1761 (2.1.26)
>* Clear block and item renderlist on resource reload by @tiffit in https://github.com/GTNewHorizons/Angelica/pull/1773 (2.1.26)
>* Fix DH framebuffer UNSUPPORTED after resize by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1741 (2.1.26)
>* Stop burying the error due to things catching RuntimeExceptions.... by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1767 (2.1.25)
>* Register later by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1763 (2.1.24)
>* Minecraft is a dirty dirty liar. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1764 (2.1.24)
>* Display list stuff by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1750 (2.1.24)
>* Fix crash on windows by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1766 (2.1.24)
>* Add cached block item renderer by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1730 (2.1.24)
>* Handle recoverable block render failures in celeritas meshing by @Kai-Z-JP in https://github.com/GTNewHorizons/Angelica/pull/1705 (2.1.23)
>* Fix skeleton legs from being jammed into their pelvis by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1747 (2.1.23)
>* Adjust options screen width by @Apis035 in https://github.com/GTNewHorizons/Angelica/pull/1748 (2.1.23)
>* Properly end the dynamic lighting profiler section by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1751 (2.1.23)
>* Misc fixes - Journeymap and Xaeros by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1756 (2.1.23)
>* Stops draw/startDrawing in ISBRH by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1759 (2.1.23)
>* [NTM:Space] Fix mixins in obfuscated environment by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1738 (2.1.22)
>* Add RGB color system by @alppp in https://github.com/GTNewHorizons/Angelica/pull/1669 (2.1.22)
>* Fix Already tesselating logs by @czqwq in https://github.com/GTNewHorizons/Angelica/pull/1729 (2.1.22)
>* Adjust IDynamicLightProducer to allow passing an ItemStack parameter by @ABKQPO in https://github.com/GTNewHorizons/Angelica/pull/1734 (2.1.22)
>* Detect vanilla AO at a higher level by @branan in https://github.com/GTNewHorizons/Angelica/pull/1733 (2.1.22)
>* Compact CTM Fixes by @Ruling-0 in https://github.com/GTNewHorizons/Angelica/pull/1726 (2.1.22)
>* add auto emissive overlay for any block by @VortexSo4 in https://github.com/GTNewHorizons/Angelica/pull/1710 (2.1.22)
...
>* Add targeting of snow-covered blocks. by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1696 (2.1.20)
>* Increase MAX_COLOR_BUFFERS limit to 32 by @SpacEagle17 in https://github.com/GTNewHorizons/Angelica/pull/1704 (2.1.20)
>* remove ctm guide as it is worse than wiki by @VortexSo4 in https://github.com/GTNewHorizons/Angelica/pull/1706 (2.1.20)
>* Fix stale uniforms when switching shader program by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1715 (2.1.20)
>* Add Cosmetic Armor support for Dynamic Lights by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/1708 (2.1.20)
>* Fix terrible performance on Intel by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1718 (2.1.20)
>* Maybe fix DragonAPI on OSX - take two by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1689 (2.1.19)
>* Fix CTM to not spread to nearby TEs by @Yoshy2002 in https://github.com/GTNewHorizons/Angelica/pull/1695 (2.1.19)
>* fix(iris): implement full GL alpha test by @Kai-Z-JP in https://github.com/GTNewHorizons/Angelica/pull/1673 (2.1.18)
>* Add "Mods Only" Dynamic FOV option by @MellowArpeggiation in https://github.com/GTNewHorizons/Angelica/pull/1680 (2.1.18)
>* NTM:Space compat rework and update by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1675 (2.1.18)
>* always request 0.9.0+ GTNHLib version when a player has an outdated version by @danyadev in https://github.com/GTNewHorizons/Angelica/pull/1672 (2.1.18)
>* Add FlatteningMap and EntityFlatteningMap by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1635 (2.1.18)
>* Automate the collection of legacy IDs for very old shaderpacks. by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1631 (2.1.18)
>* AE2 Crash Fix by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1684 (2.1.18)
>* Fix infinite extent AABB crash w/ kotlin, and ensure proper sizing/padding on VAO/VBO snapshots. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1687 (2.1.18)
>* Standalone GLSM mod - Umbra by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1642 (2.1.17)
>* DH: Fix mismatch from upstream for solas shaders by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1645 (2.1.17)
>* Fix some issues someone was having with nixos by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1647 (2.1.17)
>* fix two world client memory leaks by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1650 (2.1.17)
>* Disable clouds when shaders are active by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1648 (2.1.17)
>* Always render clouds late for shaders by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1649 (2.1.17)
>* Various fixes by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1652 (2.1.17)
>* Update zh_CN.lang by @NealDeal34 in https://github.com/GTNewHorizons/Angelica/pull/1623 (2.1.17)
>* add CTM guide by @VortexSo4 in https://github.com/GTNewHorizons/Angelica/pull/1667 (2.1.17)
>* Don't advance buffer positions for Material shininess in GLSM by @Cleptomania in https://github.com/GTNewHorizons/Angelica/pull/1668 (2.1.17)
>* Fix class circularity error with early redirector by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1670 (2.1.17)
>* Load modern block properties by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1626 (2.1.17)
>* Fix cached item in RenderItemFrame leaking both world client and server by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1659 (2.1.17)
>* Adapt shader block id override for Angelica 2.x by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1601 (2.1.16)
>* Match OpenGL Buffer Behavior for glGet by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1637 (2.1.16)
>* Implement compact ctm by @VortexSo4 in https://github.com/GTNewHorizons/Angelica/pull/1636 (2.1.16)
>* Compact CTM Fix by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1640 (2.1.16)
>* Safely handle off client thread crash reports/glGetString by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1630 (2.1.15)
>* Handle GL_QUAD_STRIP in legacy conversion by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1629 (2.1.15)
>* Port shadow translucent (aka shadow_water) from upstream by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1628 (2.1.15)
>* Pass mc_Entity like upstream does by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1627 (2.1.15)
>* Do a similar fix as MixinDroppedItemGlintEdges to held items by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1632 (2.1.15)
>* fix: correctly handle cross-chunk TileEntity render bounds by @Kai-Z-JP in https://github.com/GTNewHorizons/Angelica/pull/1607 (2.1.14)
>* Narrow another overly broad transformer exclusion by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1609 (2.1.14)
>* Fix other dynamic uniforms not updating properly by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1610 (2.1.14)
>* More Double overloads by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1613 (2.1.14)
>* Get rid of some allocations, and use immutable variants for the suppliers by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1612 (2.1.14)
>* Defer client attributes.  They're uploaded/handled elsewhere.  Should fix a crash on j8/lwjgl2 by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1618 (2.1.14)
>* Shader fixes by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1619 (2.1.14)
>* Better horse support by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1599 (2.1.14)
>* Create new deferred overlay system to fix z-fighting issues by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1605 (2.1.14)
>* Only run the logic on bop grass (fix my mod bugging out) by @JohnButlerThird in https://github.com/GTNewHorizons/Angelica/pull/1620 (2.1.14)
>* Fix item reset hopefully for the last time by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1621 (2.1.14)
>* Return `phaseChangeNotifier` by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1596 (2.1.13)
>* Update alpha test to hopefully work with RTM and AE2 by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1597 (2.1.13)
>* Handle method handles in invokedynamic by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1598 (2.1.13)
>* fix: crash when client-side vertex attrib pointers are used in core profile by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1602 (2.1.13)
>* Handle GL_POLYGON in legacy conversion by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1603 (2.1.13)
>* FINE, we'll work with java8/forge. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1606 (2.1.13)
>* Fix sky lighting on drawCrossSquare rendered blocks. by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1576 (2.1.12)
>* External Redirector API by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1580 (2.1.12)
>* Fix crash with fancy block particles. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1591 (2.1.12)
>* Blur Compat by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1593 (2.1.12)
>* Centers the Wither Armor by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1590 (2.1.12)
>* Fix missing glGetTexImage method crash when using XaerosWorldMap by @12411234 in https://github.com/GTNewHorizons/Angelica/pull/1592 (2.1.12)
>* Pass texturemap to composite shader and honor texture replacements by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1589 (2.1.12)
>* Make the mod no-op on server by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1574 (2.1.11)
>* Fix blend leak in BatchingFontRenderer by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1575 (2.1.11)
>* Distant Horizons shader support by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1553 (2.1.10)
>* Fixes 3rd person enchant glints z-fighting with the item model by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1569 (2.1.9)
>* Various fixes by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1571 (2.1.9)
>* Clear cache on reload shaders by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1559 (2.1.8)
>* Ban GL usage. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1560 (2.1.8)
>* More pass throughs by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1561 (2.1.8)
>* ASM Hook Compat by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1562 (2.1.8)
>* Change compat config by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1563 (2.1.8)
>* Fix alpha test by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1567 (2.1.8)
>* Fix modded enchant glints not being animated by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1566 (2.1.8)
>* Maybe fix botania mana pool rendering by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1558 (2.1.8)
>* Additions by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1557 (2.1.7)
>* Add a second profiles button to Angelica by @SpacEagle17 in https://github.com/GTNewHorizons/Angelica/pull/1555 (2.1.7)
>* Supernova Support by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1552 (2.1.6)
>* Misc fixes by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1550 (2.1.6)
>* Log once instead of every time. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1520 (2.1.5)
>* use classnode name in CeleritasBlockTransform by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1521 (2.1.5)
>* Further em dash removal by @DeathFuel in https://github.com/GTNewHorizons/Angelica/pull/1526 (2.1.5)
>* Make fog controls work with BoP fog by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/1539 (2.1.5)
>* use mixin to change the f3 text background instead of canceling the event by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1537 (2.1.5)
>* Fix mob's eyes from z-fighting by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1519 (2.1.5)
>* GLSM Extraction by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1527 (2.1.5)
>* Lwjgl3 support by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1544 (2.1.5)
>* Fix font alpha test transparency and BlockGrass subclass rendering with Celeritas AO by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1547 (2.1.5)
>* Add some missing glGetTexEnv* by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1503 (2.1.4)
>* Fix matching across newlines by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1505 (2.1.4)
>* Add glTexImage3D with IntBuffer by @DarkShadow44 in https://github.com/GTNewHorizons/Angelica/pull/1506 (2.1.4)
>* Optimize Streaming by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1515 (2.1.4)
>* Improvements by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1516 (2.1.4)
>* Replace compatibility mode texture formats by @DeathFuel in https://github.com/GTNewHorizons/Angelica/pull/1518 (2.1.4)
>* Split MixinRenderManager into two for DAPI compat by @MalTeeez in https://github.com/GTNewHorizons/Angelica/pull/1480 (2.1.3)
>* Better font rendering MC parity + book mode by @DeathFuel in https://github.com/GTNewHorizons/Angelica/pull/1489 (2.1.3)
>* UI Fix by @DeathFuel in https://github.com/GTNewHorizons/Angelica/pull/1492 (2.1.3)
>* Maybe make Xaero work on j8 by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1494 (2.1.3)
>* Fix overwrite visibility crash by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1499 (2.1.3)
>* Add missing overloads by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1500 (2.1.3)
>* Botania fix take two by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1501 (2.1.3)
>* Add missing overload by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1495 (2.1.3)
>* More core profile followons by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1464 (2.1.2)
>* Replace panorama with modern opengl equivalent by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1466 (2.1.2)
>* Fix load -> enter -> leave: panorama rendering, cleanup state & fix test by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1467 (2.1.2)
>* Emulate glLineWidth on core using geom shaders by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1468 (2.1.2)
>* refactor CeleritasBlockTransform by @danyadev in https://github.com/GTNewHorizons/Angelica/pull/1455 (2.1.2)
>* Fix intel tests by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1442 (2.1.2)
>* Snapshot VAO/VBO data during display list compilation, like mesa does. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1473 (2.1.2)
>* So secret you can't see them. by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1475 (2.1.2)
>* Actually sleep in FPS limiter by @ah-OOG-ah in https://github.com/GTNewHorizons/Angelica/pull/1471 (2.1.2)
>* Lazy init entity lighting maps by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1476 (2.1.2)
...
>* Fixes for backhand compat by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1437 (2.1.0)
>* fix rfb exclusions by @Alexdoru in https://github.com/GTNewHorizons/Angelica/pull/1440 (2.1.0)
>* Target OpenGL 3.3 core profile by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1412 (2.1.0)
>* Fixes by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1434 (2.0.0-alpha25)
...
>* Add unknown blend state and BufferBlendOverride handling from modern Iris by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1408 (2.0.0-alpha22)
>* Remove TODO from ProgramId by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1409 (2.0.0-alpha22)
>* Maybe fix holo inventory again - v2 - final.xlsx by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1413 (2.0.0-alpha22)
...
>* Add runtime toggle for HUD Caching, and disable by default (for now at least) by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1374 (2.0.0-alpha20)
>* Display List Refactor by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1360 (2.0.0-alpha19)
...
>* Fix deadlock in CTMUtils by @guusw in https://github.com/GTNewHorizons/Angelica/pull/1189 (2.0.0-alpha14)
>* Fix hud flickering by @sisyphussy in https://github.com/GTNewHorizons/Angelica/pull/1325 (2.0.0-alpha14)
...
>* [Shaders] Fix NTM:Space sunset not rendering {2.0 regression} by @kotmatross28729 in https://github.com/GTNewHorizons/Angelica/pull/1275 (2.0.0-alpha12)
>* Lighting fixes by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1306 (2.0.0-alpha12)
>* Fix currentRenderedItemId for ItemBlocks by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1307 (2.0.0-alpha12)
>* Improve behavior of Celeritas-based lighting pipeline by @embeddedt in https://github.com/GTNewHorizons/Angelica/pull/1296 (2.0.0-alpha11)
>* No more OpenGLHelper by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1297 (2.0.0-alpha11)
>* Respect shader render layer overrides by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1293 (2.0.0-alpha10)
>* Properly cleanup by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1294 (2.0.0-alpha10)
>* Custom images, textures, SSBO,  SmoothLightPipeline & UseSeparateAO by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1284 (2.0.0-alpha9)
>* Add support for dimension.properties by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1283 (2.0.0-alpha9)
...
>* Fix OSX F3 crash by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1264 (2.0.0-alpha6)
>* Better video settings search by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1254 (2.0.0-alpha5)
>* Dynamic light improvements by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1255 (2.0.0-alpha5)
...
>* Update entity.properties formatting by @Eclipse-Sol in https://github.com/GTNewHorizons/Angelica/pull/1197 (2.0.0-alpha1)
>* Why were these bypassing GLSM? by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1207 (2.0.0-alpha1)
>* Move EntityID shader mixin to shaders, and optimize by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1208 (2.0.0-alpha1)
>* Random menu backgrounds by @wlhlm in https://github.com/GTNewHorizons/Angelica/pull/1217 (2.0.0-alpha1)
>* Set defaults once per TE pass instead of once per TE by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1213 (2.0.0-alpha1)
>* Text cutoff quickfix by @DeathFuel in https://github.com/GTNewHorizons/Angelica/pull/1216 (2.0.0-alpha1)
>* Disable custom fonts with GraphicsEnvironment.isHeadless() by @DeathFuel in https://github.com/GTNewHorizons/Angelica/pull/1218 (2.0.0-alpha1)
>* Better Splash support by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1220 (2.0.0-alpha1)
>* Add more menu backgrounds by @wlhlm in https://github.com/GTNewHorizons/Angelica/pull/1225 (2.0.0-alpha1)
>* Angelica 2.0.0 - alpha Celeritas by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/1221 (2.0.0-alpha1)
...
# Updated - AngerMod - 0.9.0 --> 1.0.6
**Full Changelog**: https://github.com/GTNewHorizons/AngerMod/compare/0.9.0...1.0.6

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/AngerMod/pull/18 (1.0.6)
>* Add @return tags to public methods documentation by @Eldrinn-Elantey in https://github.com/GTNewHorizons/AngerMod/pull/17 (1.0.5)
...
>* Fix Pattern Repeater StackOverflow with loops by @Redderpears in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1338 (rv3-beta-969-GTNH)
>* fix wireless waila power draw by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1339 (rv3-beta-968-GTNH)
>* Delete redundant color call from lang files by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1341 (rv3-beta-968-GTNH)
>* fixes Wireless Manager by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1336 (rv3-beta-966-GTNH)
>* Add Wireless Terminal Network Manager by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1268 (rv3-beta-964-GTNH)
>* Fix pattern repeater CME by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1332 (rv3-beta-960-GTNH)
>* Fix GuiColorizer button appearance by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1331 (rv3-beta-960-GTNH)
>* fix Wireless connector lose custom name on migration by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1334 (rv3-beta-960-GTNH)
>* fix Ghost patterns from recursive by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1329 (rv3-beta-959-GTNH)
>* Fix PacketPatternValueSet by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1328 (rv3-beta-958-GTNH)
>* Fix simulate false positive on some cases by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1299 (rv3-beta-958-GTNH)
>* Add tinting to all AE2 GUI's by @ko-lja in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1243 (rv3-beta-957-GTNH)
>* add VirtualMEPhantomSlotPrecise by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1321 (rv3-beta-957-GTNH)
>* add keybinds for wireless keys by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1318 (rv3-beta-957-GTNH)
>* Split pattern value from old slot sync system by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1322 (rv3-beta-957-GTNH)
>* Pattern Repeater add to interface terminal support by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1278 (rv3-beta-955-GTNH)
>* Allow Phantom Slots to use Sync Handler by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1317 (rv3-beta-953-GTNH)
>* Language Update by @Yoshy2002 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1319 (rv3-beta-951-GTNH)
...
>* Optimite Wireless-Hub connection logic by @czqwq in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1307 (rv3-beta-944-GTNH)
>* more useful typeWeight by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1297 (rv3-beta-944-GTNH)
>* Fix NPE in getAdaptor by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1303 (rv3-beta-943-GTNH)
>* Enable 1-tick caching for InventoryAdaptors by @bk5115545 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1293 (rv3-beta-941-GTNH)
>* Fix: OreDictionaryFilter text field too short for long ore names by @youkoaona in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1250 (rv3-beta-941-GTNH)
>* Add Super Wireless Kit by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/734 (rv3-beta-941-GTNH)
>* Separate functional test task by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1280 (rv3-beta-941-GTNH)
>* Fix AE2 spatial corrupting gt5 machines by @Pxx500 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1292 (rv3-beta-941-GTNH)
>* Fix issues with ItemIO implementation by @OneEyeMaker in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1282 (rv3-beta-941-GTNH)
>* EID Compat by @tiffit in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1302 (rv3-beta-940-GTNH)
>* Add 1-tick caching to DualityInterface.isBusy() to prevent repeated target scans within a single tick by @bk5115545 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1290 (rv3-beta-938-GTNH)
>* Optimize IntegrationRegistry isEnabled() and getInstance() by @bk5115545 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1289 (rv3-beta-937-GTNH)
>* Fix leaks in TickHandler by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1291 (rv3-beta-937-GTNH)
>* Add Action handler by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1276 (rv3-beta-936-GTNH)
>* fix Crafting output can mismatch stacksize by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1286 (rv3-beta-936-GTNH)
>* Add checkRange to WirelessRegistry by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1287 (rv3-beta-936-GTNH)
>* Fix NEI recipe display by @OTPANNIEXD in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1288 (rv3-beta-936-GTNH)
>* Fix conversion monitor by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1283 (rv3-beta-935-GTNH)
>* postea Essentia Cell Workbench by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1277 (rv3-beta-935-GTNH)
>* fix Cell Restriction gui type weight incorrect by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1281 (rv3-beta-935-GTNH)
>* fix by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1279 (rv3-beta-934-GTNH)
>* Postea ae2fc and ThE deprecated by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1275 (rv3-beta-933-GTNH)
>* restore some old integrations and remove dead integrations by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1274 (rv3-beta-931-GTNH)
>* Move quartz glass to core by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1272 (rv3-beta-929-GTNH)
>* Disassemble cells by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1271 (rv3-beta-929-GTNH)
>* fix Some blocks texture location by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1273 (rv3-beta-929-GTNH)
>* Cell Restriction rework by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1265 (rv3-beta-928-GTNH)
>* fix Render fluid in terminal crash by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1267 (rv3-beta-928-GTNH)
...
>* Fix io port cell movement by @rhobold in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1259 (rv3-beta-922-GTNH)
>* Interface try push out cache stacks on neighbors update by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1254 (rv3-beta-921-GTNH)
>* fix shift crafting nbt by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1256 (rv3-beta-921-GTNH)
...
>* Fix config change not updating neighbors by @daxsc in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1244 (rv3-beta-913-GTNH)
>* Fix blank pattern extraction from network when encoding by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1242 (rv3-beta-912-GTNH)
>* Fixed the viewport area by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1240 (rv3-beta-911-GTNH)
>* Fix crafting completion sound broadcasting to all nearby players by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1239 (rv3-beta-911-GTNH)
>* Rewrite GridStorage data saving to not waste memory by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1232 (rv3-beta-910-GTNH)
>* fix Pattern with recycling ingredient broken by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1230 (rv3-beta-910-GTNH)
>* Update DualityInterface.java by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1238 (rv3-beta-910-GTNH)
>* Restore Shift+click rename in Interface Terminal by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1237 (rv3-beta-910-GTNH)
>* Interface Terminal: hide individual interfaces from the terminal view by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1228 (rv3-beta-909-GTNH)
>* Fix Overflow Void Card only voids when cell is full by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1233 (rv3-beta-908-GTNH)
...
>* Fix crafting tree counts for mixed recipes by @ShadowQFT in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1212 (rv3-beta-903-GTNH)
>* Changed button tooltip from "No crafting Job Active" to "Inactive" by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1216 (rv3-beta-903-GTNH)
>* Fix memory leak caused by ThreadLocal<RenderBlocksWorkaround> by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1215 (rv3-beta-903-GTNH)
>* Adjust Interface Terminal Gui size by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1218 (rv3-beta-903-GTNH)
>* feat(interface): add IInterfaceNameProvider API for dynamic terminal name suffixes by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1196 (rv3-beta-902-GTNH)
>* Reshuffle for AE2 by @Breviel in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1072 (rv3-beta-901-GTNH)
>* Refactor CraftingCPU GUI/Container  by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1208 (rv3-beta-900-GTNH)
>* Fix shift click in phantom slot by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1213 (rv3-beta-900-GTNH)
>* Fix IO Port cell moving by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1197 (rv3-beta-899-GTNH)
>* add test stack for stack type by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1211 (rv3-beta-899-GTNH)
...
>* Hide scheduling button in import bus GUI by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1207 (rv3-beta-896-GTNH)
>* Fix Quantum Bridge renaming cause NPE in unformed clusters by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1202 (rv3-beta-895-GTNH)
>* Fix sync condition by @czqwq in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1204 (rv3-beta-895-GTNH)
>* Fix/merge remaining count by @ShadowQFT in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1199 (rv3-beta-895-GTNH)
>* Fix crafting plan percentage rounding by @ShadowQFT in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1201 (rv3-beta-895-GTNH)
>* Enchance tooltips by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1194 (rv3-beta-894-GTNH)
>* Quick container transfer by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1189 (rv3-beta-894-GTNH)
>* Fix server memory leak in LocatableRegistry by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1193 (rv3-beta-893-GTNH)
>* Override PowerEvent in TileEnergyAcceptor so it notifies the grid when receiving power by @Majora320 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1188 (rv3-beta-892-GTNH)
>* Show calculation result tooltips by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1190 (rv3-beta-892-GTNH)
>* Fix ae2 leaving empty NBT Tags everywhere by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1191 (rv3-beta-892-GTNH)
>* Fix Multiplier&Divider infinite loop by @zyf051520 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1185 (rv3-beta-892-GTNH)
>* Generalizing TypeFilter by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1186 (rv3-beta-891-GTNH)
>* Add legacy type detection for level emitters by @PantACRO4life in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1137 (rv3-beta-890-GTNH)
>* Add legacy type detection for level emitters by @PantACRO4life in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1137 (rv3-beta-889-GTNH)
>* fix two world client memory leaks by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1183 (rv3-beta-888-GTNH)
>* Fix upgrade card tooltip cells by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1176 (rv3-beta-888-GTNH)
>* Improve scheduled reason tooltips by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1180 (rv3-beta-888-GTNH)
>* Allow sync null able by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1184 (rv3-beta-888-GTNH)
>* Hide config slots if oredict filter is present by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1177 (rv3-beta-887-GTNH)
>* Pins cleanup by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1181 (rv3-beta-886-GTNH)
>* Fix NEI Cell and Pattern View stackSize by @slprime in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1175 (rv3-beta-885-GTNH)
>* fix ore dict view cell by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1170 (rv3-beta-885-GTNH)
>* Add NEICellSearchFilter by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1179 (rv3-beta-885-GTNH)
>* Pixel Adjustments/MissingItem overlay adjustments by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1173 (rv3-beta-885-GTNH)
>* fix GuiCraftingCPU#filteredVisual not being cleared properly by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1172 (rv3-beta-884-GTNH)
>* Add scheduled-reason colors and icons to crafting CPU remaining operations by @bk5115545 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1151 (rv3-beta-883-GTNH)
>* Added Cell View color enum by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1167 (rv3-beta-882-GTNH)
>* fix portable cells by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1168 (rv3-beta-882-GTNH)
>* Add tooltip handler for upgrade slots by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1164 (rv3-beta-881-GTNH)
>* Fix fuzzy lookup with primitive-backed network list by @bk5115545 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1163 (rv3-beta-880-GTNH)
...
>* Improve search by @evgengoldwar in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1097 (rv3-beta-878-GTNH)
>* Fix alt type storage bus not able read subnet by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1154 (rv3-beta-877-GTNH)
>* Fix null key in legacy craftable map by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1149 (rv3-beta-876-GTNH)
>* Fixes Storage Bus on empty container crash by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1148 (rv3-beta-875-GTNH)
>* CPU Sorting buttons enhancements by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1145 (rv3-beta-874-GTNH)
>* Improve terminal interaction with type filter by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1147 (rv3-beta-874-GTNH)
>* Improve Performance of NetworkInventoryHandler by @bk5115545 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1096 (rv3-beta-874-GTNH)
>* Add backhand support for the color applicator by @sbancuz in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1142 (rv3-beta-873-GTNH)
>* Added CPU Sorting buttons by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1143 (rv3-beta-873-GTNH)
>* Adjusts ME Pick Block to prefer PickBlockEvent when appropriate by @querns in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1141 (rv3-beta-872-GTNH)
>* Fix fill containers interaction by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1140 (rv3-beta-871-GTNH)
>* fix NPE in AEFluidStackType#drainStackFromContainer by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1139 (rv3-beta-870-GTNH)
>* Changed the entry state of the Matter Condenser to be in Singularity Mode by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1136 (rv3-beta-870-GTNH)
...
>* Do not retry if getTile reflection fails by @zyf051520 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1125 (rv3-beta-861-GTNH)
>* Add getTile cache by @zyf051520 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1124 (rv3-beta-860-GTNH)
>* optimize ASMIntegration by @danyadev in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1123 (rv3-beta-860-GTNH)
>* Make pattern info more unviversal by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1116 (rv3-beta-859-GTNH)
...
>* fix toggle focus by @Goldenlion5648 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1100 (rv3-beta-851-GTNH)
>* Fluid transfer io port speed fix by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1108 (rv3-beta-850-GTNH)
...
>* Attempt to enable the input-only pattern to be encoded as a Tunnel pattern by @PinkYuDeer in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1057 (rv3-beta-844-GTNH)
>* Fix essentia not being pushed to network via interface by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1095 (rv3-beta-844-GTNH)
>* Improve pin slot interaction and fix ghost item by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1091 (rv3-beta-844-GTNH)
...
>* fix(gui): ensure null filters are synced to client. by @hinyb in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1075 (rv3-beta-833-GTNH)
>* partial uk_UA update/fix by @GribanovIvan in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1066 (rv3-beta-832-GTNH)
>* Cache pattern output stack by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1071 (rv3-beta-830-GTNH)
>* fix put stuff in hidden pins by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1062 (rv3-beta-830-GTNH)
>* Fix crafting status tooltip by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1068 (rv3-beta-829-GTNH)
>* View Cell supports all stack types by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1069 (rv3-beta-829-GTNH)
>* Fix crash on patterns containing unsupported types by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1063 (rv3-beta-827-GTNH)
>* Less dumb Meteorite generation by @mitchej123 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1065 (rv3-beta-827-GTNH)
>* Improve the clarity of container interactions by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1060 (rv3-beta-826-GTNH)
>* compatibility by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1061 (rv3-beta-826-GTNH)
>* some refactor in cpu by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1053 (rv3-beta-823-GTNH)
...
>* feat: Use pylon dimension for SpatialTransition instead of IO-Port by @JeromeBollinger in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1038 (rv3-beta-811-GTNH)
>* Fix config copy for IO Bus, Storage Bus, and Level Emitter via memory card by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1049 (rv3-beta-811-GTNH)
>* Restrict IO Workflow to PRs With PNGs by @UltraProdigy in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1052 (rv3-beta-810-GTNH)
...
>* fix pins r click, fix processing term by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1042 (rv3-beta-796-GTNH)
>* fix me chest by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1040 (rv3-beta-796-GTNH)
>* Fix storage bus crash and item NBT disappearance by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1019 (rv3-beta-794-GTNH)
>* Return shift click insert into phantom slots by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1021 (rv3-beta-794-GTNH)
>* Add a constructor to AEInvTile to self manage inventory by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1024 (rv3-beta-794-GTNH)
>* Fix optimizer gui not open by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1023 (rv3-beta-794-GTNH)
>* Fix fluids not displayed in optimize gui by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1028 (rv3-beta-794-GTNH)
>* Fix partition button not work on Cell Workbench by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1029 (rv3-beta-794-GTNH)
>* Fix shift-clicking a slot unnecessarily placing items in phantom slot by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1027 (rv3-beta-794-GTNH)
>* Optimize textures and add texture optimisation check in the build and test workflow by @boubou19 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1030 (rv3-beta-794-GTNH)
>* Fix highlight interface was not working sometimes by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1022 (rv3-beta-794-GTNH)
>* Refactor GuiSync annotation logic by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/968 (rv3-beta-794-GTNH)
>* Change the priority of destination slots when shift-clicking on Terminal GUI and inventory not updated by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1032 (rv3-beta-794-GTNH)
>* fix item buses does not update redstone mode when gui changes by @dfddgge in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1013 (rv3-beta-794-GTNH)
>* Set GTNHLib minimum version requirement appropriately by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1034 (rv3-beta-794-GTNH)
>* Allow viewing crafting and usage of the pattern main output by @ABKQPO in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/974 (rv3-beta-794-GTNH)
>* Correction of the ME Chest name in the pt-br language by @thiago-solfo in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1039 (rv3-beta-794-GTNH)
>* Set GTNHLib minimum version requirement appropriately by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1034 (rv3-beta-793-GTNH)
>* Allow viewing crafting and usage of the pattern main output by @ABKQPO in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/974 (rv3-beta-793-GTNH)
>* Fix highlight interface was not working sometimes by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1022 (rv3-beta-792-GTNH)
>* Refactor GuiSync annotation logic by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/968 (rv3-beta-792-GTNH)
>* Change the priority of destination slots when shift-clicking on Terminal GUI and inventory not updated by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1032 (rv3-beta-792-GTNH)
>* fix item buses does not update redstone mode when gui changes by @dfddgge in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/1013 (rv3-beta-792-GTNH)
...
>* feat(level-emitter): add button to control detection mode on empty filter by @hinyb in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/994 (rv3-beta-775-GTNH)
>* Fix bi-directional filters with storage bus + interface subnet by @sbancuz in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/991 (rv3-beta-775-GTNH)
>* implement storage interceptor & fix locking card by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/993 (rv3-beta-775-GTNH)
>* do not push in inactive interface by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/995 (rv3-beta-775-GTNH)
>* fix crash without ae2fc by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/983 (rv3-beta-772-GTNH)
>* remove pattern refill card by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/984 (rv3-beta-772-GTNH)
>* Localization of Amount elements by @Ranzuu in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/982 (rv3-beta-772-GTNH)
>* Changes Level Type Tooltip To Include Fluid by @UltraProdigy in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/986 (rv3-beta-772-GTNH)
>* fix crash, fix encoded pattern overwrite by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/987 (rv3-beta-772-GTNH)
>* Fix crafting gui open in non-hand slot by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/981 (rv3-beta-770-GTNH)
>* make crafting tree search more exhaustive by @Glease in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/936 (rv3-beta-768-GTNH)
>* Fix NEI Cell View stack size rendering by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/979 (rv3-beta-767-GTNH)
...
>* Fix primary gui by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/971 (rv3-beta-762-GTNH)
...
>* Add Preview Blocks by @evgengoldwar in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/935 (rv3-beta-759-GTNH)
>* fix(render): adapt hodgepodge fixBottomFaceUV by @leagris in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/940 (rv3-beta-759-GTNH)
>* Fix wrong substitutes used in crafting calculation by @zyf051520 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/953 (rv3-beta-759-GTNH)
>* Ug fixes 2 by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/965 (rv3-beta-759-GTNH)
>* Fix Network Status Gui not open by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/967 (rv3-beta-759-GTNH)
>* [Memory-opti:fix leak] Fix world leak in CraftingCPUCluster and AppEngRenderItem by @Alexdoru in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/956 (rv3-beta-758-GTNH)
>* Don't unfocus text field on GuiAmount by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/947 (rv3-beta-758-GTNH)
>* Check range in performCheck by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/957 (rv3-beta-758-GTNH)
>* Fix fluid cell interaction by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/962 (rv3-beta-758-GTNH)
>* ug fixes by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/960 (rv3-beta-758-GTNH)
>* Universal GUI by @lc-1337 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/872 (rv3-beta-754-GTNH)
...
>* Fix interface passing network contents when missing channel by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/918 (rv3-beta-741-GTNH)
...
# Updated - ArchitectureCraft - 1.11.6 --> 1.12.13
**Full Changelog**: https://github.com/GTNewHorizons/ArchitectureCraft/compare/1.11.6...1.12.13

## What's Changed:
>* Localize the values as lang keys by @Ranzuu in https://github.com/GTNewHorizons/ArchitectureCraft/pull/42 (1.12.13)
...
>* Prevent crash for slopes when mixing opaque and translucent blocks by @DarkShadow44 in https://github.com/GTNewHorizons/ArchitectureCraft/pull/29 (1.12.7)
>* Add WAILA integration for Shape blocks by @wlhlm in https://github.com/GTNewHorizons/ArchitectureCraft/pull/31 (1.12.5)
>* delete useless event registration by @Alexdoru in https://github.com/GTNewHorizons/ArchitectureCraft/pull/30 (1.12.3)
>* Fix flipped bottom face uv when hodgepodge mc fix is enabled by @danyadev in https://github.com/GTNewHorizons/ArchitectureCraft/pull/28 (1.12.1)
>* Fix flickering by @sisyphussy in https://github.com/GTNewHorizons/ArchitectureCraft/pull/27 (1.12.0)

# Updated - AsieLib - 0.7.0 --> 0.7.2
**Full Changelog**: https://github.com/GTNewHorizons/AsieLib/compare/0.7.0...0.7.2
...
# Updated - Avaritia - 1.77 --> 1.97
**Full Changelog**: https://github.com/GTNewHorizons/Avaritia/compare/1.77...1.97

## What's Changed:
>* register infinity ingot like neutronium by @MCTBL in https://github.com/GTNewHorizons/Avaritia/pull/82 (1.97)
...
>* Replace Universium shader with GTNHLib by @sisyphussy in https://github.com/GTNewHorizons/Avaritia/pull/67 (1.89)
>* Allow clusters to store more than 16k items by @RecursivePineapple in https://github.com/GTNewHorizons/Avaritia/pull/69 (1.85)
...
# Updated - Avaritiaddons - 1.9.3-GTNH --> 1.9.4-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Avaritiaddons/compare/1.9.3-GTNH...1.9.4-GTNH

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Avaritiaddons/pull/20 (1.9.4-GTNH)

# Updated - Backhand - 1.7.7 --> 1.8.10
**Full Changelog**: https://github.com/GTNewHorizons/Backhand/compare/1.7.7...1.8.10

## What's Changed:
>* Fix offhand item clipping through custom armor models by @Luca-Guettinger in https://github.com/GTNewHorizons/Backhand/pull/178 (1.8.10)
>* Fixed Galacticraft armor slot offset by @Ranzuu in https://github.com/GTNewHorizons/Backhand/pull/180 (1.8.9)
>* Fixes clearing of offhand slot with Creative Inventory "Destroy Item" Button/Slot by @Ranzuu in https://github.com/GTNewHorizons/Backhand/pull/175 (1.8.8)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Backhand/pull/176 (1.8.7)
>* Proper offhand healing axe compat by @Caedis in https://github.com/GTNewHorizons/Backhand/pull/174 (1.8.6)
>* Don't strip logs when holding healing axe in offhand by @sbancuz in https://github.com/GTNewHorizons/Backhand/pull/170 (1.8.5)
>* fix: hide offhand slot when hotbar rendering is canceled by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Backhand/pull/169 (1.8.4)
...
# Updated - Battlegear2-for-Backhand - 1.5.9-backhand --> 1.6.8-backhand
**Full Changelog**: https://github.com/GTNewHorizons/Battlegear2-for-Backhand/compare/1.5.9-backhand...1.6.8-backhand

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Battlegear2-for-Backhand/pull/16 (1.6.8-backhand)
>* Fix the issue where Ender Arrows break blocks by @ABKQPO in https://github.com/GTNewHorizons/Battlegear2-for-Backhand/pull/15 (1.6.8-backhand)
>* Improve quiver rendering by @sisyphussy in https://github.com/GTNewHorizons/Battlegear2-for-Backhand/pull/12 (1.6.7-backhand)
>* delete useless event registration by @Alexdoru in https://github.com/GTNewHorizons/Battlegear2-for-Backhand/pull/13 (1.6.6-backhand)
...
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Baubles-Expanded/pull/30 (2.2.13-GTNH)
>* Infinite Bauble Slots by @koolkrafter5 in https://github.com/GTNewHorizons/Baubles-Expanded/pull/28 (2.2.11-GTNH)
>* Added Empty/Unused Slot texture/Quick Docs on old layout by @Ranzuu in https://github.com/GTNewHorizons/Baubles-Expanded/pull/27 (2.2.9-GTNH)
>* Implement multi-column logic by @FourIsTheNumber in https://github.com/GTNewHorizons/Baubles-Expanded/pull/26 (2.2.8-GTNH)
>* Handle tooltip for "universal" type baubles correctly by @Kynake in https://github.com/GTNewHorizons/Baubles-Expanded/pull/24 (2.2.6-GTNH)
>* Display type tooltip when hovering on a Bauble slot by @Kynake in https://github.com/GTNewHorizons/Baubles-Expanded/pull/22 (2.2.4-GTNH)
...
# Updated - BeeBetterAtBees-GTNH - 0.4.3-GTNH --> 0.4.6-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/BeeBetterAtBees-GTNH/compare/0.4.3-GTNH...0.4.6-GTNH

## What's Changed:
>* Fix HEI Handler Tooltip by @slprime in https://github.com/GTNewHorizons/BeeBetterAtBees-GTNH/pull/8 (0.4.6-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BeeBetterAtBees-GTNH/pull/7 (0.4.5-GTNH)
>* Fix Mutation Requirement Tooltips by @Ruling-0 in https://github.com/GTNewHorizons/BeeBetterAtBees-GTNH/pull/6 (0.4.4-GTNH)

# Updated - BetterAchievements - 0.3.0 --> 0.3.3
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/BetterAchievements/compare/0.3.0...0.3.3

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BetterAchievements/pull/6 (0.3.3)
>* Changed achievement title localization by @Ranzuu in https://github.com/GTNewHorizons/BetterAchievements/pull/5 (0.3.2)

# Updated - BetterBuildersWands - 0.13.3-GTNH --> 0.13.11-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/BetterBuildersWands/compare/0.13.3-GTNH...0.13.11-GTNH

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BetterBuildersWands/pull/24 (0.13.11-GTNH)
>* Fixed Backhand integration and resolved block placement issues with certain mods by @ABKQPO in https://github.com/GTNewHorizons/BetterBuildersWands/pull/23 (0.13.10-GTNH)
...
# Updated - BetterCrashes - 1.4.0-GTNH --> 1.4.5-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/BetterCrashes/compare/1.4.0-GTNH...1.4.5-GTNH

## What's Changed:
>* Modernize: enable jabel, generic injection, Tags class by @Eldrinn-Elantey in https://github.com/GTNewHorizons/BetterCrashes/pull/22 (1.4.5-GTNH)
>* Fix hang on loading on crash by @tiffit in https://github.com/GTNewHorizons/BetterCrashes/pull/19 (1.4.4-GTNH)
...
# Updated - BetterLoadingScreen - 1.7.2-GTNH --> 1.7.8-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/BetterLoadingScreen/compare/1.7.2-GTNH...1.7.8-GTNH

## What's Changed:
>* Create ru_RU.txt by @Eldrinn-Elantey in https://github.com/GTNewHorizons/BetterLoadingScreen/pull/32 (1.7.8-GTNH)
>* Fix outdated tips in en_US.txt by @Eldrinn-Elantey in https://github.com/GTNewHorizons/BetterLoadingScreen/pull/35 (1.7.8-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BetterLoadingScreen/pull/34 (1.7.7-GTNH)
>* Revert "Fix resource packs being reset on startup (symlink packs included)" by @Eldrinn-Elantey in https://github.com/GTNewHorizons/BetterLoadingScreen/pull/33 (1.7.6-GTNH)
...
>* Show quest notifications as titles by @alppp in https://github.com/GTNewHorizons/BetterQuesting/pull/200 (3.8.62-GTNH)
...
>* switch over from joml to lwjgl by @tiffit in https://github.com/GTNewHorizons/BetterQuesting/pull/217 (3.8.48-GTNH)
...
>* Fix URL Color Toggle by @UltraProdigy in https://github.com/GTNewHorizons/BetterQuesting/pull/197 (3.8.34-GTNH)
>* Fix server leak by @Alexdoru in https://github.com/GTNewHorizons/BetterQuesting/pull/196 (3.8.33-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BetterQuesting/pull/193 (3.8.32-GTNH)
>* Fix [Note] & [Warn] by @UltraProdigy in https://github.com/GTNewHorizons/BetterQuesting/pull/192 (3.8.31-GTNH)
>* fix NPE in EventHandler#postPresetNotice by @Alexdoru in https://github.com/GTNewHorizons/BetterQuesting/pull/190 (3.8.30-GTNH)
>* Add Color Toggle Option by @UltraProdigy in https://github.com/GTNewHorizons/BetterQuesting/pull/189 (3.8.30-GTNH)
>* Hide rewards when noRewards is on in server by @vulcandragi in https://github.com/GTNewHorizons/BetterQuesting/pull/191 (3.8.30-GTNH)
...
>* fix: on the server, the quest name in the notification is not localized. by @iouter in https://github.com/GTNewHorizons/BetterQuesting/pull/178 (3.8.12-GTNH)
...
# Updated - Binnie - 2.5.24 --> 2.6.32
**Full Changelog**: https://github.com/GTNewHorizons/Binnie/compare/2.5.24...2.6.32

## What's Changed:
>* Fix ComponentTankContainer draining wrong fluid when specific fluid requested by @dipo33 in https://github.com/GTNewHorizons/Binnie/pull/97 (2.6.32)
...
>* fix isolator consumption chance config source by @SmileYik in https://github.com/GTNewHorizons/Binnie/pull/87 (2.6.27)
>* Fix ceramic tiles + Add config option to disable compartments by @brandyyn in https://github.com/GTNewHorizons/Binnie/pull/83 (2.6.26)
>* fix world client leak in RendererMachine by @Alexdoru in https://github.com/GTNewHorizons/Binnie/pull/90 (2.6.24)
>* Move out larvae from splicer even when no serum is present anymore by @DarkShadow44 in https://github.com/GTNewHorizons/Binnie/pull/76 (2.6.22)
>* Fix Genetics machines' VFX incorrectly appearing at 0;0;0 coordinates by @TweksTY in https://github.com/GTNewHorizons/Binnie/pull/89 (2.6.22)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Binnie/pull/88 (2.6.19)
>* Cache frequent Enum#values() calls by @Alexdoru in https://github.com/GTNewHorizons/Binnie/pull/86 (2.6.17)
>* CropsNH Integration/IC2 Depreciation by @C0bra5 in https://github.com/GTNewHorizons/Binnie/pull/82 (2.6.16)
>* Fix incorrect integer division in `getRipeningStage` by @Ameobea in https://github.com/GTNewHorizons/Binnie/pull/85 (2.6.14)
...
# Updated - BlockRenderer6343 - 1.3.17 --> 1.4.13
**Full Changelog**: https://github.com/GTNewHorizons/BlockRenderer6343/compare/1.3.17...1.4.13

## What's Changed:
>* fix world client memory leak in GuiMultiblockHandler by @Alexdoru in https://github.com/GTNewHorizons/BlockRenderer6343/pull/48 (1.4.13)
>* Make non GT controllers appear first in ingredient list by @Lyfts in https://github.com/GTNewHorizons/BlockRenderer6343/pull/47 (1.4.12)
>* Rename lang by @czqwq in https://github.com/GTNewHorizons/BlockRenderer6343/pull/46 (1.4.11)
>* Fixed a bug with preview display in NEI by @evgengoldwar in https://github.com/GTNewHorizons/BlockRenderer6343/pull/45 (1.4.10)
>* Fix mouse offset wrong on secondary pages by @Lyfts in https://github.com/GTNewHorizons/BlockRenderer6343/pull/44 (1.4.9)
>* Enhance neiOverlay with named paper output and filtered all MTEHatches by @czqwq in https://github.com/GTNewHorizons/BlockRenderer6343/pull/43 (1.4.8)
>* Improve Valid Hatches String in MB preview by @Yoshy2002 in https://github.com/GTNewHorizons/BlockRenderer6343/pull/41 (1.4.7)
>* Handler config by @slprime in https://github.com/GTNewHorizons/BlockRenderer6343/pull/40 (1.4.6)
...
# Updated - BloodArsenal - 1.4.10 --> 1.5.10
**Full Changelog**: https://github.com/GTNewHorizons/BloodArsenal/compare/1.4.10...1.5.10

## What's Changed:
>* Downscale transparent orb texture by @GDCloudstrike in https://github.com/GTNewHorizons/BloodArsenal/pull/44 (1.5.10)
>* Adapt to BM changes by @koolkrafter5 in https://github.com/GTNewHorizons/BloodArsenal/pull/43 (1.5.9)
>* Add glassProtectiveItems config by @tiffit in https://github.com/GTNewHorizons/BloodArsenal/pull/42 (1.5.8)
>* Update Augmented Capacity Rune effect to match base BM by @koolkrafter5 in https://github.com/GTNewHorizons/BloodArsenal/pull/41 (1.5.7)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BloodArsenal/pull/40 (1.5.6)
...
# Updated - BloodMagic - 1.7.52 --> 1.9.4
**Full Changelog**: https://github.com/GTNewHorizons/BloodMagic/compare/1.7.52...1.9.4

## What's Changed:
>* Do the laggy permission check for bound tools last after all other checks by @koolkrafter5 in https://github.com/GTNewHorizons/BloodMagic/pull/134 (1.9.4)
>* EID Compat by @tiffit in https://github.com/GTNewHorizons/BloodMagic/pull/133 (1.9.3)
>* Make the Alchemic Router's UX Better by @ReignOfFROZE in https://github.com/GTNewHorizons/BloodMagic/pull/124 (1.9.3)
...
>* Update BS & Deps by @UltraProdigy in https://github.com/GTNewHorizons/BloodMagic/pull/122 (1.8.13)
...
>* Alchemic Calcinator Improvements by @koolkrafter5 in https://github.com/GTNewHorizons/BloodMagic/pull/109 (1.8.7)
>* Add hazmat protection to bound and omega armors by @Worive in https://github.com/GTNewHorizons/BloodMagic/pull/111 (1.8.7)
...
# Updated - Botania - 1.12.28-GTNH --> 1.13.25-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Botania/compare/1.12.28-GTNH...1.13.25-GTNH

## What's Changed:
>* Clean up NEI handlers by @koolkrafter5 in https://github.com/GTNewHorizons/Botania/pull/131 (1.13.25-GTNH)
>* Added size parameter to lang file by @Ranzuu in https://github.com/GTNewHorizons/Botania/pull/137 (1.13.21-GTNH)
>* fix three world leaks in TESR by @Alexdoru in https://github.com/GTNewHorizons/Botania/pull/136 (1.13.19-GTNH)
>* Fix Ring of Mantle re-applying Haste every tick by @guneykabel in https://github.com/GTNewHorizons/Botania/pull/133 (1.13.17-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Botania/pull/125 (1.13.16-GTNH)
>* Update dep&bs by @UltraProdigy in https://github.com/GTNewHorizons/Botania/pull/126 (1.13.16-GTNH)
>* GuiTitles Localization by @Ranzuu in https://github.com/GTNewHorizons/Botania/pull/124 (1.13.15-GTNH)
>* Refactor: tiered tool interface by @combusterf in https://github.com/GTNewHorizons/Botania/pull/103 (1.13.14-GTNH)
>* fix typos by @Yoshy2002 in https://github.com/GTNewHorizons/Botania/pull/120 (1.13.12-GTNH)
>* Fix crash when no IC2 is installed by @ALongStringOfNumbers in https://github.com/GTNewHorizons/Botania/pull/119 (1.13.10-GTNH)
>* Allow more explosion sources to generate mana via Entropinnyum by @ALongStringOfNumbers in https://github.com/GTNewHorizons/Botania/pull/117 (1.13.8-GTNH)
>* Great Renaming 3 - Misc. by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Botania/pull/110 (1.13.6-GTNH)
>* Backport modern Rosa Arcana behavior by @koolkrafter5 in https://github.com/GTNewHorizons/Botania/pull/109 (1.13.4-GTNH)
...
# Updated - Botanic-horizons - 1.11.27-GTNH --> 1.12.8-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Botanic-horizons/compare/1.11.27-GTNH...1.12.8-GTNH

## What's Changed:
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Botanic-horizons/pull/51 (1.12.8-GTNH)
>* Fixes NoSuchMethodError gregtech.api.interfaces.IIconContainer.getIcon with fancy wrench by @alppp in https://github.com/GTNewHorizons/Botanic-horizons/pull/50 (1.12.6-GTNH)
>* Registry Name Migration for NewHorizonsCoreMod by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Botanic-horizons/pull/49 (1.12.5-GTNH)
>* fix: Bump despawn timer for tiered wrenches in line with Terra Shatterer by @MaxLunar in https://github.com/GTNewHorizons/Botanic-horizons/pull/45 (1.12.3-GTNH)
...
>* Fewer Allocations by @mitchej123 in https://github.com/GTNewHorizons/BuildCraft/pull/30 (7.1.54)
...
# Updated - BuildCraftCompat - 7.1.18 --> 7.1.21
**Full Changelog**: https://github.com/GTNewHorizons/BuildCraftCompat/compare/7.1.18...7.1.21

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/BuildCraftCompat/pull/14 (7.1.21)
>* Added optional localization and fixed gui by @Ranzuu in https://github.com/GTNewHorizons/BuildCraftCompat/pull/13 (7.1.20)

# Updated - BuildCraftOilTweak - 1.1.1 --> 1.1.3
**Full Changelog**: https://github.com/GTNewHorizons/BuildCraftOilTweak/compare/1.1.1...1.1.3

## What's Changed:
>* optimize isModLoaded checks by @danyadev in https://github.com/GTNewHorizons/BuildCraftOilTweak/pull/3 (1.1.3)

# Updated - CarpentersBlocks - 3.7.0-GTNH --> 3.7.2-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/CarpentersBlocks/compare/3.7.0-GTNH...3.7.2-GTNH

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/CarpentersBlocks/pull/18 (3.7.2-GTNH)
>* Added Carpenters Safe gui title localization by @Ranzuu in https://github.com/GTNewHorizons/CarpentersBlocks/pull/15 (3.7.1-GTNH)
...
# Updated - Catwalks-2 - 2.4.0-GTNH --> 2.4.1-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Catwalks-2/compare/2.4.0-GTNH...2.4.1-GTNH

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Catwalks-2/pull/18 (2.4.1-GTNH)

# Updated - Chisel - 2.16.15-GTNH --> 2.17.27-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Chisel/compare/2.16.15-GTNH...2.17.27-GTNH

## What's Changed:
>* Improve perf of TextureType.exists by @tiffit in https://github.com/GTNewHorizons/Chisel/pull/97 (2.17.27-GTNH)
>* june's chisel block additions on an actually working branch this time by @seventh-june in https://github.com/GTNewHorizons/Chisel/pull/83 (2.17.26-GTNH)
>* Fix ctm of concrete block by @Deviouslrd in https://github.com/GTNewHorizons/Chisel/pull/91 (2.17.25-GTNH)
>* Add concrete slabs and stairs by @Deviouslrd in https://github.com/GTNewHorizons/Chisel/pull/90 (2.17.24-GTNH)
>* Woolen clay must be mined with pickaxe by @flamingowrangler2869 in https://github.com/GTNewHorizons/Chisel/pull/82 (2.17.23-GTNH)
>* Fix world client memory leaks caused by block renderers by @Alexdoru in https://github.com/GTNewHorizons/Chisel/pull/88 (2.17.22-GTNH)
>* ItemChisel: Set max damage field instead of overriding getMaxDamage by @tiffit in https://github.com/GTNewHorizons/Chisel/pull/89 (2.17.21-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Chisel/pull/81 (2.17.20-GTNH)
...
>* 'Dustrial Decor backports by @FourIsTheNumber in https://github.com/GTNewHorizons/Chisel/pull/70 (2.17.6-GTNH)
...
# New Mod - ChromaticTooltips:1.0.28-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/ChromaticTooltips/compare/1.0.17-GTNH...1.0.28-GTNH

## What's Changed:
>* Restore F3+H item string id functionality by @C0bra5 in https://github.com/GTNewHorizons/ChromaticTooltips/pull/7 (1.0.28-GTNH)
>* Fix Durability Info by @slprime in https://github.com/GTNewHorizons/ChromaticTooltips/pull/6 (1.0.27-GTNH)
>* Fix Broken Item DisplayName by @slprime in https://github.com/GTNewHorizons/ChromaticTooltips/pull/5 (1.0.24-GTNH)
>* Change ModInfo to Italic-Blue by @slprime in https://github.com/GTNewHorizons/ChromaticTooltips/pull/4 (1.0.23-GTNH)
...
# New Mod - ChromaticTooltipsCompat:1.0.31-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/ChromaticTooltipsCompat/compare/1.0.23-GTNH...1.0.31-GTNH

## What's Changed:
>* IC2: Fix electric armor durability tooltip by @slprime in https://github.com/GTNewHorizons/ChromaticTooltipsCompat/pull/9 (1.0.31-GTNH)
>* Botania: Fix ManaBar Position by @slprime in https://github.com/GTNewHorizons/ChromaticTooltipsCompat/pull/7 (1.0.30-GTNH)
>* fix Betterquesting OSS by @slprime in https://github.com/GTNewHorizons/ChromaticTooltipsCompat/pull/8 (1.0.30-GTNH)
>* Fix Creative Tab by @slprime in https://github.com/GTNewHorizons/ChromaticTooltipsCompat/pull/6 (1.0.29-GTNH)
...
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - CodeChickenCore - 1.4.10 --> 1.4.13
**Full Changelog**: https://github.com/GTNewHorizons/CodeChickenCore/compare/1.4.10...1.4.13

## What's Changed:
>* intern superclass and interfaces of ClassHeirachyManager data by @Alexdoru in https://github.com/GTNewHorizons/CodeChickenCore/pull/46 (1.4.13)
...
# Updated - Controlling - 2.1.2 --> 2.1.7
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/Controlling/compare/2.1.2...2.1.7

## What's Changed:
>* missed a keycode 0 check by @Caedis in https://github.com/GTNewHorizons/Controlling/pull/13 (2.1.7)
>* Use Enum .name() value when unseralizing KeyModifiers by @Caedis in https://github.com/GTNewHorizons/Controlling/pull/12 (2.1.6)
>* More optimizations by @Caedis in https://github.com/GTNewHorizons/Controlling/pull/11 (2.1.5)
>* Cache enums by @Caedis in https://github.com/GTNewHorizons/Controlling/pull/10 (2.1.4)
>* Backport Key Combos by @Caedis in https://github.com/GTNewHorizons/Controlling/pull/8 (2.1.3)

# Updated - CookingForBlockheads - 1.4.4-GTNH --> 1.4.12-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/CookingForBlockheads/compare/1.4.4-GTNH...1.4.12-GTNH

## What's Changed:
>* Add missing key by @Ranzuu in https://github.com/GTNewHorizons/CookingForBlockheads/pull/65 (1.4.12-GTNH)
>* Refactor the textures/Scrollbar atlas by @Ranzuu in https://github.com/GTNewHorizons/CookingForBlockheads/pull/63 (1.4.11-GTNH)
>* Remove IC2 Furnace From Recipes by @UltraProdigy in https://github.com/GTNewHorizons/CookingForBlockheads/pull/61 (1.4.10-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/CookingForBlockheads/pull/60 (1.4.9-GTNH)
>* CropsNH Integration/IC2 Depreciation by @C0bra5 in https://github.com/GTNewHorizons/CookingForBlockheads/pull/59 (1.4.8-GTNH)
>* Registry Name Migration for NewHorizonsCoreMod by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/CookingForBlockheads/pull/58 (1.4.7-GTNH)
...
# Updated - CoreTweaks - 0.3.3.6-GTNH --> 0.3.4.6-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/CoreTweaks/compare/0.3.3.6-GTNH...0.3.4.6-GTNH

## What's Changed:
>* save transformer cache async by @Alexdoru in https://github.com/GTNewHorizons/CoreTweaks/pull/15 (0.3.4.6-GTNH)
>* Fix LITE transformer cache producing corrupt classes from bad GDiff diffs by @Luca-Guettinger in https://github.com/GTNewHorizons/CoreTweaks/pull/10 (0.3.4.5-GTNH)
>* Cleanup LITE TransformerCache by @Alexdoru in https://github.com/GTNewHorizons/CoreTweaks/pull/14 (0.3.4.5-GTNH)
>* Fix : clear cache when ingame not on main menu by @Alexdoru in https://github.com/GTNewHorizons/CoreTweaks/pull/13 (0.3.4.4-GTNH)
>* quick cleanup by @Alexdoru in https://github.com/GTNewHorizons/CoreTweaks/pull/12 (0.3.4.3-GTNH)
>* Clear transformer cache when loading into a world by @Luca-Guettinger in https://github.com/GTNewHorizons/CoreTweaks/pull/11 (0.3.4.3-GTNH)
>* More supernova compat by @mitchej123 in https://github.com/GTNewHorizons/CoreTweaks/pull/9 (0.3.4.2-GTNH)
>* Supernova Compat by @mitchej123 in https://github.com/GTNewHorizons/CoreTweaks/pull/8 (0.3.4.1-GTNH)
>* Ignore spotless format in git blame by @wlhlm in https://github.com/GTNewHorizons/CoreTweaks/pull/6 (0.3.4.0-GTNH)
>* Remove optimizeGetPendingBlockUpdates  by @mitchej123 in https://github.com/GTNewHorizons/CoreTweaks/pull/7 (0.3.4.0-GTNH)
>* Update buildscripts to v2 by @wlhlm in https://github.com/GTNewHorizons/CoreTweaks/pull/4 (0.3.3.8-GTNH)
...
# New Mod - CosmeticArmorReworked:1.0.5-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/CosmeticArmorReworked/compare/1.0.0-GTNH...1.0.5-GTNH

## What's Changed:
>* Adds support for putting blocks inside your Head armor slot by @Ranzuu in https://github.com/GTNewHorizons/CosmeticArmorReworked/pull/5 (1.0.5-GTNH)
>* fix gui pos with potions by @Alexdoru in https://github.com/GTNewHorizons/CosmeticArmorReworked/pull/4 (1.0.3-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/CosmeticArmorReworked/pull/3 (1.0.2-GTNH)
>* Do some cleanup / fix world client leak by @Alexdoru in https://github.com/GTNewHorizons/CosmeticArmorReworked/pull/2 (1.0.1-GTNH)
>* unbind key by default by @Alexdoru in https://github.com/GTNewHorizons/CosmeticArmorReworked/pull/1 (1.0.1-GTNH)

# Updated - Craft-Presence - 2.6.2 --> 2.7.1
Mod is client-side only.
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - CraftTweaker - 3.4.2 --> 3.4.7
**Full Changelog**: https://github.com/GTNewHorizons/CraftTweaker/compare/3.4.2...3.4.7

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/CraftTweaker/pull/29 (3.4.7)
>* fix log file path by @Alexdoru in https://github.com/GTNewHorizons/CraftTweaker/pull/28 (3.4.6)
>* Fix commands leaking server by @Alexdoru in https://github.com/GTNewHorizons/CraftTweaker/pull/27 (3.4.5)
>* Fix memory leak in MTLogger by @Alexdoru in https://github.com/GTNewHorizons/CraftTweaker/pull/26 (3.4.4)
...
>* add missing indigo blossom recipes by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/131 (2.0.56)
>* Fix mcmod.info URLs by @DatLycan in https://github.com/GTNewHorizons/CropsNH/pull/129 (2.0.55)
>* Correct Ardite Berry Drop Count by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/127 (2.0.54)
>* allow goldfish to interact with things by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/126 (2.0.53)
>* Add materialCropLeaf ore dict to material leaf items. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/125 (2.0.52)
...
>* Fix Environmental module (Dead) recipe using wrong rotten flesh by @Luca-Guettinger in https://github.com/GTNewHorizons/CropsNH/pull/114 (2.0.45)
>* fix: typo, dustSlufur -> dustSulfur by @alfarelcynthesis in https://github.com/GTNewHorizons/CropsNH/pull/113 (2.0.44)
...
>* Fix structure localisations in the projector ui by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/107 (2.0.40)
>* Add AoE to ExU watering can compat. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/106 (2.0.40)
>* Add better default tooltip and visuals handling for quest book. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/108 (2.0.40)
>* Add rubyne by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/102 (2.0.39)
>* Spade code cleanup and QoL by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/105 (2.0.39)
>* Fix and improve waila tooltips by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/104 (2.0.38)
>* Balance thiosulfine conversion recipes. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/101 (2.0.38)
>* Add thiosulfine, the sulfur crop  by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/99 (2.0.37)
>* Fix alcohol fluid langs and lessen gt++ reliance for celled fluids. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/97 (2.0.37)
>* Bump gt dep by @Alexdoru in https://github.com/GTNewHorizons/CropsNH/pull/98 (2.0.36)
>* remove usage of gt++ logger by @Alexdoru in https://github.com/GTNewHorizons/CropsNH/pull/96 (2.0.35)
>* Prevent weed and migrator crops from showing up in NEI by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/91 (2.0.34)
>* Allow weed-ex to prevent disease transmission to healthy crops. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/92 (2.0.34)
>* Better load panic handling, Soil list refactor and clean-up, and oil berry soil changes by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/93 (2.0.34)
>* Make crop sticks turn green-ish when a crop is sick by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/94 (2.0.34)
>* Fix survival build hatches by @evgengoldwar in https://github.com/GTNewHorizons/CropsNH/pull/88 (2.0.33)
>* Fix NEI hatches by @evgengoldwar in https://github.com/GTNewHorizons/CropsNH/pull/87 (2.0.32)
>* Add standardized system for marking crops who's soil got changed. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/78 (2.0.31)
>* Fix incorrect block meta on migrated MTEs by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/84 (2.0.30)
>* Balance changes by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/64 (2.0.30)
>* Remove Sticky pool from Slimy Bonsai by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/86 (2.0.30)
...
>* Add more mutation pool to some crops by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/80 (2.0.27)
...
>* NEI tooltip changes and a quick fix for glowing coral by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/70 (2.0.24)
>* Fix april first easter egg by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/66 (2.0.23)
>* Fix liquid-input enriched fertilizer and remove gold from goldfish maceration. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/59 (2.0.22)
>* Fix drop stack sizes by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/58 (2.0.22)
>* fix incorrect formula for breeder nei tooltip by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/62 (2.0.22)
>* Add bop flax as an alt seed for flax by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/55 (2.0.21)
>* Make mica recipe use recipe eu/t instead of amp eu/t by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/53 (2.0.21)
>* Fix multiplayer-only issues by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/49 (2.0.20)
>* Use propper ore dict for garlic alt seeds. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/48 (2.0.19)
>* Fix IF drop increases being applied multiple times by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/47 (2.0.18)
>* Crop balance changes by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/46 (2.0.17)
>* Improve IF tooltips and textures (and update deps) by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/43 (2.0.16)
>* Fix ConcurrentModificationException in MTECropManager.harvest (issue #40) by @Calvin304 in https://github.com/GTNewHorizons/CropsNH/pull/41 (2.0.15)
>* Mark the spades as shovel type tools by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/42 (2.0.15)
>* Fix Crop Manager Lang Key by @UltraProdigy in https://github.com/GTNewHorizons/CropsNH/pull/39 (2.0.14)
>* bump GT to account for https://github.com/GTNewHorizons/GT5-Unofficial/pull/5781 by @boubou19 in https://github.com/GTNewHorizons/CropsNH/pull/38 (2.0.13)
>* Shrink collision box for Crop Sticks by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/34 (2.0.12)
>* Add some sense to Gene Extractor and Crop Synthesizer recipe times by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/33 (2.0.11)
>* Fix duplicate mutation for Allium and Belladonna by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/32 (2.0.10)
>* Allow seed data parser to identify crops that cannot be crossed. by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/30 (2.0.10)
>* Allow spade to harvest IF only crops for seeds when mature by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/31 (2.0.10)
>* Mutation pools updates by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/19 (2.0.9)
>* fix incorrect item ids for crop synthesizer migrations by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/20 (2.0.9)
>* Fix Stone Compression by @UltraProdigy in https://github.com/GTNewHorizons/CropsNH/pull/18 (2.0.8)
>* Drop changes, invalid soil warning, lang updates, single block rebalance by @C0bra5 in https://github.com/GTNewHorizons/CropsNH/pull/16 (2.0.7)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/CropsNH/pull/17 (2.0.6)
...
# Updated - Custom-Main-Menu - 1.12.2 --> 1.14.1
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/Custom-Main-Menu/compare/1.12.2...1.14.1

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Custom-Main-Menu/pull/12 (1.14.1)
>* feat(Action): Send IMC message to mod by @leagris in https://github.com/GTNewHorizons/Custom-Main-Menu/pull/11 (1.14.0)
...
# Updated - Darkerer - 1.0.6 --> 1.1.0
**Full Changelog**: https://github.com/GTNewHorizons/Darkerer/compare/1.0.6...1.1.0

## What's Changed:
>* Make mod client side-only and allow disabling entirely by @JL2210 in https://github.com/GTNewHorizons/Darkerer/pull/2 (1.1.0)

# Updated - Default-Configs - 1.3.0 --> 1.3.1
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/Default-Configs/compare/1.3.0...1.3.1

## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - DefaultServerList - 1.6.5 --> 1.7.3
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/DefaultServerList/compare/1.6.5...1.7.3
...
>* Properly use client / common proxies to fix memory leaks by @Alexdoru in https://github.com/GTNewHorizons/Draconic-Evolution/pull/97 (1.5.23-GTNH)
...
>* Fix Draconic Armor offhand rendering by @Roelof033 in https://github.com/GTNewHorizons/Draconic-Evolution/pull/88 (1.5.18-GTNH)
>* Sync zh-CN.lang with ParaTranz project by @tuodekun in https://github.com/GTNewHorizons/Draconic-Evolution/pull/91 (1.5.16-GTNH)
>* Update Buildscript by @Ruling-0 in https://github.com/GTNewHorizons/Draconic-Evolution/pull/90 (1.5.14-GTNH)
>* Fix lore formatting for wyvern and draconic items by @tuodekun in https://github.com/GTNewHorizons/Draconic-Evolution/pull/89 (1.5.14-GTNH)
>* Add block blacklist for magnets by @SuperSoupr in https://github.com/GTNewHorizons/Draconic-Evolution/pull/80 (1.5.11-GTNH)
>* Fix nullPointerException by @Georggi in https://github.com/GTNewHorizons/Draconic-Evolution/pull/87 (1.5.11-GTNH)
>* Update fuel usage config comment by @StaffiX in https://github.com/GTNewHorizons/Draconic-Evolution/pull/84 (1.5.8-GTNH)
>* delete useless event registration by @Alexdoru in https://github.com/GTNewHorizons/Draconic-Evolution/pull/82 (1.5.6-GTNH)
>* add missing enum switch case in ModHelper#getHazmatArmorConfigKey by @Alexdoru in https://github.com/GTNewHorizons/Draconic-Evolution/pull/81 (1.5.4-GTNH)
...
# Updated - DummyCore - 1.20.0 --> 1.21.0
**Full Changelog**: https://github.com/GTNewHorizons/DummyCore/compare/1.20.0...1.21.0

## What's Changed:
>* eid compat by @tiffit in https://github.com/GTNewHorizons/DummyCore/pull/7 (1.21.0)

# Updated - DuraDisplay - 1.3.4 --> 1.4.2
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/DuraDisplay/compare/1.3.4...1.4.2

## What's Changed:
>* Made certain dependencies optional to prevent crashes when running outside GTNH by @system64MC in https://github.com/GTNewHorizons/DuraDisplay/pull/24 (1.4.2)
>* Adds a custom overlay for Forestry backpacks by @querns in https://github.com/GTNewHorizons/DuraDisplay/pull/23 (1.4.0)

# Updated - Electro-Magic-Tools - 1.6.18 --> 1.7.22
**Full Changelog**: https://github.com/GTNewHorizons/Electro-Magic-Tools/compare/1.6.18...1.7.22

## What's Changed:
>* Remove spacesuit from nano armor by @FourIsTheNumber in https://github.com/GTNewHorizons/Electro-Magic-Tools/pull/117 (1.7.22)
>* Fix EMT machines dropping wrong items when broken by @Luca-Guettinger in https://github.com/GTNewHorizons/Electro-Magic-Tools/pull/116 (1.7.21)
>* Remove smelting recipes Amber and Cinnabar Ore by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Electro-Magic-Tools/pull/115 (1.7.20)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Electro-Magic-Tools/pull/114 (1.7.19)
>* Fix typos/grammar by @Yoshy2002 in https://github.com/GTNewHorizons/Electro-Magic-Tools/pull/113 (1.7.18)
>* Format number migration by @Connor-Colenso in https://github.com/GTNewHorizons/Electro-Magic-Tools/pull/112 (1.7.17)
...
# Updated - EnderCore - 0.4.8 --> 0.5.14
**Full Changelog**: https://github.com/GTNewHorizons/EnderCore/compare/0.4.8...0.5.14

## What's Changed:
>* fix world client leak in CustomCubeRenderer by @Alexdoru in https://github.com/GTNewHorizons/EnderCore/pull/34 (0.5.14)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/EnderCore/pull/33 (0.5.13)
>* Sickle AoE Right Click to Harvest by @DrParadox7 in https://github.com/GTNewHorizons/EnderCore/pull/29 (0.5.12)
>* Cache mod loaded checks and fix log spam with Chisel 1 by @koolkrafter5 in https://github.com/GTNewHorizons/EnderCore/pull/31 (0.5.9)
>* cache DyeColor#values() by @Alexdoru in https://github.com/GTNewHorizons/EnderCore/pull/30 (0.5.7)
...
# Updated - EnderIO - 2.9.28 --> 2.10.29
**Full Changelog**: https://github.com/GTNewHorizons/EnderIO/compare/2.9.28...2.10.29

## What's Changed:
>* Remove space suit from end steel armor by @FourIsTheNumber in https://github.com/GTNewHorizons/EnderIO/pull/237 (2.10.29)
>* Localization of gui title elemets by @Ranzuu in https://github.com/GTNewHorizons/EnderIO/pull/236 (2.10.28)
>* Intellij quick fixes by @Alexdoru in https://github.com/GTNewHorizons/EnderIO/pull/234 (2.10.27)
>* Fix 4 world client leaks by @Alexdoru in https://github.com/GTNewHorizons/EnderIO/pull/235 (2.10.27)
>* Fix world client leak in TechneMachineRenderer by @Alexdoru in https://github.com/GTNewHorizons/EnderIO/pull/233 (2.10.26)
>* Fix sort order bounds check on Inventory Panel UI by @ImaMapleTree in https://github.com/GTNewHorizons/EnderIO/pull/228 (2.10.25)
>* Fix Dark Steel Shears duplicating drops from shearable blocks by @clawdbot-silly-waddle in https://github.com/GTNewHorizons/EnderIO/pull/224 (2.10.24)
>* Render travel anchor when holding staff in offhand by @sbancuz in https://github.com/GTNewHorizons/EnderIO/pull/226 (2.10.23)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/EnderIO/pull/225 (2.10.22)
>* Cache frequent Enum#values() calls by @Alexdoru in https://github.com/GTNewHorizons/EnderIO/pull/223 (2.10.21)
...
>* Improve tooltip capacitor and farming station efficiency by @evgengoldwar in https://github.com/GTNewHorizons/EnderIO/pull/215 (2.10.18)
...
>* Delete brute forcing of items to generate Thaumcraft aspects by @Alexdoru in https://github.com/GTNewHorizons/EnderIO/pull/213 (2.10.6)
>* [Memory-opti:fix leak] Fix World leak in ConduitNetworkTickHandler by @Alexdoru in https://github.com/GTNewHorizons/EnderIO/pull/211 (2.10.5)
...
# Updated - EnderStorage - 1.7.7 --> 1.8.3
**Full Changelog**: https://github.com/GTNewHorizons/EnderStorage/compare/1.7.7...1.8.3

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/EnderStorage/pull/25 (1.8.3)
>* Added Optional Localization of gui titles and moved Inventory label to correct spot inside gui by @Ranzuu in https://github.com/GTNewHorizons/EnderStorage/pull/24 (1.8.2)
...
# Updated - EnderZoo - 1.3.3 --> 1.3.4
**Full Changelog**: https://github.com/GTNewHorizons/EnderZoo/compare/1.3.3...1.3.4
...
**Full Changelog**: https://github.com/GTNewHorizons/EnhancedLootBags/compare/1.2.8...1.3.4

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/EnhancedLootBags/pull/21 (1.3.4)
>* Localize GroupName by @Ranzuu in https://github.com/GTNewHorizons/EnhancedLootBags/pull/20 (1.3.3)
>* Change Handler Height & Set it Dynamic by @slprime in https://github.com/GTNewHorizons/EnhancedLootBags/pull/19 (1.3.2)
...
>* Moved ore dictionary registry from postInit to Init by @tiffit in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/61 (2.6.31-GTNH)
...
>* make OceanMonument use fastutil Long2IntOpenHashMap by @Alexdoru in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/53 (2.6.18-GTNH)
>* Add the missing music discs by @ABKQPO in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/52 (2.6.16-GTNH)
>* Fix FMagic Dep by @UltraProdigy in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/57 (2.6.15-GTNH)
>* Fixed duplication of doors during copper oxidization by @nwmqpa in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/42 (2.6.12-GTNH)
>* Simplify observer notification logic by @Caedis in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/46 (2.6.12-GTNH)
>* Readded raw ores to blast furnace recipes by @Caedis in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/48 (2.6.12-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/50 (2.6.11-GTNH)
...
>* Fix spectator visibility leaks for modded backpacks and TConstruct accessories by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/29 (2.6.4-GTNH)
>* Remove baubles api package by @Caedis in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/43 (2.6.4-GTNH)
>* use gtnhlib leaf decay by @Alexdoru in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/36 (2.6.3-GTNH)

# Updated - Eternal-Singularity - 1.2.3 --> 1.4.3
**Full Changelog**: https://github.com/GTNewHorizons/Eternal-Singularity/compare/1.2.3...1.4.3

## What's Changed:
>* Rename Robotic Singularity to Arithmetic Singularity by @Auynonymous in https://github.com/GTNewHorizons/Eternal-Singularity/pull/15 (1.4.3)
...
**Full Changelog**: https://github.com/GTNewHorizons/Fether/compare/0.1.0...2.0.5

## What's Changed:
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Fether/pull/9 (2.0.5)
>* Fix incomplete Remappings corrupting the World by @glowredman in https://github.com/GTNewHorizons/Fether/pull/8 (2.0.4)
...
# Updated - FindIt - 1.4.0 --> 1.4.3
**Full Changelog**: https://github.com/GTNewHorizons/FindIt/compare/1.4.0...1.4.3

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/FindIt/pull/30 (1.4.3)
...
# Updated - FloodLights - 1.5.4 --> 1.5.6
**Full Changelog**: https://github.com/GTNewHorizons/FloodLights/compare/1.5.4...1.5.6
...
>* Fix Wand Metadata by @koolkrafter5 in https://github.com/GTNewHorizons/ForbiddenMagic/pull/25 (0.9.12-GTNH)
>* Convert to config by @LazyFleshWasTaken in https://github.com/GTNewHorizons/ForbiddenMagic/pull/22 (0.9.11-GTNH)
>* Update buildscript by @Ruling-0 in https://github.com/GTNewHorizons/ForbiddenMagic/pull/24 (0.9.10-GTNH)
...
# Updated - ForestryMC - 4.10.17 --> 4.11.26
**Full Changelog**: https://github.com/GTNewHorizons/ForestryMC/compare/4.10.17...4.11.26

## What's Changed:
>* added ability to open backpacks enabled by NoHotbarNeeded by @Erixonich in https://github.com/GTNewHorizons/ForestryMC/pull/105 (4.11.26)
>* Add OreDictionary entry for fertile tree pollen by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ForestryMC/pull/120 (4.11.23)
>* return the correct butterfly when rendering by @Alexdoru in https://github.com/GTNewHorizons/ForestryMC/pull/119 (4.11.19)
...
>* Add fertilizer registry by @C0bra5 in https://github.com/GTNewHorizons/ForestryMC/pull/112 (4.11.12)
...
>* Cache frequent Enum#values() calls by @Alexdoru in https://github.com/GTNewHorizons/ForestryMC/pull/107 (4.11.7)
>* Work on localization and color properties by @Ranzuu in https://github.com/GTNewHorizons/ForestryMC/pull/106 (4.11.6)
>* Allow bees use EFR flowers by @CN132DAS in https://github.com/GTNewHorizons/ForestryMC/pull/104 (4.11.4)
>* Add null guards to BlockUtil reflections to prevent NullPointerExceptions by @Teteros in https://github.com/GTNewHorizons/ForestryMC/pull/103 (4.11.2)
...
# Updated - ForgeMultipart - 1.7.2 --> 1.7.7
**Full Changelog**: https://github.com/GTNewHorizons/ForgeMultipart/compare/1.7.2...1.7.7

## What's Changed:
>* fix npe on chunk unload when tile is null by @alppp in https://github.com/GTNewHorizons/ForgeMultipart/pull/46 (1.7.7)
...
# New Mod - Freecam:1.0.8
**Full Changelog**: https://github.com/GTNewHorizons/Freecam/compare/1.0.2...1.0.8

## What's Changed:
>* Fix flight mods moving player during freecam by @Luca-Guettinger in https://github.com/GTNewHorizons/Freecam/pull/18 (1.0.8)
>* Add compat with controlling combo keybinds by @Caedis in https://github.com/GTNewHorizons/Freecam/pull/17 (1.0.7)
>* unbind unnecessary keys by default by @Alexdoru in https://github.com/GTNewHorizons/Freecam/pull/15 (1.0.6)
>* Give priority to angelica zooming while in freecam by @Caedis in https://github.com/GTNewHorizons/Freecam/pull/13 (1.0.5)
>* Handle EFR gamemode switcher by @Caedis in https://github.com/GTNewHorizons/Freecam/pull/14 (1.0.5)
>* Fullbright Shader Support by @Caedis in https://github.com/GTNewHorizons/Freecam/pull/11 (1.0.4)
>* store perspective when activating tripod by @Caedis in https://github.com/GTNewHorizons/Freecam/pull/9 (1.0.3)
>* Extend EntityPlayer instead of LivingEntityBase by @Caedis in https://github.com/GTNewHorizons/Freecam/pull/10 (1.0.3)
...
>* Fix ingot -> the same ingot recipes by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6967 (5.09.52.582)
>* Improve Debug Computation Hatch by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6857 (5.09.52.582)
>* Changes to Dangote Distillus Distillery mode Parallels by @EdenExecutive in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6971 (5.09.52.582)
>* Spell Tungstensteel correctly by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6973 (5.09.52.582)
>* Swapped textures for ichorium electric wire cutters and angle grinder by @KwazziAus in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6960 (5.09.52.581)
>* [BEC] Recipes for BEC multis and casings (and BW mat frame boxes) by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6959 (5.09.52.581)
>* arc furnace fixes by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6942 (5.09.52.580)
>* Fix missing texture in block renderer by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6948 (5.09.52.580)
>* [BEC] Add MetaMaterials by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6735 (5.09.52.580)
>* Fix structure error text clipping for long casing names by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6950 (5.09.52.580)
>* Fix ore mode in arc furnace by @kuba6000 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6951 (5.09.52.580)
>* Fix LES mParallel always being zero by @Krakenrek in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6952 (5.09.52.580)
>* Fix annealed copper not using oxygen by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6934 (5.09.52.580)
>* fixes LSC exploding after increasing laser target voltage in gui by @Sanduhr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6940 (5.09.52.580)
>* Fix TT block renderer missing textures by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6956 (5.09.52.580)
>* Make fluid pipes directional when placed with wrench in offhand by @mhowell9 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6851 (5.09.52.580)
...
>* LHC rate scaling nerf by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6930 (5.09.52.577)
>* increase durability of mutagenic frames by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6926 (5.09.52.576)
>* Remove space suit from nano/hazmat by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6925 (5.09.52.576)
>* GT Large Boiler "rework" by @Miklebe in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5171 (5.09.52.575)
>* Only check PCB min casing for T3 by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6912 (5.09.52.574)
>* Fix energy infuser did not output charged draconium blocks to output bus by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6914 (5.09.52.574)
>* Fix crash of Legacy Chisel Multiblock by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6911 (5.09.52.574)
>* Add oredict support for RecipeGenMultisUsingFluidInsteadOfCells by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6898 (5.09.52.574)
>* Allow for looting mechanic to work in EEC for the staballoy construct by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6916 (5.09.52.574)
>* Allow output side selection in singleblock GUI by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6909 (5.09.52.574)
>* replace textures for side selection by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6918 (5.09.52.574)
>* LHC calculator widgets by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6815 (5.09.52.574)
>* add batch mode to solar factory by @MLGfruitshoot in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6921 (5.09.52.574)
>* Fix Gorge modules NEI preview by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6923 (5.09.52.574)
>* Fix Hearth not being able to do unlimited tierskips by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6924 (5.09.52.574)
>* Move LNE tooltip registration to en_US.lang by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6902 (5.09.52.573)
>* Optimize recipemap checking and startup with recipe deduplication by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6813 (5.09.52.573)
>* Fix owner being set to null by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6900 (5.09.52.573)
>* No multithreaded needs-structure-check check, and merge all checks per world by @dvdmandt in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4592 (5.09.52.573)
>* T3 PCB Factory Hatch Placement Removed Restriction by @Rikka-Kitani in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6650 (5.09.52.573)
>* Enable MUI2 for naquadah fuel refinery by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6904 (5.09.52.573)
>* mdt hint and screwdriver mode switch fix by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6905 (5.09.52.573)
...
>* Revamp Beamline Tooltips by @DylanTaylor1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6888 (5.09.52.570)
>* Change Mega Chemical Reactor recipe to match LuV Megas by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6882 (5.09.52.569)
...
>* Add scanner info to Hearth & Fridge, fix 1 bug and 1 waila addition by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6800 (5.09.52.560)
>* add matter manipulator to gt5u dep by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6850 (5.09.52.560)
...
>* Remove Dragon Blood from GTPP custom material rendering by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6819 (5.09.52.550)
>* Fixed FOG Plasma Fabricator debug setters by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6821 (5.09.52.550)
>* add a new casing for use in the mdt structure rework and mega oil cracker cleanup by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6756 (5.09.52.548)
...
>* [MUI2] Client to Server sync changes by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6757 (5.09.52.541)
>* Reme required input from mass fab by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6799 (5.09.52.541)
>* GT Modular Armor by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4065 (5.09.52.541)
>* use updated cleaned up StructureLib API by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6789 (5.09.52.539)
>* Fix Legacy FluidShaper checkMachine by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6783 (5.09.52.538)
>* Fix NAC Module wrong Check by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6784 (5.09.52.538)
>* Fixes precise mode on wrenches in toolbox by @querns in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6771 (5.09.52.538)
>* fix skipped checkMachines by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6786 (5.09.52.538)
>* Update Structure Error Translation keys by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6791 (5.09.52.538)
>* Unify recipe result Translation Keys by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6792 (5.09.52.538)
>* adjust structure tooltips of reworked megas by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6785 (5.09.52.538)
>* Fix GT++ Fluid rendering  by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6794 (5.09.52.538)
...
>* Polish UV and UIV Voltage Coil Textures by @jude123412 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6752 (5.09.52.530)
>* fix QOS(NetworkSwitchAdv) Maintenance Element missing by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6753 (5.09.52.530)
>* Optimize performance by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6751 (5.09.52.530)
>* [Structure Rework] Industrial 3D Copying Machine by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6519 (5.09.52.530)
>* Make bio name can be translated by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6601 (5.09.52.529)
>* [BEC] Full Artpass by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6742 (5.09.52.529)
>* Add missing mining levels to ores by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6744 (5.09.52.529)
>* Apply material renderers to gtpp cells by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6745 (5.09.52.529)
>* fix: type-aware drain in depleteInput second pass by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6746 (5.09.52.529)
>* Fix identical tooltips of identical named machines but GTLanguageManager by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6736 (5.09.52.528)
>* Replace `Dyes` RGBA packed color to RGB packed color. by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6693 (5.09.52.528)
>* Remove unused Radio Hatch code. by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6694 (5.09.52.528)
>* Fix PCB Factory controller tooltip by @Angry3vilbot in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6697 (5.09.52.528)
>* Clean up `Element` enum by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6713 (5.09.52.528)
>* Remove unused classes `StreamUtils` & `BWNBTDependantCraftingRecipe` by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6717 (5.09.52.528)
>* Arc furnace fixes by @kuba6000 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6720 (5.09.52.528)
>* More SubstituteFluidStack recipes by @TotallyNotOndre in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6727 (5.09.52.528)
>* Remove PTMEG and chemicals only used to craft PTMEG by @YannickMG in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6691 (5.09.52.528)
>* Diagnostics implementation by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6557 (5.09.52.527)
>* fix stray pixels on ypic texture by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6732 (5.09.52.526)
>* Increase the speed of T4 Nano Forge survival autoplace by @Angry3vilbot in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6728 (5.09.52.526)
>* MUI2: Port non-recipe map SB machines to MUI2 by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6729 (5.09.52.526)
>* Cleanup gt++ fluid utils wildcard fluid lookup functions. by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6733 (5.09.52.526)
>* fix FierySteel cellMolten item showing wrong lang key by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6730 (5.09.52.526)
>* [MUI2] Ported MTERegulator to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6438 (5.09.52.526)
>* [Structure Rework] Thermal Boiler by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6473 (5.09.52.526)
>* Fix Treefarm populating NEI twice and fix both farms not being able to use all saplings by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6624 (5.09.52.526)
...
>* Fix GT++ Textures in GTNH CoreMod Dev Env by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6718 (5.09.52.524)
>* Fix Symmetry in Exo-Foundry Again... by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6725 (5.09.52.524)
>* FluidStack Substitutions by @TotallyNotOndre in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6661 (5.09.52.524)
>* Fix class cast exception for MTESteamMultiBlocks when using a void bus by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6573 (5.09.52.522)
>* added missing minewood to tree growth simulator by @Quollveth in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6703 (5.09.52.522)
>* Fix and make LNE tooltip + recipes + chlorosulfonic acid line more consistent by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6570 (5.09.52.521)
>* Use getMetaTileEntity over field reference by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6711 (5.09.52.521)
>* Fix Wireless Machine Controller cover crash on redstone button click by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6712 (5.09.52.521)
>* Unify multiblock button tooltips by @hanben02 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6517 (5.09.52.519)
>* New uses for beams in UHV by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6682 (5.09.52.519)
>* Fix oopsie in arc furnace tooltip by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6710 (5.09.52.519)
>* Fix space miner GUI crash from missing cycleDistance sync handler by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6708 (5.09.52.518)
>* Band aid fix for BEC gui crash by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6707 (5.09.52.518)
>* Refactor BaseMetaTileEntity::updateEntityProfiled into smaller methods by @TechLord22 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6028 (5.09.52.518)
>* [Fix] TT Hatch discovery & classification by @Sanduhr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6709 (5.09.52.518)
>* [Structure Rework] Industrial Arc Furnace by @kuba6000 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6342 (5.09.52.518)
>* Added CompositeParameter + small changes by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6639 (5.09.52.516)
...
>* Fixed nbt not saving/loading properly in output hatch by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6698 (5.09.52.511)
>* Show "Works with any stack size" on cauldron NEI recipes by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6458 (5.09.52.510)
>* Spinmatron localization by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6695 (5.09.52.510)
>* [MUI2] Ported MTEHatchOutput to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6676 (5.09.52.510)
>* [MUI2] Ported MTESuperBuffer to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6442 (5.09.52.510)
>* [MUI2] Ported MTERecipeFilter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6625 (5.09.52.509)
>* [MUI2] Ported MTETypeFilter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6626 (5.09.52.509)
>* fix(outputme): fix output bus me void items when multipie transactions occur in 1t. by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6683 (5.09.52.509)
>* Fix flasks renderer by @NeutronSelector in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6684 (5.09.52.509)
>* [Structure Rework] XL Turbines by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6562 (5.09.52.509)
>* [MUI2] Ported MTETeleporter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6527 (5.09.52.509)
>* Remove duplicate textures by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6681 (5.09.52.509)
>* Fix broken GT++ textures by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6687 (5.09.52.509)
>* [MUI2] Ported MTEFilter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6456 (5.09.52.509)
>* Show multiblocks area work in world by @NeutronSelector in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6516 (5.09.52.509)
>* Fix server crash when opening some covers by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6690 (5.09.52.509)
>* Parametrizer card copy for SE Mining Module's Filter by @Krepyn in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6685 (5.09.52.509)
>* Prevent unsafe cast to interfere OC calculator by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6675 (5.09.52.508)
>* Fix Forge of Gods beam crash by re-binding VBO before draw calls by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6670 (5.09.52.508)
>* MUI2 Reactive Cover Popup by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6619 (5.09.52.508)
>* [MUI2] Ported MTESpecialFilter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6613 (5.09.52.508)
>* Fixed misc MUI2 stuff by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6677 (5.09.52.508)
>* Changed MessageFormat inside ME bus/hatch by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6679 (5.09.52.508)
>* Fix Naquadah Cauldron Washing Recipe in NEI by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6651 (5.09.52.508)
>* Adjust Large Hadron Collider Info Panel GUI by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6678 (5.09.52.508)
>* [Structure Rework] Algae Pond by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6534 (5.09.52.508)
>* [MUI2] (Re)Ported ItemVolumetricFlask to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6477 (5.09.52.508)
>* [MUI2] Ported ItemCircuitProgrammer to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6522 (5.09.52.508)
>* [MUI2] Finished port of ItemIntegratedCircuit to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6496 (5.09.52.508)
>* [MUI2] Finished port of the Infinite Spray Can to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6494 (5.09.52.508)
>* fix(structure): add minimum casing limit check to dangote by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6460 (5.09.52.507)
>* implement buffering for removeRecipeByOutputDelayed calls with non-default options by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6491 (5.09.52.507)
>* remove pump tokens from existence by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6663 (5.09.52.507)
>* LHC balancing tweaks for Higgs and power cost by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6662 (5.09.52.507)
>* Fix ME stocking hatches NPE when owner UUID is null by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6664 (5.09.52.507)
>* [Structure Rework] Infinite Fluid Drilling Rig by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6508 (5.09.52.507)
>* Add a tooltip for the manual slot by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6669 (5.09.52.507)
>* Add unique top and bottom texture to fireboxes by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6672 (5.09.52.507)
>* fix: allow 1-volt Solar Panel to export EU by @Junyan721113 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6666 (5.09.52.507)
>* Fix stocking hatches not pulling when owner has changed nickname by @Lyfts in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6644 (5.09.52.506)
>* Fixes for showSlotOverlay by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6652 (5.09.52.506)
>* Fixes the worst block misplacement of all time  by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6658 (5.09.52.506)
>* Fix boiler fuel indicator and improve GUI readability by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6571 (5.09.52.506)
>* [MUI2] Ported MTEFilterBase to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6444 (5.09.52.506)
>* Fixed broken offhand interaction in GTPacketUpdateItem by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6659 (5.09.52.506)
>* Remove invalid item fuel acceptance from geothermal and rocket engines by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6660 (5.09.52.506)
>* Correctly detect active stack for tooltip by @slprime in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6643 (5.09.52.505)
>* Remove invalid item fuel acceptance from semi-fluid generator by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6642 (5.09.52.505)
>* Debloat long wood stick recipe for NEI readability by @Algent in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6414 (5.09.52.505)
>* Fix Coke Oven Hatch texture not updating on screwdriver right-click by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6646 (5.09.52.505)
>* Delete empty files by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6648 (5.09.52.505)
>* Clean up Bartworks material integration by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6647 (5.09.52.505)
>* Fix MV rock cutter not being craftable by @Algent in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6640 (5.09.52.504)
>* Fix saw breaking placing water when breaking ice by @DarkShadow44 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6641 (5.09.52.504)
>* Fixed Extrusion Bus Ghost Shape Bug by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6331 (5.09.52.502)
>* Fix BEC casing texture indices by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6637 (5.09.52.502)
>* fix pump button offset by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6629 (5.09.52.500)
>* fix extruder not forming with only cribs by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6636 (5.09.52.500)
>* fix(outputme): prevent voiding extra fluids when multiple output overflow by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6630 (5.09.52.500)
...
>* Fix useInventoryTint not being properly reset by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6627 (5.09.52.496)
>* ECE multiple fixes by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6617 (5.09.52.495)
>* Fixed iApiary's accelerated secondary bee effect by @thehoblit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6621 (5.09.52.495)
>* Fix Uncertainty MatrixElemet typo and refresh bugs by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6615 (5.09.52.495)
>* Clean up small TODOs by @doshibadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6614 (5.09.52.495)
...
>* Chunkapi by @Cardinalstars in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5860 (5.09.52.485)
>* Changed the transparent fluid slot inside tanks to be texture by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6579 (5.09.52.485)
>* Fix: Improve legacy Unicode font fallback and fullwidth punctuation rendering by @PinkYuDeer in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6591 (5.09.52.485)
>* lhc output roll fix to be per hatch. also add scan message if off by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6593 (5.09.52.485)
>* Fix ore spawn by checking if ores have been placed, if not retry by @arisado in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6583 (5.09.52.485)
>* Fix Redstone Sniffer crash on server by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6584 (5.09.52.484)
>* Added helper functions to parameter classes by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6585 (5.09.52.484)
>* make exotic energy hatches respect the glass tier in MCR by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6588 (5.09.52.484)
>* Platline Platinum loop recipe fix and alignment for tiny dust by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6463 (5.09.52.484)
>* [Structure Rework] Steam Squasher (compressor) by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6545 (5.09.52.484)
>* [Structure Rework] Cryogenic Freezer by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6478 (5.09.52.484)
>* [Structure Rework] Large Naquadah Reactor by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6359 (5.09.52.484)
>* [Structure Rework] Large Turbines by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6546 (5.09.52.484)
>* fix npe when recipe locking with chanced outputs by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6582 (5.09.52.482)
...
>* Replace deprecated CapturingTessellator with Direct by @sisyphussy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6515 (5.09.52.476)
>* Fixed unlocalized values to have mui2 theme by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6569 (5.09.52.476)
>* Performance improvement of various hatches by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5900 (5.09.52.476)
>* Add Hexanite and BEC material twin metal blocks by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6575 (5.09.52.476)
...
>* fix fluid tank duplication in waila for machines with only one fluid slot by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6525 (5.09.52.468)
>* Add OrePrefixes to all StoneTypes that lack one by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6499 (5.09.52.468)
>* LHC/stabilizer minor fixes + Quark catalyst recipe adjustment by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6556 (5.09.52.468)
>* Fix incorrect support bools for ZFP, TGS and IMS by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6558 (5.09.52.468)
>* allow all glasses on Macerator and Rock Breaker by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6559 (5.09.52.468)
...
>* Large neutralization engine by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6117 (5.09.52.465)
>* HTGR's recipe and NEI fix by @6C-C6 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6472 (5.09.52.463)
>* Make cryotheum recipe use lapis instead of redstone by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6514 (5.09.52.463)
>* Add max circuit wrap recipe by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6518 (5.09.52.463)
>* Fix bio circuit board texture xD by @jude123412 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6521 (5.09.52.463)
>* Add cauldron tooltip to Flour by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6524 (5.09.52.463)
>* Fix cauldron NEI page missing purified dusts, crushed ores, and wheat by @Luca-Guettinger in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6482 (5.09.52.463)
>* Fix depleteInput not aggregating fluid hatches by @54M44R in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6505 (5.09.52.461)
>* Changed GTPacketUpdateItem to account for backhand item by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6495 (5.09.52.461)
>* Deprecate Buffered Dynamo and allow 4A TT Hatches by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6513 (5.09.52.461)
>* Fix Theme name by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6507 (5.09.52.459)
>* Fix Beam Crafter's recipe check for effective voltage  by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6509 (5.09.52.459)
>* Fixed Void Metal Pipe has no name, and the Void is renamed Void Metal by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6453 (5.09.52.459)
>* [Structure Rework] Tree Grow Simulator by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6511 (5.09.52.459)
>* made nano forge use iridium casing instead of europium casing by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6512 (5.09.52.459)
>* Improve GT machine and Crafting Input Bus display names in AE2 terminal by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6437 (5.09.52.457)
>* Check if StoneType is null for GTBlockOre by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6492 (5.09.52.456)
>* balance changes to staballoy loot drops by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6336 (5.09.52.456)
>* Simplify Staballoy Drop Logic by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6497 (5.09.52.456)
>* Wire cutter multi-cable connection by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6448 (5.09.52.455)
>* Fix Recipe EU Values by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6493 (5.09.52.455)
>* ATLAS casing recipe adjustment by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6487 (5.09.52.454)
>* Fix fluid pattern highlight in Interface Terminal for Crafting Input Buffer by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6489 (5.09.52.454)
>* Fix ItemDimensionDisplay using client-only I18n by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6490 (5.09.52.454)
>* Drop covers and clear colorization on shift break by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6485 (5.09.52.454)
>* New Circuit Board Textures + Exotic, Cosmic, and Transcendent Circuit Boards by @jude123412 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6488 (5.09.52.454)
...
>* Fix LCE not generating any EU by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6461 (5.09.52.449)
>* Fix ECE not generating any EU by @tiffit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6464 (5.09.52.449)
>* Fix broken structure writer and add QoL button by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6465 (5.09.52.449)
...
>* Add AnyCarbon oredict by @TotallyNotOndre in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6373 (5.09.52.446)
>* chore(fix): prevent amforge from duplicating fluid cost from multi hatches by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6184 (5.09.52.446)
>* MTEBasicMachineWithRecipe builder by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5952 (5.09.52.445)
>* Add missing discount for MTEMassSolidifier by @54M44R in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6436 (5.09.52.445)
>* Remove old-unused nanochip assembly compex brain icon by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6434 (5.09.52.445)
>* minor GTModHandler optimizations by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6378 (5.09.52.445)
>* Make the planck manifold a real item by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6447 (5.09.52.445)
>* Implement IInterfaceNameProvider to expose ghost circuit config in AE2 terminal by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6368 (5.09.52.444)
>* [MUI2] Ported MTEDebugStructureWriter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6250 (5.09.52.444)
>* [MUI2] Ported MTEHatchUncertainty to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6386 (5.09.52.444)
>* [MUI2] Ported MTEHatchMaintenance to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6265 (5.09.52.444)
>* [MUI2] Ported MTEHatchWirelessMulti to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6419 (5.09.52.444)
>* [MUI2] Ported MTEHatchWirelessComputationInput to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6416 (5.09.52.443)
>* [MUI2] Ported MTEHatchObjectHolder to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6269 (5.09.52.443)
>* [MUI2] Ported MTEHatchInputME to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6234 (5.09.52.443)
>* [MUI2] Finished port of MTEDigitalTankBase to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6212 (5.09.52.443)
>* Add muffler button to radio hatch gui by @kx08 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6268 (5.09.52.443)
>* [MUI2] Moved charger slot creation from MTEBasicMachineWithRecipeBaseGui to parent class by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6432 (5.09.52.442)
>* [MUI2] Port Space Miner Module GUI by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5597 (5.09.52.442)
>* [MUI2] Ported MTEBuffer to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6426 (5.09.52.442)
>* [MUI2] Ported MTEHatchSteamBusOutput to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6283 (5.09.52.442)
>* [MUI2] Ported MTEHatchOutputBusME to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6275 (5.09.52.442)
>* [MUI2] Ported MTEHatchMultiInput to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6266 (5.09.52.442)
>* [MUI2] Ported MTEBuckConverter to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6247 (5.09.52.442)
>* [MUI2] Ported MTEDebugPollutor to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6248 (5.09.52.442)
>* [MUI2] Ported MTELinkedInputBus to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6174 (5.09.52.442)
>* [MUI2] Ported MTEHatchInputBusME to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6157 (5.09.52.442)
>* [MUI2] Ported MTEDebugPowerGenerator to MUI2  by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6249 (5.09.52.442)
>* [MUI2] Port of MTEHatchInputBattery and MTEHatchOutputBattery by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6025 (5.09.52.442)
>* [MUI2] Ported MTEHatchOutputME to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6277 (5.09.52.442)
>* Add Planck-Scale Circuit NAC Items + Hexanite by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6430 (5.09.52.442)
>* [MUI2] Ported MTEHatchRack to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6309 (5.09.52.442)
>* New power IC integration by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6428 (5.09.52.442)
>* Replacing Duplicate Textures by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6241 (5.09.52.440)
>* Fix washer structure check by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6415 (5.09.52.439)
>* Minor godforge statistics panel UI fixes by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6417 (5.09.52.439)
>* Beamcrafter logic fixes (round 2) by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6239 (5.09.52.439)
>* Structure Rework various fixes by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6423 (5.09.52.439)
>* fix world leak caused by MobHandlerLoader$MobEECRecipe#entityCopy by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6427 (5.09.52.439)
...
>* Refix vajra ghost block by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6405 (5.09.52.434)
>* put check in regular centrifuge to not run heavy mode recipes by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6408 (5.09.52.434)
>* add line about unlimited tierskips to the spinmatron by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6410 (5.09.52.434)
>* add back EU capacity of machines in the tooltip by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6399 (5.09.52.432)
>* Disable the GUI from opening for the Wireless Assembly Line Reception Connector and the Assembly Line Reception Connector by @ABKQPO in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6398 (5.09.52.432)
>* Add extra slots for hv+ Chembath singleblocks by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6376 (5.09.52.430)
>* Add more recipe locking support by @54M44R in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5005 (5.09.52.430)
>* [Structure Rework] Industrial Washer / Industrial Chemical Bath by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6371 (5.09.52.430)
>* [Structure Rework] Electric Implosion Compressor by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6339 (5.09.52.430)
>* [Structure Rework] Boldarnator by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6319 (5.09.52.430)
>* Add Missing Structure Channel Tooltips by @DylanTaylor1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6387 (5.09.52.430)
>* Make iron bars paid again by @TotallyNotOndre in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6393 (5.09.52.430)
>* Fix processingLogic overflow for spinmatron by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6395 (5.09.52.430)
>* Make the game blow up on null oredict recipes inputs by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6394 (5.09.52.430)
>* Add toggle for power goggles measurement section / Fix rounding issue by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6305 (5.09.52.430)
>* Fix new mixer multiamp restrictions by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6392 (5.09.52.430)
>* [Structure Rework] Industrial Coke Oven by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6391 (5.09.52.430)
>* [Structure Rework] Industrial Maceration Stack by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6271 (5.09.52.430)
>* [Structure Rework] Zhuhai Fishing Port by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6257 (5.09.52.430)
...
>* [MUI2] Ported MTEHatchOutputBus to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6270 (5.09.52.426)
>* [MUI2] Ported MTEBasicGenerator to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6235 (5.09.52.426)
>* [MUI2] Small UI fix for MTEHatchEnergyDebug by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6246 (5.09.52.426)
>* [MUI2] Port of MTEBasicBatteryBuffer by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6029 (5.09.52.426)
>* Speedup remove recipe by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6370 (5.09.52.426)
>* Fix debug input hatch usage on some multis by @kuba6000 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6352 (5.09.52.424)
>* shift ids to avoid issues with armor PR on experimental builds by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6367 (5.09.52.424)
>* Add UEV-MAX Voltage Coil Items by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6366 (5.09.52.423)
>* Nei Handler Refactoring by @slprime in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6297 (5.09.52.422)
>* Buff MHDCSM v2 Recipe for new EIC by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6346 (5.09.52.421)
>* Fixed missing translation for the "EU" string by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6348 (5.09.52.421)
>* [Structure Rework] Planetary Gas Siphon by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6310 (5.09.52.421)
>* Reduce Magic Feather from EV -> HV Voltage by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6354 (5.09.52.421)
>* [Structure Rework] Advanced Implosion Compressor (Density^2) by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6317 (5.09.52.421)
>* Add a few blocks to Casings.java by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6358 (5.09.52.421)
>* HTGR Changes by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6351 (5.09.52.421)
>* [Structure Rework] Extreme Combustion Engine by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6349 (5.09.52.421)
>* [MUI2] Small fixes + bump mui2 version by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6357 (5.09.52.421)
>* Void Miner Filter GUI Improvements by @purebluez in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6302 (5.09.52.421)
>* rm -rf GtPlusPlus unused stuff by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6341 (5.09.52.420)
>* [Structure Rework] Large Combustion Engine by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6340 (5.09.52.420)
>* [Structure Rework] UCFE by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6312 (5.09.52.420)
>* [Structure Rework] Pyrolyse Oven by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6313 (5.09.52.420)
>* Tooltip Changes by @DylanTaylor1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6281 (5.09.52.420)
>* add assembler recipe for Forming Core by @KleinGrrmpf in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6345 (5.09.52.420)
>* [Structure Rework] Naquadah Fuel Refinery by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6252 (5.09.52.420)
>* Add extra slots to digester by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6347 (5.09.52.420)
>* Use ItemStackNBT helper where possible to make code cleaner and less prone to errors by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6335 (5.09.52.419)
>* rm -rf GtPlusPlus Logger by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6338 (5.09.52.419)
>* Make Hammer & Jackhammer Behavior Consistent by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6332 (5.09.52.419)
>* Assets and code optimization of GTPP and some GT by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6328 (5.09.52.418)
>* Add new Block: Forming Core by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6334 (5.09.52.418)
>* Fix int overflow in IOF fluid and item accumulation. by @luoyangyuli2001 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6272 (5.09.52.418)
>* [MUI2] Upstream sync fixes by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6321 (5.09.52.417)
>* Fixed Drone Remote Interface NPE by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6333 (5.09.52.417)
>* Change PGS Tooltip to add awareness of hatch restrictions by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6320 (5.09.52.417)
>* Fix inverted labels in conveyor, pump, fluid detector covers by @kuba6000 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6315 (5.09.52.417)
>* Added new widget theme to be used on unlocalized values by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6318 (5.09.52.417)
>* Change MTESteamMultiBlockBase base class to ExtendedPowerMultiBlockBase by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6160 (5.09.52.416)
>* Fix NPE in `getAccessibleSlotsFromSide` of `MTEHatchCokeOven` by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6324 (5.09.52.416)
>* delete gt++ INIT_PHASE enum and hardcore mod id by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6280 (5.09.52.416)
>* [Structure Rework] Boilers by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6251 (5.09.52.415)
>* (Semi) Remove Capsules by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6301 (5.09.52.415)
>* Refactor basic machine localization (dynamic tooltips, lang keys) by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6282 (5.09.52.415)
>* [Structure Rework] industrial mixer by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5963 (5.09.52.415)
...
>* Fixed incorrect chat message when filtering ME output hatch/bus by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6276 (5.09.52.411)
>* fix(outputme): correct fluid check and enhance info display by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6198 (5.09.52.411)
>* Simplify Fluid Heater recipe map by @KleinGrrmpf in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6304 (5.09.52.411)
>* Fix ICO imported oredict recipes by @TotallyNotOndre in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6306 (5.09.52.411)
>* Decrease time cost of diluted acid recycling recipes by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6258 (5.09.52.411)
>* fix nac survival autoplace to be 500 instead of 25 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6307 (5.09.52.411)
>* Complete Hypogen Texture Revamp by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6290 (5.09.52.411)
>* Add missing controller positions by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6286 (5.09.52.411)
>* fix(outputme): localize filter update by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6279 (5.09.52.411)
>* Fix Auto-Taping Maintenance Hatch by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6261 (5.09.52.411)
...
>* Replace ic2 solar panel with 1-volt Solar Panel by @thehoblit in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6291 (5.09.52.407)
>* Fix dtpf description for output bus count by @JMan-Zx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6287 (5.09.52.405)
>* Fix default melting point (1123K) pollution by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6260 (5.09.52.403)
>* Reduce number of T3 casings for LHC from 380 to 158 by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6284 (5.09.52.403)
>* Small Typos fix by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6285 (5.09.52.402)
>* Fix gt tank fluid dupe by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6228 (5.09.52.401)
>* Use GTUtility translations and update tooltips by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6255 (5.09.52.400)
>* Added clickable progress bar to LHC NEI handler by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6278 (5.09.52.400)
>* Add back necessary fluid keys by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6274 (5.09.52.399)
>* Fix tgs max tier overclock behavior by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6273 (5.09.52.399)
...
>* Increase burn values of various acid generator acids by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6244 (5.09.52.396)
>* Add Water Placement to Clarifier and Flotation Cell by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6240 (5.09.52.396)
>* Fix Typo in UV Chem Reactor by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6253 (5.09.52.396)
>* Buff Multiamp Fluid Requirements 4x by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6254 (5.09.52.396)
>* Fix description for input hatch ME autopull by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6238 (5.09.52.395)
>* Fix typo in Mining Drone MK-XII name by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6237 (5.09.52.395)
>* Fixed error tooltips by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6231 (5.09.52.395)
>* [MUI2] Ported MTEBasicTank to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6178 (5.09.52.394)
>* Fix fill/drain for GT++ tanks by @Kogepan229 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6227 (5.09.52.394)
>* Beamcrafter logic fix by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6185 (5.09.52.394)
>* Downtier incoloy-903 to EV ABS by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6232 (5.09.52.394)
>* Double Incoloy-903 Recipe Time to Correspond w/ Voltage Change from #6232 by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6233 (5.09.52.394)
>* Remove Granite Compression Conflict by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6224 (5.09.52.394)
>* Change 3d copying machine default mode by @LooseEthics in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6133 (5.09.52.394)
>* Fix dissolution tank input parsing by @LooseEthics in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6094 (5.09.52.394)
>* Make naq wafers engrave with all lenses in oredict by @LooseEthics in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6194 (5.09.52.394)
>* Reverse recipes mode in crafting proxies by @khaskelbergTAU in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6168 (5.09.52.394)
>* chore(fix): fix wrong fluid temperature logic by @Nana-Sakura in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6207 (5.09.52.393)
>* Fixed Components of Tungsten Carbide of GTPP are null by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6214 (5.09.52.392)
>* Remove Redundant Tooltip by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6217 (5.09.52.392)
>* bump dep to prevent crashing in dev env by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6218 (5.09.52.392)
>* Fixed GTPP's Plasma does not have a correct name by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6219 (5.09.52.392)
>* Add fluid localized keys by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6206 (5.09.52.392)
>* refactor(render): enforce SBRContext encapsulation via static factory by @leagris in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6216 (5.09.52.392)
>* Move book texts to lang keys and translate via GTUtility by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6199 (5.09.52.392)
>* Removing unnecessary localization keys by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6221 (5.09.52.392)
>* LHC custom NEI handler by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6195 (5.09.52.392)
>* Update tooltip for glass fiber circuit part by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6215 (5.09.52.392)
>* [Structure Rework] Flotation Cell by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6176 (5.09.52.392)
>* fix master not building by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6222 (5.09.52.392)
>* Remove EnderIO bars & Tungsten Bars by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6202 (5.09.52.391)
>* LATEX tooltip change: eXpert to eXocoater by @bencimp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6201 (5.09.52.391)
>* Use StatCollector for fluid localization by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6205 (5.09.52.391)
>* Fix toolbox localization: use GTUtility.translate and preserve super tooltip by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6197 (5.09.52.391)
>* Remove Molten Magnetic Fluid Autogen by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6208 (5.09.52.391)
>* Toolbox Fixes part 3 by @querns in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6192 (5.09.52.391)
>* Fix Thermal Centrifuge constructor name by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6210 (5.09.52.391)
>* Research Recipe Output Fix by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6209 (5.09.52.391)
>* Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5261 (5.09.52.391)
>* Fix awkward duration value of UUM recipes by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6213 (5.09.52.391)
>* [Breaking] final mega apiary symmetry fixes by @Sanduhr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6191 (5.09.52.390)
>* fix(outputme): follow-up fix for outputme by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6193 (5.09.52.390)
>* Remove gt language manager from gt generic item gt fluid by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6079 (5.09.52.390)
>* Add localization support for MetaGeneratedItem display names and tooltips by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6064 (5.09.52.390)
>* Fix cables transfering energy through energy-blocking covers in certain cases by @C-Remilian in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6143 (5.09.52.390)
>* Update LATEX Tooltip by @bencimp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6190 (5.09.52.390)
>* Corrected UCFE Tooltip by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6179 (5.09.52.389)
>* Compact Cyclotron deprecation by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6166 (5.09.52.389)
>* Thermal Centrifuge Strucutre Rework fixes by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6181 (5.09.52.389)
>* [Breaking] Fix another typo in mega apiary structure for symmetry by @Sanduhr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6183 (5.09.52.389)
>* [Strucuture Rework] Molecular transformer by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6182 (5.09.52.389)
>* DTPF TT hatches compatibility on tooltip by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6186 (5.09.52.389)
>* Put Tier In Mining Drone Name by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6189 (5.09.52.389)
>* Remove Deprecated QFT Catalysts by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6180 (5.09.52.389)
>* [MUI2] Ported MTETieredMachineBlock to MUI2 by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6175 (5.09.52.389)
...
>* Improve explosion logging by @konradmoesch in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6162 (5.09.52.387)
>* fix power calculation in IOF by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6165 (5.09.52.387)
>* Chat message localization 20260318 by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6123 (5.09.52.387)
>* Add strontium to prismatic qft by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6164 (5.09.52.387)
>* [Breaking] Make Mega Apiary symmetric by @Sanduhr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6153 (5.09.52.386)
>* fix integrated ore factory not respecting recipe time + remove batch mode by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6156 (5.09.52.386)
>* Source chamber - new Neutrons recipe added by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6137 (5.09.52.386)
>* Align GT++ fluid extractor recycling EU/t with material tier voltage by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6154 (5.09.52.383)
>* Toolbox now deselects tools when pick blocking maint hatch by @querns in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6149 (5.09.52.383)
>* fix flickering waila color info for input hatches by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6116 (5.09.52.381)
>* Delete duplicate MTETooltip class by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6147 (5.09.52.381)
>* [Structure Rework] Integrated Ore Factory by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6062 (5.09.52.380)
>* Make MTEDrillerBase use Enums instead of magic numbers by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6148 (5.09.52.379)
>* Refactor fix class inheritance issues by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6150 (5.09.52.379)
>* Refactor beamline and LHC to use casings enum for shielded acc. casing by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6151 (5.09.52.379)
>* Manually parse clamping when everything in it are constants by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6152 (5.09.52.379)
>* Beamcrafting multis structure downtiering by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6144 (5.09.52.378)
>* Fix batch mode on the infinite fluid drilling rig by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6140 (5.09.52.378)
>* extract batch mode toggle method to the parent class instead of copying it 32 times... by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6139 (5.09.52.378)
>* fix oil recipe by @czqwq in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6135 (5.09.52.377)
>* Fix a few GT++ server side crashes where keys are checked by @DarkShadow44 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6138 (5.09.52.377)
>* Fix lang key by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6134 (5.09.52.377)
>* Attempt Fix of EEC Rotation Bug by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6125 (5.09.52.375)
>* Fix consistent EEC rotation bug by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6131 (5.09.52.375)
>* Various powerfail fixes by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6129 (5.09.52.375)
>* refactor(util): fix calculation of incomplete tick data in AveragePerTickCounter. by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6127 (5.09.52.375)
>* revert volumetric flask mui2 for now by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6109 (5.09.52.375)
>* Toolbox / ME pick block fix by @querns in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6130 (5.09.52.375)
>* Add simulatedSink impl for AEInventoryItemIO by @hiroscho in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6128 (5.09.52.375)
>* Beamcrafter fixes and GUI by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6124 (5.09.52.373)
>* Fix Space Miner output chance bug and "Clay & Cheese cannot be acquired from Space Elevator" by @SST-03 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6017 (5.09.52.371)
>* Remove IC2 Furnace From Recipes by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6126 (5.09.52.370)
>* Chat message localization 20260307 by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6072 (5.09.52.369)
>* expose recipe debug flags by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6122 (5.09.52.369)
>* Add the Large Hadron Collider multiblock by @ham-corp in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5135 (5.09.52.368)
>* Add material and block type descriptions to tooltips in various machine classes by @PantACRO4life in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6113 (5.09.52.367)
>* remove delay from fluid i/o slots on singleblock machine guis by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6115 (5.09.52.366)
>* Fix Wirecutter Interaction w/ ME Chest & Drive by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6101 (5.09.52.365)
>* make the ME hatch tooltip not absurdly long by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6111 (5.09.52.365)
>* Fix 3 plastics showing as "ingot/plate" instead of "bar/sheet" by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6112 (5.09.52.365)
>* Bump PostEA by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6114 (5.09.52.365)
...
>* Optional resource by @leagris in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5781 (5.09.52.360)
...
>* disable shift transfer on the item_inv group by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6099 (5.09.52.355)
>* Fix Tooltips for Wireless in LSC and Caps by @Sanduhr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6096 (5.09.52.354)
>* Rework Processing recipes to use oredicts when applicable by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6088 (5.09.52.354)
>* fix: solar tower can't use projector build by @riggzh in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6056 (5.09.52.350)
>* Downtier Fluorphlogopite insulator foil recipe by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6095 (5.09.52.350)
>* Remove Duplicate Stone Plate Compression by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6093 (5.09.52.348)
>* Standardize tooltips of multi amp hatches by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6082 (5.09.52.347)
>* Fix "PurificationUnitDegasser outputs more Grade 7 Water than expected when using SuperconductorUIVBase" by @SST-03 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6092 (5.09.52.347)
>* [MUI2] Added power and muffler button disables by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6090 (5.09.52.347)
>* fix circuit slot not doing recipe check by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6091 (5.09.52.346)
>* cull hardcoded space by @ChromaPIE in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6085 (5.09.52.346)
>* Add new Configs & fix bug by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5871 (5.09.52.345)
>* Warn if oredict is empty by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6087 (5.09.52.345)
>* Add fluorophlogopite plate recipes by @LooseEthics in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6081 (5.09.52.345)
>* Several fix for drone centre rework by @RealSilverMoon in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5932 (5.09.52.345)
>* Fix Stargate Plate Recipe by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6089 (5.09.52.345)
>* Rename GT Planks to <woodType> Plank Cover; add oredict by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6086 (5.09.52.344)
>* Replaced old MTEDebugStructureWriter with the advanced version by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6078 (5.09.52.343)
>* Add MTE Chisel ArchitectureCraft Compat by @dragongod100 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5992 (5.09.52.343)
>* Fix MBM Tooltips by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6083 (5.09.52.343)
>* Enhance the resource pack ability for CoverTabs by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6084 (5.09.52.343)
>* use the mui2 client method instead of gt mod??? by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6071 (5.09.52.342)
>* EEC Rotation by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5935 (5.09.52.342)
>* Colorize GT++ fluorite ore by @koolkrafter5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6070 (5.09.52.342)
>* Add basic non-GT oredict item support in all machine recipes by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6055 (5.09.52.342)
>* Fixed a bug where you could not open a chest cover after opening the first one on a block with more than one attached by @glektarssza in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6068 (5.09.52.342)
>* [MUI2] Ported MTEBlackHoleUtility by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6074 (5.09.52.342)
>* change MTEBasicMachineBaseGui.java to MTETieredMachineBlockBaseGui.java by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6077 (5.09.52.342)
>* use long packing to avoid allocating object wrappers in the render loop in MetaGeneratedItemRenderer by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6066 (5.09.52.341)
>* remove crops++ reference by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6067 (5.09.52.341)
>* Add missing hatches to structure tooltip by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6069 (5.09.52.341)
...
>* fix(gui): localize empty fluid labels client-side in tank and hatches by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5951 (5.09.52.328)
>* Lava thermal boiler tooltip update  by @noah-cope-dev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5969 (5.09.52.327)
>* Misc speedups by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6038 (5.09.52.326)
>* Add documentation for the casing page used by CropsNH by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6042 (5.09.52.326)
>* fix waterline to run recipes by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6045 (5.09.52.326)
>* Recolor spinel to be distinct from ruby by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6043 (5.09.52.326)
>* Remove ids of old slicers by @NeutronSelector in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6034 (5.09.52.326)
>* Refactor mtewireless charger tooltip by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6032 (5.09.52.326)
>* Fix Neutron Activator hanging the server when not totally chunkloaded by @Worive in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6024 (5.09.52.326)
>* Improvement mtetieredtank tooltip by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6023 (5.09.52.326)
...
>* Add AE quartz knife renaming functionality to wirecutter by @kx08 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5956 (5.09.52.323)
>* remove salty root correctly by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6030 (5.09.52.323)
>* GT fluid registry cleanup by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5859 (5.09.52.322)
>* CropsNH Integration (Recipe removals and depreciations) by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5652 (5.09.52.321)
>* move mass solidifier down in the nei list  by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6027 (5.09.52.320)
>* Remove unnecessary addFluidContainerData calls by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5848 (5.09.52.320)
>* Orb scan fix by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6026 (5.09.52.319)
>* Cleanup NAC Structure Tooltip by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5996 (5.09.52.319)
>* Update postea handlers for new version. by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5806 (5.09.52.319)
>* Fix Crash with LMA in Interface Terminal, Add Temporary Texture for Pattern Provider by @asquared31415 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5979 (5.09.52.318)
>* Modularize scanner processing logic and Improve Research Station by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5677 (5.09.52.318)
>* Replace MAX w/ UHV for Distributor & Energy Buffer by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6015 (5.09.52.317)
>* Fix dependencies.gradle by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6012 (5.09.52.317)
>* fix ME Output Buses/Hatches void their stored content on server restart by @lc-1337 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6014 (5.09.52.317)
>* Refactor fluid text color handling by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6018 (5.09.52.317)
>* Adjust CPU Mask Uses (10->100) by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6020 (5.09.52.317)
>* Lowered harvest level of BlockFrameBox to iron/bronze by @noah-cope-dev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5973 (5.09.52.316)
>* add all needed controller IDs & items for structure rework by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5991 (5.09.52.316)
>* Refactor mtecropharvestor tooltip by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6005 (5.09.52.316)
>* Fix Redstone-on Texture having a few wrong pixels by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6007 (5.09.52.316)
>* Update Industrial Electrolyzer tooltip to match the new structure. by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6009 (5.09.52.316)
>* Fix NAC firewall projection casing texture by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6010 (5.09.52.316)
...
>* Normalize Chemical Formula for NEI Filter by @slprime in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5997 (5.09.52.314)
>* make stocking bus base tier EV and move main ui 5 pixels over to align it properly by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5999 (5.09.52.314)
>* Add Fether Compat by @glowredman in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6000 (5.09.52.314)
>* Fix ConcurrentModificationException in NAC conversion to real items by @NotAPenguin0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5985 (5.09.52.313)
>* Fix structure rework multies' overrides by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5989 (5.09.52.313)
>* Downgrade HEE due to version delete by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5990 (5.09.52.313)
>* Fix NAC always draining its entire laser by @NotAPenguin0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5993 (5.09.52.313)
>* Unique NAC Hatch Textures by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5994 (5.09.52.313)
>* fix: singleblock machine activity for 1 tick recipes by @Sinerum in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5959 (5.09.52.312)
>* fix sparge tower crash by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5983 (5.09.52.309)
>* fix nac voiding items when modules were waiting in power by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5980 (5.09.52.308)
>* Fix wrong information displayed for insufficient voltage by @youkoaona in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5977 (5.09.52.306)
>* Rework Steam Blender by @JL2210 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5930 (5.09.52.306)
>* Add Large Molecular Assembler to interface terminal by @asquared31415 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5688 (5.09.52.305)
>* Localization of Pattern Provider Hatch by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5978 (5.09.52.305)
>* Fix NPE in GTShapelessRecipe.matches when slot returns null by @noah-cope-dev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5960 (5.09.52.305)
>* optimize fillStacksIntoFirstSlots by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5882 (5.09.52.305)
...
>* fix new mcr not tierskipping by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5944 (5.09.52.296)
>* Added structure check after max amperage change on laser target hatches by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5942 (5.09.52.296)
>* [NAC] Added Localization / Changed Icon by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5939 (5.09.52.295)
>* Improving the readability of tooltips Large Combustion Engine by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5927 (5.09.52.295)
>* fix(outputme): fix overflow protection and cell filter update issue. by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5934 (5.09.52.295)
>* restore mcr having more than one energy hatch by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5940 (5.09.52.295)
>* use the new method to display deprecated text for the fluid shaper by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5941 (5.09.52.295)
>* [Structure Rework] Mega Chemical Reactor by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5893 (5.09.52.294)
>* Nanochip Assembly Complex by @NotAPenguin0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2903 (5.09.52.294)
>* Refactoring scanner info by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5833 (5.09.52.294)
...
>* fix(gt++): align recycling recipes with GregTech standards and NEI cаtegories by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5907 (5.09.52.288)
>* patch yet another loop cheaper than water electrolysis by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5921 (5.09.52.288)
>* fix fluid regulator crash  by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5916 (5.09.52.288)
>* Add GT++ casings to Casings.java by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5922 (5.09.52.288)
>* Don't expose GTMultiTextureRender constructor by @sisyphussy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5923 (5.09.52.288)
>* Main texture fluxed electrum by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5918 (5.09.52.288)
>* Replacing EBF and Volcanus sounds by @IX-git in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5915 (5.09.52.286)
>* Revert "Move Fluxed Electrum Textures to main texture, instead of OVE… by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5917 (5.09.52.286)
>* fix TinkersGregworks server crash by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5867 (5.09.52.285)
>* Split TextureFactory + Cleanup by @sisyphussy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5534 (5.09.52.285)
>* Add Compressed + Quantum Busses by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5694 (5.09.52.285)
>* [MUI2] port Drone Centre to MUI2 by @RealSilverMoon in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5320 (5.09.52.285)
>* Refactor rendering Block/TileEntities, fix HIL laser accelerating whe… by @YamiKami-Sama in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5543 (5.09.52.285)
>* SLAM: Change HatchElement from ExoticEnergy to ExoticDynamo by @harrynull in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5872 (5.09.52.285)
>* add MCPatcher full ctm to fusion casings 1 and 2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5904 (5.09.52.285)
>* show discount on dtpf waila by @mamiemru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5909 (5.09.52.285)
>* Move Fluxed Electrum Textures to main texture, instead of OVERLAY by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5913 (5.09.52.285)
>* Shift magmatter unlock one upgrade earlier by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5889 (5.09.52.283)
>* Add A Full Fluxed Electrum Material Set by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5896 (5.09.52.283)
>* port gregtech BlockCasings (and related) to the casings enum by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5897 (5.09.52.282)
>* mui2 dep bump by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5898 (5.09.52.282)
...
>* Remove ContributorList helper class and just use mbtt methods instead by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5887 (5.09.52.280)
>* [Refactor]Fix CAL imprint migration being broken by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5771 (5.09.52.279)
...
>* fix event subscription NPE in GTClient by @Alexdoru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5878 (5.09.52.271)
...
>* adapt to mui2 sync again by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5865 (5.09.52.266)
>* Adapt to ThE changes by @Kogepan229 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5774 (5.09.52.265)
>* Remove trailing 's' from Circuitry wrap display names by @flamingowrangler2869 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5862 (5.09.52.263)
...
>* Fix npe on coke oven by @RealSilverMoon in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5855 (5.09.52.258)
>* Add non-GT ore (ancient debris) prospecting by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5153 (5.09.52.258)
>* Clean up the Materials <-> Werkstoff pairing code by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5380 (5.09.52.258)
>* Allow chanced recipe inputs and fluid outputs by @ABKQPO in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5735 (5.09.52.258)
>* adapt mui2 to upstream changes by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5852 (5.09.52.257)
>* update docs by @Ranzuu in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5845 (5.09.52.256)
>* Hopefully fix alpha overlay for sheetmetal by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5851 (5.09.52.256)
>* Remove ridiculous remapping by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5849 (5.09.52.256)
>* feat/refactor(OutputME): enhance Output Hatch/Bus functionality by @hinyb in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5589 (5.09.52.256)
>* Refactor GTPP/BlockBaseModular.java by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5625 (5.09.52.255)
>* Remove "Minimum" From ICO Heat Casing Count by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5843 (5.09.52.255)
>* Allow transformers to accept extra amperage by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5842 (5.09.52.255)
>* Improve Basic Machine Energy Tooltip Coloring by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5831 (5.09.52.255)
>* Add new Drawer Framing Machine by @maybemattie in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5811 (5.09.52.254)
>* Fix BHC's spacetime cost not resetting when it closes naturally  by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5832 (5.09.52.254)
>* Separate Machine Metal and split out Gui Metal Color into its own unit by @ABKQPO in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5440 (5.09.52.254)
>* Change Turbine Shaft Into Assembler Recipe by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5825 (5.09.52.254)
>* Cleaning up StaticRecipeChangeLoaders by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5391 (5.09.52.254)
>* Fix multi-mode Multiblocks crash with CRIB by @zyf051520 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5599 (5.09.52.254)
...
>* Add Bio Vat to the BW item registry by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5802 (5.09.52.243)
>* Minor Tool Revamp by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5612 (5.09.52.243)
>* Fix crash for #5746 by @Taskeren in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5779 (5.09.52.243)
>* More Typo fixes by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5800 (5.09.52.242)
>* Fix stocking bus not properly extracting from slot 1 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5801 (5.09.52.242)
>* Fix Large Semifluid&Combustion Gens resetting Efficiency on World restart by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5778 (5.09.52.242)
>* fix typos by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5795 (5.09.52.240)
>* Improve waila tooltip by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5744 (5.09.52.240)
...
>* Fix redstone not connecting to pipe covers by @Engineer12798 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5760 (5.09.52.227)
>* Maybe optimize hasValidMetaTileEntity && getRenderBoundingBox by @mitchej123 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5764 (5.09.52.227)
>* Merge fluid canner into canner by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5763 (5.09.52.227)
>* Fix TC Energy Converter / Absorber Recipes by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5756 (5.09.52.226)
>* Add some machine mode gui buttons to multis which did not have them by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5303 (5.09.52.226)
>* fix: Jukebox needlessly prepending "records." to the played record resource by @eigenraven in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5758 (5.09.52.225)
>* Actually replicate vanilla record logic properly by @eigenraven in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5759 (5.09.52.225)
>* Add Discount Info to Volcani Tooltip by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5754 (5.09.52.224)
>* Revert "[ChunkAPI] Initial ChunkAPI/EID Compatibility (#4974)" by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5755 (5.09.52.224)
>* Fix dyson and gas siphon textures not rotating properly by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5753 (5.09.52.224)
>* Format numbers migration by @Connor-Colenso in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5752 (5.09.52.223)
>* reduce combs for netherite/prismarine recipes from 32 to 8.  by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5724 (5.09.52.222)
>* Clarify tooltip of the Industrial 3D Copying Machine by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5745 (5.09.52.222)
>* Refactor DimensionHelper by @ABKQPO in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5747 (5.09.52.222)
>* [ChunkAPI] Initial ChunkAPI/EID Compatibility by @Cleptomania in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4974 (5.09.52.222)
>* [MUI2] changes the base gui classs maintenance issue hoverable textures. by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5749 (5.09.52.222)
>* rename chamber centrifuge to spinmatron internally by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5751 (5.09.52.222)
>* fix showing cupronickel coil recipe when looking at any other coil by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5743 (5.09.52.221)
>* Refactor Item Renderers by @sisyphussy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5535 (5.09.52.221)
>* Powerfail icon rescaling by @WayneYam in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5734 (5.09.52.221)
...
>* rename modules in UI to match casings in game. also removed the 'its free' by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5705 (5.09.52.205)
>* Remove hatches placed by hologram projector by default by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5699 (5.09.52.205)
>* Add Fluid Extraction Recipes For Smeltable GT++ Alloy Dusts by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5689 (5.09.52.205)
>* Add 256A Dynamo Hatches (UV-UXV) by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5665 (5.09.52.205)
>* unique botmium casing texture by @Auynonymous in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5706 (5.09.52.205)
>* Tool texture improvements by @jude123412 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4669 (5.09.52.203)
>* Changes NO2 -> N2O4 chemical reactor recipe's circuit by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5690 (5.09.52.203)
>* Add Component Assembly Line Casing channel by @ABKQPO in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5695 (5.09.52.203)
...
>* Remove Outdated Algae Pond TT Line by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5686 (5.09.52.197)
>* don't connect to the side when enabling input in fluid pipes by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5616 (5.09.52.196)
>* Optimize focus input bus and reduce capacity by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5679 (5.09.52.195)
>* add input sep toggling for foundry (default is still true) by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5680 (5.09.52.195)
>* Chat message localization in server – initial by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5548 (5.09.52.195)
>* Cleanup GTPP/core/item/wearable by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5675 (5.09.52.195)
>* fix crash when loading with NHCoreMod but without Galacticraft by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5671 (5.09.52.195)
>* replace the Fluid Shaper with a new multi by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5676 (5.09.52.195)
>* Remove GT++ RecipeUtils class by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5673 (5.09.52.194)
>* remove foundry recipes from gt5u by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5674 (5.09.52.194)
>* Change some Thorium 232 related recipes to remove small dusts by @GirixK in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5636 (5.09.52.192)
>* Fix GT++ quad cell batteries being incorrectly tinted by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5657 (5.09.52.192)
>* Remove aqua regia chem formula by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5654 (5.09.52.192)
>* Cleanup GT++ ModItems class by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5658 (5.09.52.192)
>* Add Glass as HV-Glass and allow all Glasses on Steam Washer by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5656 (5.09.52.192)
>* Boldarnator dedicated nei page by @Faotik in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5637 (5.09.52.192)
>* Apply rocket pollution only once a second by @wlhlm in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5659 (5.09.52.192)
>* fix styrene butadiene recipe by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5663 (5.09.52.192)
>* Add VM Acronym by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5666 (5.09.52.192)
>* Remove Deprecated VM Structures by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5667 (5.09.52.192)
>* deprecate the wire mold for the extruder by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5669 (5.09.52.192)
>* Only catch Exceptions not Errors by @glowredman in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5550 (5.09.52.192)
>* Add a new Modular Solidifier to supersede the Shaper by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4627 (5.09.52.192)
>* Work on removing unnecessary methods from GT++ ItemUtils/FluidUtils by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5672 (5.09.52.192)
>* Remove Deprecated Laser Hatches by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5651 (5.09.52.190)
>* Fix recipe errors in GT++ recipes by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5633 (5.09.52.190)
>* Update HILE Tooltip to hint at all UEV+ Laser Sources by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5653 (5.09.52.190)
>* add promethium plasma properly by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5655 (5.09.52.190)
...
>* remove the 'Structure is too complex!' line from all controller descriptions by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5617 (5.09.52.178)
>* Fix crib highlight on Interface Terminal by @Kogepan229 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5619 (5.09.52.178)
>* Blacklist botania flowers from the EIG by @C0bra5 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5620 (5.09.52.178)
>* Fix algaepond issues by @boubou19 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5608 (5.09.52.178)
>* Further platline chemformula improvements by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5600 (5.09.52.178)
>* [MUI2] Chisel Hatch by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5593 (5.09.52.178)
>* [MUI2] MUI2 Laser Hatches by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5583 (5.09.52.178)
>* [MUI2] Data Hatch by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5580 (5.09.52.178)
>* Refactor GT++ RecipesMachines class by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5621 (5.09.52.178)
>* refactor MaterialGenerator.java to be more readable by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5623 (5.09.52.178)
>* Refactor GT++ RecipesGregtech class by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5626 (5.09.52.178)
>* Delete GT++ CI class by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5627 (5.09.52.178)
>* Add EAF abbreviation by @DylanTaylor1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5601 (5.09.52.176)
>* Fix Ore Drillilng Plant using way too much drilling fluid by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5602 (5.09.52.176)
>* allow heat coils to conduct redstone by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5606 (5.09.52.176)
>* Fix Electric Air Filter turbine texture pointing sideways by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5610 (5.09.52.176)
>* close opened cover tab when clicking at its button again by @danyadev in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5611 (5.09.52.176)
>* change latex size in tooltip by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5613 (5.09.52.176)
>* fix prass tt by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5614 (5.09.52.176)
>* Add proper Mixin remapping annotations by @ah-OOG-ah in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5459 (5.09.52.176)
>* Allow superconductors to set P2P to GT EU mode by @Worive in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5607 (5.09.52.176)
...
>* Buff later conveyor speed growth and late pump speed by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5538 (5.09.52.154)
>* Clean up dead code in boilers from MUI2 port by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5560 (5.09.52.154)
>* Clean out more unused MUI1 code by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5561 (5.09.52.154)
>* Localization of type filter's tooltip and death messages by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5559 (5.09.52.154)
>* Fix issues with GT++ material rendering by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5562 (5.09.52.154)
>* fix water line data stick by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5563 (5.09.52.154)
...
>* Add Dirt Path, Farmland as permitted top-layer blocks for Charcoal Pit by @ModularityEnjoyer in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5516 (5.09.52.145)
>* Nei cauldron recipe by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5539 (5.09.52.144)
>* fix the heat bar on steam machines to have a tooltip by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5541 (5.09.52.144)
>* Improve Nei Cauldron Recipe by @evgengoldwar in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5542 (5.09.52.144)
>* Added IV Acid Generator + slight change to textures by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5540 (5.09.52.144)
>* Fix Purified Water NEI and supports i18n by @SST-03 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5530 (5.09.52.144)
>* Mui2 tesla tower by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5238 (5.09.52.143)
>* Add a recipe to allow the crafting of raw advanced crystal chip via beamlines using CeLuAG by @lonei-G in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5513 (5.09.52.143)
>* Fix Beamline Tooltips by @Ruling-0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5536 (5.09.52.143)
>* allow for better tuning of conveyor module numbers by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5537 (5.09.52.143)
>* Make executor service load on demand, may need it earlier by @DarkShadow44 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5532 (5.09.52.143)
>* Decrease texture size of hexplate by @sisyphussy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5520 (5.09.52.140)
>* fix Research Station consume research item by @ABKQPO in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5521 (5.09.52.140)
>* Some achievement text fixes by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5523 (5.09.52.140)
>* bump mui2 dep by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5525 (5.09.52.140)
>* Fix Industrial Arc Furnace Mode Setting Waila by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5527 (5.09.52.140)
>* adapt code to changes in ae by @lc-1337 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5258 (5.09.52.140)
...
>* Migrating item renderer code by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5511 (5.09.52.137)
>* Fix Fluid Shaper tooltip about parallels by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5514 (5.09.52.137)
>* Remove names method and fix UUID regex by @glowredman in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5517 (5.09.52.137)
...
>* Remove PowerFail Event When Right-click with SoftMallet by @CN132DAS in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5428 (5.09.52.130)
>* remove cell prefix for radox polymer by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5451 (5.09.52.129)
>* Fix superchest dropping items on ground by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5425 (5.09.52.129)
>* Improve Vajra texture by @envoidia in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5447 (5.09.52.129)
...
>* Fix Industrial Coke Oven recipe by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5430 (5.09.52.126)
>* [MUI2] Port Godforge modules to MUI2 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5423 (5.09.52.126)
>* add eta meson in qft synchrotron catalyst by @mamiemru in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5314 (5.09.52.125)
>* Changed the color of rose gold by @seventh-june in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5394 (5.09.52.124)
>* Update to latest MUI2 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5421 (5.09.52.124)
>* Fix L.E.S.U. overflowing to maxLong power storage with 107 casings by @OmdaCZ in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5420 (5.09.52.124)
>* Integrated Circuit Refactor Method by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5413 (5.09.52.124)
...
>* Use GT Coke Oven Controller in Industrial Coke Oven Controller Recipe by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5385 (5.09.52.118)
>* fix input buses sorting mode. by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5372 (5.09.52.117)
>* More item moving fixes by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5375 (5.09.52.117)
>* Restore Gases to Bartworks Electrolysis Recipes by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5376 (5.09.52.117)
>* Fix PCB Factory not working without cooling tower by @guid118 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5377 (5.09.52.117)
...
>* sensible logging for failed ticks by @Glease in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5282 (5.09.52.105)
>* [MUI2] port MTEPurificationUnitBase to MUI2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5275 (5.09.52.105)
>* Fix "AAL will overclock too much for some recipes" by @SST-03 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5176 (5.09.52.105)
>* [MUI2] port MTEPlasmaForge to MUI2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5273 (5.09.52.105)
>* fix raw animal waste conflict by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5294 (5.09.52.105)
>* Implement IItemSource + IItemSink & use ItemTransfer by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5027 (5.09.52.105)
>* no more Chunk loading by @Glease in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5284 (5.09.52.105)
>* [MUI2] Port MTENanoForge to MUI2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5272 (5.09.52.105)
>* [MUI2] port MTEPCBFactory to MUI2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5271 (5.09.52.105)
>* Fix UEV part texture noise by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5295 (5.09.52.105)
>* [MUI2] tidy up some ported MTE UIs by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5296 (5.09.52.105)
>* Update to latest MUI2 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5298 (5.09.52.105)
>* Add custom multi progress hook by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5199 (5.09.52.105)
>* Disable some recipes when nuclear horizons is present by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5297 (5.09.52.105)
>* Update to latest MUI2 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5299 (5.09.52.105)
>* Glass Tooltips enhancement to make it be the same to actual situation by @SST-03 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5301 (5.09.52.105)
>* Delete MUI1 Implementation of ported ui's by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5300 (5.09.52.105)
>* add batch mode to Infinite Fluid Drills by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5304 (5.09.52.105)
>* Simplify eoh nanite recipes by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5305 (5.09.52.105)
>* Fix and buff decay warehouse by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5302 (5.09.52.105)
>* Nether ores asteroid by @EnderProyects in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5249 (5.09.52.105)
>* Revert "Fix Strontium dupe" by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5308 (5.09.52.105)
>* bep dump by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5309 (5.09.52.105)
>* adapt to new MUI changes by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5310 (5.09.52.105)
>* rename where uitexture points in mui1 because im foolish by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5312 (5.09.52.105)
>* Allow UIV-MAX conveyors and pumps to be used as covers by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5306 (5.09.52.105)
>* Make a base gui for hatches by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5317 (5.09.52.105)
>* Update to latest MUI2 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5319 (5.09.52.105)
>* Fix crash when previewing decay warehouse structure by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4441 (5.09.52.105)
>* adapt to mui2 changes by @Spicierspace153 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5323 (5.09.52.105)
>* fix drain code on debug hatch by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5324 (5.09.52.105)
>* bartworks overriding HTGR recipes fix by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5315 (5.09.52.105)
>* Fix spelling error, effect -> affect by @arch1t3cht in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5326 (5.09.52.105)
>* Cape System Rework by @glowredman in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5186 (5.09.52.105)
>* Update to latest MUI2 by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5327 (5.09.52.105)
>* [MUI2] create a common widgets class by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5328 (5.09.52.105)
>* fix crash with covers from upstream by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5329 (5.09.52.105)
>* [MUI2] create base class for MTESingleBlock by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5330 (5.09.52.105)
>* [MUI2] fix bug when player invent is not bound in mtebasegui by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5331 (5.09.52.105)
>* Various ore refactor fixes by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5307 (5.09.52.105)
>* [MUI2] port input bus to MUI2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5318 (5.09.52.105)
>* Fix conduit connection to T.F.F.T hatch by @zyf051520 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5311 (5.09.52.105)
>* fix: Missing side check crash when hint is called on a frame by @combusterf in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5209 (5.09.52.105)
...
>* Added ability to smelt Garnierite Ore & Dust in EBF by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5262 (5.09.52.99)
>* Revert "fix large arc furnace structure oddness" by @Glease in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5263 (5.09.52.99)
>* Add a debug input bus for developers by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5259 (5.09.52.99)
>* Add a debug input hatch for developers by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5260 (5.09.52.99)
>* Move block outline rendering into BlockOverlayRenderer by @Brabb3l in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5264 (5.09.52.99)
>* fix index out of bounds error on data repository by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5267 (5.09.52.99)
>* Set density of magnetic metals (iron, steel, neodymium) back to default(1).  by @loenaaaa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5266 (5.09.52.99)
>* Change LV To Dark Green by @UltraProdigy in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5268 (5.09.52.99)
...
>* Add debug fluid tank by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5175 (5.09.52.95)
>* Fix power goggles losing enchant when linking/unlinking by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5241 (5.09.52.95)
>* PCB Factory sub-multi additions by @Dream-Master in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5190 (5.09.52.95)
>* port / replace mui1 implementation of ItemVolumetricFlask to mui2 by @chrombread in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5242 (5.09.52.95)
>* delete deprecated "ULV Simple Washer" by @VortexSo4 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5247 (5.09.52.95)
>* Increase Netherrack Froth output volume to 8x by @Glease in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5246 (5.09.52.95)
>* fix `GTUtility.translate` related error text by @ChromaPIE in https://github.com/GTNewHorizons/GT5-Unofficial/pull/5196 (5.09.52.95)
...
>* Fuzzy Finder for search box by @SkorchedEU in https://github.com/GTNewHorizons/GTNH-Credits/pull/7 (1.2.0)
>* Lib credits by @leagris in https://github.com/GTNewHorizons/GTNH-Credits/pull/8 (1.2.0)
>* feat: Custom Main Menu integration by @leagris in https://github.com/GTNewHorizons/GTNH-Credits/pull/3 (1.2.0)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/GTNH-Credits/pull/11 (1.2.0)
>* Credits editor by @leagris in https://github.com/GTNewHorizons/GTNH-Credits/pull/10 (1.2.0)
...
# Updated - GTNH-TC-Wands - 1.4.6 --> 1.4.14
**Full Changelog**: https://github.com/GTNewHorizons/GTNH-TC-Wands/compare/1.4.6...1.4.14

## What's Changed:
>* Refactor Wand Recipe Creation by @koolkrafter5 in https://github.com/GTNewHorizons/GTNH-TC-Wands/pull/31 (1.4.14)
...
# New Mod - GTNHExtLib:1.0.1
**Full Changelog**: https://github.com/GTNewHorizons/GTNHExtLib/compare/1.0.0...1.0.1

## What's Changed:
>* Fix two crashes by @mitchej123 in https://github.com/GTNewHorizons/GTNHExtLib/pull/1 (1.0.1)

# Updated - GTNHLib - 0.7.10 --> 0.11.4
**Full Changelog**: https://github.com/GTNewHorizons/GTNHLib/compare/0.7.10...0.11.4

## What's Changed:
>* Misc BlockState Fixes by @RecursivePineapple in https://github.com/GTNewHorizons/GTNHLib/pull/383 (0.11.4)
>* Fix model loading from folder resource packs by @ah-OOG-ah in https://github.com/GTNewHorizons/GTNHLib/pull/382 (0.11.4)
...
>* Catch same team mergers and fix command by @cubefury in https://github.com/GTNewHorizons/GTNHLib/pull/348 (0.9.66)
>* Add Model overrideIcon by @Shigure-Ruiseki in https://github.com/GTNewHorizons/GTNHLib/pull/343 (0.9.66)
>* Fix new team data types not being added to old teams by @tiffit in https://github.com/GTNewHorizons/GTNHLib/pull/347 (0.9.65)
>* Add per-slot stack size limit to ItemSink API by @Luca-Guettinger in https://github.com/GTNewHorizons/GTNHLib/pull/331 (0.9.64)
...
>* Add @Config.{RequiresMod, RequiresModOr and RequiresModAnd} to the config system by @slprime in https://github.com/GTNewHorizons/GTNHLib/pull/334 (0.9.54)
>* Make ModelISBRH.INSTANCE ThreadLocal to fix race condition by @Ruling-0 in https://github.com/GTNewHorizons/GTNHLib/pull/320 (0.9.53)
>* Add & color code awareness to font methods by @alppp in https://github.com/GTNewHorizons/GTNHLib/pull/328 (0.9.52)
>* Fix JsonModel Loading Typo by @Shigure-Ruiseki in https://github.com/GTNewHorizons/GTNHLib/pull/318 (0.9.51)
>* add two helper methods to ItemStackNBT by @Alexdoru in https://github.com/GTNewHorizons/GTNHLib/pull/326 (0.9.50)
...
>* handle obfuscated names in BlockIconTransformer by @danyadev in https://github.com/GTNewHorizons/GTNHLib/pull/316 (0.9.45)
>* ASM Fixes for Tessellator transformer and block transformer by @Alexdoru in https://github.com/GTNewHorizons/GTNHLib/pull/307 (0.9.45)
...
>* add BFS leaf decay by @Alexdoru in https://github.com/GTNewHorizons/GTNHLib/pull/305 (0.9.41)
...
>* Add ability to supply custom models and add transparency support by @Ruling-0 in https://github.com/GTNewHorizons/GTNHLib/pull/277 (0.9.37)
...
>* remap readFromNBT/writeToNBT injections in TileInFusionMatrix mixin by @danyadev in https://github.com/GTNewHorizons/GTNHLib/pull/274 (0.9.19)
>* Update buildscript to fix lwjgl3ify linux launch error by @koolkrafter5 in https://github.com/GTNewHorizons/GTNHLib/pull/271 (0.9.16)
>* Add an enhanced infusion recipe that supports replacements by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GTNHLib/pull/270 (0.9.15)
>* Copy the FormattedResearchPage from Salis Arcana for use in other mods by @koolkrafter5 in https://github.com/GTNewHorizons/GTNHLib/pull/269 (0.9.13)
>* Add lwjgl3 fallback for apple vao by @mitchej123 in https://github.com/GTNewHorizons/GTNHLib/pull/264 (0.9.10)
>* Add Direct Tessellator; Add proper VBO/VAO API; Refactor VertexFormat by @sisyphussy in https://github.com/GTNewHorizons/GTNHLib/pull/261 (0.9.9)
>* Format numbers work by @Connor-Colenso in https://github.com/GTNewHorizons/GTNHLib/pull/235 (0.9.6)
>* Adds pick block event mixin by @querns in https://github.com/GTNewHorizons/GTNHLib/pull/259 (0.9.5)
>* Add ability to check 4D map using outside range by @Ruling-0 in https://github.com/GTNewHorizons/GTNHLib/pull/255 (0.9.3)
>* Add GuiText for customizable GUI text handling by @Ranzuu in https://github.com/GTNewHorizons/GTNHLib/pull/252 (0.9.3)
>* Document known issue with Fnv1a algorithms in javadoc by @WNP78 in https://github.com/GTNewHorizons/GTNHLib/pull/257 (0.9.3)
...
>* Update normal calcs to handle degenerate quads by @mitchej123 in https://github.com/GTNewHorizons/GTNHLib/pull/234 (0.8.33)
>* Fix SharedDepthFramebuffer by @sisyphussy in https://github.com/GTNewHorizons/GTNHLib/pull/225 (0.8.33)
...
>* Update descriptions for Essentia Compressor research by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Gadomancy/pull/50 (1.5.9)
>* Typos/Grammar Fixes by @Yoshy2002 in https://github.com/GTNewHorizons/Gadomancy/pull/51 (1.5.9)
...
# Updated - Galacticraft - 3.3.13-GTNH --> 3.4.29-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Galacticraft/compare/3.3.13-GTNH...3.4.29-GTNH

## What's Changed:
>* reduce runtime allocations from arc lamp algorithm by @Alexdoru in https://github.com/GTNewHorizons/Galacticraft/pull/140 (3.4.29-GTNH)
>* Fix EID Space Station Travel Crash by @UltraProdigy in https://github.com/GTNewHorizons/Galacticraft/pull/139 (3.4.28-GTNH)
>* Fix game hang when minimizing during celestial selection screen by @Luca-Guettinger in https://github.com/GTNewHorizons/Galacticraft/pull/132 (3.4.27-GTNH)
>* Unify (fix) galacticraft inventory gui by @Ranzuu in https://github.com/GTNewHorizons/Galacticraft/pull/135 (3.4.26-GTNH)
>* Fix server-side chat messages ignoring client locale by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Galacticraft/pull/137 (3.4.26-GTNH)
>* Fix world client leak in ItemRendererFlag by @Alexdoru in https://github.com/GTNewHorizons/Galacticraft/pull/133 (3.4.25-GTNH)
>* fix arc lamp renderer by @Alexdoru in https://github.com/GTNewHorizons/Galacticraft/pull/134 (3.4.25-GTNH)
>* Create GalacticraftModels class to avoid duplicate models registration by @Alexdoru in https://github.com/GTNewHorizons/Galacticraft/pull/131 (3.4.24-GTNH)
>* Spotless apply for branch fix/landing-balloons-stuck-on-mars for #125 by @github-actions[bot] in https://github.com/GTNewHorizons/Galacticraft/pull/130 (3.4.23-GTNH)
>* Fix landing balloons freezing mid-air when player exits before ground contact by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Galacticraft/pull/125 (3.4.23-GTNH)
>* Fix world server leak by @Alexdoru in https://github.com/GTNewHorizons/Galacticraft/pull/129 (3.4.22-GTNH)
>* Fix placing multiple rockets on the same landing pad by @sbancuz in https://github.com/GTNewHorizons/Galacticraft/pull/128 (3.4.21-GTNH)
>* Schematics unification by @Ranzuu in https://github.com/GTNewHorizons/Galacticraft/pull/126 (3.4.20-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Galacticraft/pull/124 (3.4.19-GTNH)
>* Cache frequent Enum#values() calls by @Alexdoru in https://github.com/GTNewHorizons/Galacticraft/pull/123 (3.4.18-GTNH)
>* Localization of GUI titles and optional number localization by @Ranzuu in https://github.com/GTNewHorizons/Galacticraft/pull/120 (3.4.17-GTNH)
>* Fix the oxygen usage when entering water by @Yoshy2002 in https://github.com/GTNewHorizons/Galacticraft/pull/121 (3.4.15-GTNH)
>* Fix coordinate packing bug in ArcLamp by @mitchej123 in https://github.com/GTNewHorizons/Galacticraft/pull/118 (3.4.14-GTNH)
>* Fix liquid Nitrogen temperature by @Nana-Sakura in https://github.com/GTNewHorizons/Galacticraft/pull/117 (3.4.14-GTNH)
>* Support Witchery's Sticky Items potion by @wlhlm in https://github.com/GTNewHorizons/Galacticraft/pull/113 (3.4.13-GTNH)
>* Fix incompatibility with DragonAPI by @MalTeeez in https://github.com/GTNewHorizons/Galacticraft/pull/116 (3.4.11-GTNH)
...
# Updated - Galaxy-Space-GTNH - 1.1.121-GTNH --> 1.1.138-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Galaxy-Space-GTNH/compare/1.1.121-GTNH...1.1.138-GTNH

## What's Changed:
>* Fix GS Chunk Gen w/ EID by @UltraProdigy in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/152 (1.1.138-GTNH)
>* EID Mixin Crash Fix by @UltraProdigy in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/151 (1.1.137-GTNH)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/150 (1.1.136-GTNH)
>* Create model objects only once by @Alexdoru in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/149 (1.1.135-GTNH)
>* Fix placing multiple rockets on the same landing pad by @sbancuz in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/148 (1.1.134-GTNH)
>* Fix placing multiple rockets on the same landing pad by @sbancuz in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/148 (1.1.133-GTNH)
>* Prevent blocks from loading chunks while ticking by @Alexdoru in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/146 (1.1.132-GTNH)
>* use bfs leaf decay from gtnh lib by @Alexdoru in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/147 (1.1.132-GTNH)
>* make ItemRocket#getRarity client side only to fix server crash by @Alexdoru in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/145 (1.1.131-GTNH)
>* Schematics unification by @Ranzuu in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/144 (1.1.130-GTNH)
>* replace multiple world.getblock calls with a single world.checkChunksExist call by @Alexdoru in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/143 (1.1.129-GTNH)
...
# Updated - Gravitation-Suite-Neo - 1.3.6 --> 1.3.12
**Full Changelog**: https://github.com/GTNewHorizons/Gravitation-Suite-Neo/compare/1.3.6...1.3.12

## What's Changed:
>* Remove spacesuit from nano armor by @FourIsTheNumber in https://github.com/GTNewHorizons/Gravitation-Suite-Neo/pull/34 (1.3.12)
>* Fix server-side chat messages not being localized by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Gravitation-Suite-Neo/pull/32 (1.3.11)
...
# New Mod - GregoryTweaksForCrafting:1.0.3
**Full Changelog**: https://github.com/GTNewHorizons/GregoryTweaksForCrafting/compare/1.0.0...1.0.3

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/GregoryTweaksForCrafting/pull/4 (1.0.3)
>* don't load client mixins on server... by @Alexdoru in https://github.com/GTNewHorizons/GregoryTweaksForCrafting/pull/3 (1.0.2)
...
## What's Changed:
>* Change CustomMusicTicker to use vanilla's ISound field by @tiffit in https://github.com/GTNewHorizons/Hardcore-Ender-Expansion/pull/39 (1.12.22-GTNH)
>* fix client world leak in RenderTileEssenceAltar by @Alexdoru in https://github.com/GTNewHorizons/Hardcore-Ender-Expansion/pull/38 (1.12.21-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Hardcore-Ender-Expansion/pull/37 (1.12.20-GTNH)
...
# Updated - Hodgepodge - 2.6.112 --> 2.7.159
**Full Changelog**: https://github.com/GTNewHorizons/Hodgepodge/compare/2.6.112...2.7.159

## What's Changed:
>* Localized the whole mod + README (Czech) by @Kuliiuu in https://github.com/GTNewHorizons/Hodgepodge/pull/882 (2.7.159)
>* Clamp looting to a minimum of 0 by @ah-OOG-ah in https://github.com/GTNewHorizons/Hodgepodge/pull/916 (2.7.158)
>* Clip the entity renders within vanilla GUIs using `glScissor` by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Hodgepodge/pull/834 (2.7.157)
>* Fix BOP colorized sapling icon when growth stage bit is set in meta by @dipo33 in https://github.com/GTNewHorizons/Hodgepodge/pull/904 (2.7.157)
...
>* Fix EID incompatibilities for IC2, BoP, Witchery by @tiffit in https://github.com/GTNewHorizons/Hodgepodge/pull/891 (2.7.143)
...
>* [Memory-opti:fix leak] fix memory leak in IC2 OverlayTESR by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/872 (2.7.139)
>* [Memory-opti:fix leak] fix forge's FakePlayerFactory leaking the world server by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/867 (2.7.139)
>* optimize JarDiscoverer class name validation by @danyadev in https://github.com/GTNewHorizons/Hodgepodge/pull/880 (2.7.138)
>* Fix crash with disableChunkTerrainGeneration and EndlessIDs by @konkers in https://github.com/GTNewHorizons/Hodgepodge/pull/877 (2.7.137)
>* Attempt to fix out of bounds crash with modern blockpick by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/875 (2.7.136)
...
>* Caches the advanced Model renderers to speedup loading and avoid wasting memory with duplicate models by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/851 (2.7.126)
...
>* dedupe magic numbers and gradient-terminator check in color mixins by @alppp in https://github.com/GTNewHorizons/Hodgepodge/pull/844 (2.7.122)
>* clear all mouse and keyboard events at once on SplashScreen finish by @danyadev in https://github.com/GTNewHorizons/Hodgepodge/pull/749 (2.7.122)
>* Add mixin that makes freecam work with ic2 jetpacks by @Luca-Guettinger in https://github.com/GTNewHorizons/Hodgepodge/pull/845 (2.7.122)
>* Add color code support for text rendering by @alppp in https://github.com/GTNewHorizons/Hodgepodge/pull/829 (2.7.121)
>* Import EnchantmentHelper memory leak fix from ArchaicFix by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/839 (2.7.120)
>* Fix mixin warn by @czqwq in https://github.com/GTNewHorizons/Hodgepodge/pull/835 (2.7.119)
>* fix RenderBlocks static instance leaking world by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/831 (2.7.119)
>* Disable TileEntity Y bounds validation when Cubic Chunks is present by @RecursivePineapple in https://github.com/GTNewHorizons/Hodgepodge/pull/828 (2.7.118)
>* Fix all remaining WorldClient leaks by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/823 (2.7.117)
>* Fix World MapStorage memory leak by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/815 (2.7.117)
>* Fix a crash caused when a mod tries to send a chat message to a FakePlayer by @koolkrafter5 in https://github.com/GTNewHorizons/Hodgepodge/pull/819 (2.7.116)
>* Create Memory config category by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/814 (2.7.115)
>* Fix memory leak caused by CommandBase#theAdmin by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/813 (2.7.114)
>* fix ChunkGenScheduler memory leak by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/816 (2.7.114)
...
>* Fix leaking the last rendered item when unloading a world by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/804 (2.7.109)
>* Fix NBTTagSmartByteArray sending null to NBTTagByteArray by @koolkrafter5 in https://github.com/GTNewHorizons/Hodgepodge/pull/801 (2.7.108)
>* Fixes by @mitchej123 in https://github.com/GTNewHorizons/Hodgepodge/pull/798 (2.7.107)
...
>* Ensure that Minecraft save files are not written to existing directies. by @copi143 in https://github.com/GTNewHorizons/Hodgepodge/pull/770 (2.7.98)
>* Prevent flowing liquids from loading chunks by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/787 (2.7.98)
>* correctly remap cofh_at field names by @danyadev in https://github.com/GTNewHorizons/Hodgepodge/pull/777 (2.7.97)
>* fix mixin compat with aquaacrobatics mod by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/785 (2.7.96)
>* fix SpeedupLongIntHashMapTransformer not transforming mod classes in obf environment by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/781 (2.7.95)
>* Prevent entity pathfinding from loading chunks on the server by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/782 (2.7.95)
>* Prevent loading chunks when ticking vanilla blocs by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/778 (2.7.95)
>* Prevent chunk load on block updates by @kuba6000 in https://github.com/GTNewHorizons/Hodgepodge/pull/615 (2.7.94)
>* Add debug transformer to track too frequent Enum#values() calls by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/766 (2.7.93)
>* Restore the cascading classloading of the parent classes done by EventSubscriptionTransformer by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/776 (2.7.92)
...
>* Revert #596 by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/761 (2.7.82)
...
>* compare NBT when switching item in hand by @danyadev in https://github.com/GTNewHorizons/Hodgepodge/pull/729 (2.7.70)
...
>* Localize Forge "Mod Options..." pause-menu button by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Hodgepodge/pull/732 (2.7.60)
...
>* Better compatability w/ Falsetweaks by @mitchej123 in https://github.com/GTNewHorizons/Hodgepodge/pull/713 (2.7.49)
>* remove fixBottomFaceUV blackboard flag when falsetweaks LT 433 is loaded by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/720 (2.7.49)
...
>* Remove unneeded limitations by @brandyyn in https://github.com/GTNewHorizons/Hodgepodge/pull/708 (2.7.39)
>* Prevent slimes from resetting their health when reloaded from NBT. by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Hodgepodge/pull/704 (2.7.37)
>* fix instant item texture switch when switching an item in hand to an item with different NBT by @danyadev in https://github.com/GTNewHorizons/Hodgepodge/pull/666 (2.7.35)
>* Fix missing mixin in prod by @ah-OOG-ah in https://github.com/GTNewHorizons/Hodgepodge/pull/702 (2.7.35)
>* Fix BiblioWoods Forestry Recipes by @DrParadox7 in https://github.com/GTNewHorizons/Hodgepodge/pull/694 (2.7.35)
>* Send difficulty updates to clients by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Hodgepodge/pull/701 (2.7.35)
>* Allow players in Creative to eat food. by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Hodgepodge/pull/705 (2.7.35)
...
>* Speedup NBTTagCompound#copy() by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/691 (2.7.23)
>* [Memory-opti:fix leak] Fix world leak in MinecraftServer by clearing the static server instance by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/675 (2.7.23)
>* Add option to hide the texture errors in the log by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/679 (2.7.23)
>* Speedup ThaumcraftApi#getInfusionRecipes by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/677 (2.7.23)
>* Write mod times results in a shutdown hook in order to capture the server events too by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/683 (2.7.23)
>* Fix /cofh tpx logic; add F3+C(Clip location) by @SST-03 in https://github.com/GTNewHorizons/Hodgepodge/pull/678 (2.7.20)
...
>* Random fixes by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/674 (2.7.18)
...
>* Add config option to disable BoP fog effects (disabled by default) by @MellowArpeggiation in https://github.com/GTNewHorizons/Hodgepodge/pull/609 (2.7.13)
>* Add rfb debug transformer to log time it takes to read and parse each config file by @Alexdoru in https://github.com/GTNewHorizons/Hodgepodge/pull/604 (2.7.13)
>* [Client Only] Add info for F3+Q in F3+Q by @SST-03 in https://github.com/GTNewHorizons/Hodgepodge/pull/659 (2.7.13)
>* Copy all buffers in S35PacketUpdateTileEntity batching by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/651 (2.7.11)
>* Fix fastChunkHandling by using a correct target for the mixin by @Sopel97 in https://github.com/GTNewHorizons/Hodgepodge/pull/645 (2.7.11)
>* Fix simulation distance random ticks for thermos by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/636 (2.7.11)
>* More logging and fix for simulation distance not removing ticks by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/642 (2.7.11)
>* Fix MixinKeyboardClient_sendKeyUpdate by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/653 (2.7.11)
>* Don't apply mixins for IC2 classic by @DarkShadow44 in https://github.com/GTNewHorizons/Hodgepodge/pull/655 (2.7.11)
...
>* Create ru_RU.lang by @Eldrinn-Elantey in https://github.com/GTNewHorizons/HoloInventory/pull/57 (2.5.8-GTNH)
...
>* impr(Textures): Adapt to GT5 OptionalResources by @leagris in https://github.com/GTNewHorizons/HydroEnergy/pull/41 (1.4.16)
...
# Updated - IFU - 1.11.2 --> 1.11.8
**Full Changelog**: https://github.com/GTNewHorizons/IFU/compare/1.11.2...1.11.8

## What's Changed:
>* Fixes gui texture by @Ranzuu in https://github.com/GTNewHorizons/IFU/pull/24 (1.11.8)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/IFU/pull/23 (1.11.7)
...
# Updated - Infernal-Mobs - 1.10.3-GTNH --> 1.10.5-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Infernal-Mobs/compare/1.10.3-GTNH...1.10.5-GTNH
...
# Updated - InventoryBogoSorter - 1.2.68-GTNH --> 1.3.29-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/InventoryBogoSorter/compare/1.2.68-GTNH...1.3.29-GTNH

## What's Changed:
>* Simple NTM update fix by @re7gog in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/188 (1.3.29-GTNH)
>* fix(network): validate and gate custom packets by @Caedis in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/185 (1.3.28-GTNH)
...
>* Yeet CraftingTweaks and MouseTweaks by @Caedis in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/175 (1.3.23-GTNH)
>* Fix drop-off not recognizing modded inventories with shared block types by @mikkerlo in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/174 (1.3.22-GTNH)
>* Allow bigger item names by @DarkShadow44 in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/173 (1.3.21-GTNH)
>* Added check to prevent null tools from crashing by @WayneYam in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/172 (1.3.20-GTNH)
>* Guard against adding empty keybinds by @0hwx in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/169 (1.3.19-GTNH)
>* fix ae crafting slot by @lc-1337 in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/167 (1.3.17-GTNH)
...
>* Dropoff additions by @0hwx in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/163 (1.3.13-GTNH)
...
# Updated - IronChestMinecarts - 1.2.0 --> 1.2.1
**Full Changelog**: https://github.com/GTNewHorizons/IronChestMinecarts/compare/1.2.0...1.2.1

## What's Changed:
>* fix obsidian chest cart by @2ndDerivative in https://github.com/GTNewHorizons/IronChestMinecarts/pull/10 (1.2.1)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/IronChestMinecarts/pull/11 (1.2.1)

# Updated - Irontanks - 1.4.2 --> 1.4.6
**Full Changelog**: https://github.com/GTNewHorizons/Irontanks/compare/1.4.2...1.4.6

## What's Changed:
>* Fix Russian localization for Iron Tanks items by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Irontanks/pull/17 (1.4.6)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Irontanks/pull/16 (1.4.5)
>* Add tooltips for extended tanks and custom ItemBlock by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Irontanks/pull/15 (1.4.4)
...
# Updated - Jabba - 1.5.10 --> 1.5.20
**Full Changelog**: https://github.com/GTNewHorizons/Jabba/compare/1.5.10...1.5.20

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Jabba/pull/50 (1.5.20)
>* make renderer registration less stupid by @Alexdoru in https://github.com/GTNewHorizons/Jabba/pull/49 (1.5.19)
>* Add simulated sink impl for barrels by @hiroscho in https://github.com/GTNewHorizons/Jabba/pull/48 (1.5.18)
...
# New Mod - JarJar:0.3.3-beta
**Full Changelog**: https://github.com/GTNewHorizons/JarJar/compare/0.1.0-beta...0.3.3-beta

## What's Changed:
>* Include Compile time annotations in ASMDataTable by @mitchej123 in https://github.com/GTNewHorizons/JarJar/pull/21 (0.3.3-beta)
>* Sort mod candidates case insensitively. by @mitchej123 in https://github.com/GTNewHorizons/JarJar/pull/20 (0.3.2-beta)
...
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/LittleTiles/pull/57 (1.6.23)
>* Defend against blocks from removed mods by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/55 (1.6.22)
>* Fix dupe glitch by @sbancuz in https://github.com/GTNewHorizons/LittleTiles/pull/54 (1.6.21)
>* Implement pillars by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/53 (1.6.20)
>* Added lookout for background color by @Ranzuu in https://github.com/GTNewHorizons/LittleTiles/pull/52 (1.6.19)
>* Use earcut to close edges of cut meshes by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/49 (1.6.18)
>* Implement generic model loader by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/50 (1.6.18)
>* Don't add blocks server side, getSubBlocks is client only by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/42 (1.6.16)
>* Merge two similar methods by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/45 (1.6.15)
>* Write logged meshes with .obj file extension by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/48 (1.6.15)
>* Rework how tiles are updated by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/51 (1.6.15)
>* Don't delete chisel in survival mode by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/47 (1.6.15)
>* Rework blockpicking to work in survival by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/46 (1.6.15)
>* Make tile entities non-ticking by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/44 (1.6.13)
>* Fix stackoverflow when too many tiles are bordering by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/43 (1.6.10)
>* Turn bounding box into single variables by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/40 (1.6.10)
>* Blockdisplay fixes by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/41 (1.6.10)
>* Implement slope rotation by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/38 (1.6.10)
>* Fix typo by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/39 (1.6.9)
...
>* Add grid aligment and block size by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/33 (1.6.4)
>* Minor fixes by @DarkShadow44 in https://github.com/GTNewHorizons/LittleTiles/pull/34 (1.6.4)
>* Tooltips changes by @czerwonogrodzki in https://github.com/GTNewHorizons/LittleTiles/pull/28 (1.6.4)
...
# Updated - LogisticsPipes - 1.4.24-GTNH --> 1.5.25-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/LogisticsPipes/compare/1.4.24-GTNH...1.5.25-GTNH

## What's Changed:
>* Fix MUI2 C2S issues by @tiffit in https://github.com/GTNewHorizons/LogisticsPipes/pull/123 (1.5.25-GTNH)
...
>* Localization of gui elements and textures by @Ranzuu in https://github.com/GTNewHorizons/LogisticsPipes/pull/114 (1.5.16-GTNH)
>* NEI integration by @ChaosTheLegend in https://github.com/GTNewHorizons/LogisticsPipes/pull/113 (1.5.14-GTNH)
>* Fix fluids not being routed to basic fluid pipes connected to entities that void fluids (for instance, a super tank) by @and-reas-se in https://github.com/GTNewHorizons/LogisticsPipes/pull/102 (1.5.12-GTNH)
>* Fix Scala Check by @UltraProdigy in https://github.com/GTNewHorizons/LogisticsPipes/pull/115 (1.5.12-GTNH)
>* [Memory-opti:fix leak] Fix world leak in ServerPacketBufferHandlerThread by @Alexdoru in https://github.com/GTNewHorizons/LogisticsPipes/pull/111 (1.5.7-GTNH)
>* fluid pipe fixes by @Glease in https://github.com/GTNewHorizons/LogisticsPipes/pull/109 (1.5.5-GTNH)
>* Add the ability to copy the satelliteId by @Firenezz in https://github.com/GTNewHorizons/LogisticsPipes/pull/101 (1.5.5-GTNH)
...
# Updated - LootGames - 2.2.0.1 --> 2.2.12
**Full Changelog**: https://github.com/GTNewHorizons/LootGames/compare/2.2.0.1...2.2.12

## What's Changed:
>* Adjust config Sudoku min/max by @PLASMAchicken in https://github.com/GTNewHorizons/LootGames/pull/35 (2.2.12)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/LootGames/pull/34 (2.2.11)
...
>* fix sudoku msg.lootgames.stage_complete by @ABKQPO in https://github.com/GTNewHorizons/LootGames/pull/27 (2.2.6)
>* Fix Sudoku Loot Chest by @ABKQPO in https://github.com/GTNewHorizons/LootGames/pull/24 (2.2.5)
>* Fix duplicate loot generation in Minesweeper Level 4 by @Worive in https://github.com/GTNewHorizons/LootGames/pull/25 (2.2.5)
...
# Updated - MagicBees - 2.9.4-GTNH --> 2.10.9-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/MagicBees/compare/2.9.4-GTNH...2.10.9-GTNH

## What's Changed:
>* Fix magic apiary GUI bypassing claim protection by @Eldrinn-Elantey in https://github.com/GTNewHorizons/MagicBees/pull/63 (2.10.9-GTNH)
>* Un-hide Hives by @Ranzuu in https://github.com/GTNewHorizons/MagicBees/pull/62 (2.10.8-GTNH)
>* Fix gui crop and localize Inventory title by @Ranzuu in https://github.com/GTNewHorizons/MagicBees/pull/61 (2.10.8-GTNH)
>* Clarified tool tip for each blood frame to reflect actual use by @EricC808 in https://github.com/GTNewHorizons/MagicBees/pull/58 (2.10.7-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/MagicBees/pull/60 (2.10.6-GTNH)
>* cache frequent enum.values() calls by @Alexdoru in https://github.com/GTNewHorizons/MagicBees/pull/59 (2.10.5-GTNH)
...
# Updated - Mantle - 0.5.1 --> 0.5.2
**Full Changelog**: https://github.com/GTNewHorizons/Mantle/compare/0.5.1...0.5.2

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Mantle/pull/11 (0.5.2)

# Updated - MatterManipulator - 0.0.51-GTNH --> 0.1.36-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/MatterManipulator/compare/0.0.51-GTNH...0.1.36-GTNH

## What's Changed:
>* Fix incorrect EnderIO dependency version by @dipo33 in https://github.com/GTNewHorizons/MatterManipulator/pull/55 (0.1.36-GTNH)
>* Adapt to GT5u changes by @Kogepan229 in https://github.com/GTNewHorizons/MatterManipulator/pull/53 (0.1.35-GTNH)
>* Port AE2Stuff Wireless Connector/Hub to AE2 by @Kogepan229 in https://github.com/GTNewHorizons/MatterManipulator/pull/50 (0.1.35-GTNH)
>* Update IFluidLockable to IFluidLockableMui2 API by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/52 (0.1.33-GTNH)
>* Prevent some modes from bypassing grief protection by @Lyfts in https://github.com/GTNewHorizons/MatterManipulator/pull/51 (0.1.31-GTNH)
...
>* Fix copying Crafting Input Buffer manual slots with Matter Manipulator by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/43 (0.1.26-GTNH)
>* [MatterManipulator] Add Open Computers Cable support to Cable Mode  by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/44 (0.1.26-GTNH)
>* Fix Matter Manipulator not copying Carpenter's Blocks correctly by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/46 (0.1.26-GTNH)
>* [MatterManipulator] Fix: Matter Manipulator does not move wireless hubs and wireless connectors correctly by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/37 (0.1.25-GTNH)
>* [MatterManipulator] add Advanced Copy Options by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/40 (0.1.25-GTNH)
>* [MatterManipulator]  Fix AE2 not detecting GT hatches after replacement without server restart by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/36 (0.1.25-GTNH)
>* Fix stacked Fluid Cells where not filled by MM  by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/42 (0.1.25-GTNH)
>* [MatterManipulator] Fix Disconnect when trying to create a Plan by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/41 (0.1.24-GTNH)
>* Matter Manipulator does not copy fluids in dual interfaces by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/33 (0.1.23-GTNH)
>* Implement FMP and Project Red in Matter Manipulator in copy mode by @Luca-Guettinger in https://github.com/GTNewHorizons/MatterManipulator/pull/34 (0.1.23-GTNH)
>* Matter Manip saves NBT between modes by @WhyDoLogic2 in https://github.com/GTNewHorizons/MatterManipulator/pull/31 (0.1.23-GTNH)
>* Localize chat in client by @Discreater in https://github.com/GTNewHorizons/MatterManipulator/pull/19 (0.1.23-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/MatterManipulator/pull/32 (0.1.22-GTNH)
>* [Sub-PR] Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/MatterManipulator/pull/30 (0.1.21-GTNH)
...
>* bump GT to account for https://github.com/GTNewHorizons/GT5-Unofficial/pull/5781 by @boubou19 in https://github.com/GTNewHorizons/MatterManipulator/pull/25 (0.1.16-GTNH)
>* optimize DeMemberator by @danyadev in https://github.com/GTNewHorizons/MatterManipulator/pull/24 (0.1.15-GTNH)
>* Fix compat with CAL by @boubou19 in https://github.com/GTNewHorizons/MatterManipulator/pull/21 (0.1.14-GTNH)
...
# Updated - Minecraft-Backpack-Mod - 2.5.10-GTNH --> 2.6.13-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/compare/2.5.10-GTNH...2.6.13-GTNH

## What's Changed:
>* Localized button letters by @Ranzuu in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/33 (2.6.13-GTNH)
>* Feat: disable backpack pickup when personal backpack is open by @Worive in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/29 (2.6.12-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/27 (2.6.11-GTNH)
>* feat: add dynamic tooltip info for backpacks by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/26 (2.6.10-GTNH)
>* Added optional color customization and inventory/hotbar slots by @Ranzuu in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/25 (2.6.9-GTNH)
>* Fix input field focus in backpack renaming GUI by @ModularityEnjoyer in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/24 (2.6.7-GTNH)
>* Optimize GUI render performance by @gaogao-qwq in https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/pull/23 (2.6.6-GTNH)
...
# Updated - Minetweaker-Gregtech-5-Addon - 2.3.1 --> 2.3.3
**Full Changelog**: https://github.com/GTNewHorizons/Minetweaker-Gregtech-5-Addon/compare/2.3.1...2.3.3
...
# Updated - ModTweaker - 0.12.0 --> 0.13.0
**Full Changelog**: https://github.com/GTNewHorizons/ModTweaker/compare/0.12.0...0.13.0

## What's Changed:
>* change message to logs folder by @Alexdoru in https://github.com/GTNewHorizons/ModTweaker/pull/8 (0.13.0)

# Updated - ModernMarkings - 0.3.12-1.7.10 --> 0.3.13-1.7.10
**Full Changelog**: https://github.com/GTNewHorizons/ModernMarkings/compare/0.3.12-1.7.10...0.3.13-1.7.10

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ModernMarkings/pull/21 (0.3.13-1.7.10)

# Updated - ModularUI - 1.2.20 --> 1.3.4
**Full Changelog**: https://github.com/GTNewHorizons/ModularUI/compare/1.2.20...1.3.4

## What's Changed:
>* Fix memory leak in ModularUIContext by @Alexdoru in https://github.com/GTNewHorizons/ModularUI/pull/94 (1.3.4)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ModularUI/pull/95 (1.3.4)
>* Fix memory leak in ModularUIContext by @Alexdoru in https://github.com/GTNewHorizons/ModularUI/pull/94 (1.3.3)
>* [Sub-PR] Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/ModularUI/pull/93 (1.3.2)
...
# Updated - ModularUI2 - 2.2.18-1.7.10 --> 2.3.72-1.7.10
**Full Changelog**: https://github.com/GTNewHorizons/ModularUI2/compare/2.2.18-1.7.10...2.3.72-1.7.10

## What's Changed:
>* Fix crash in PanelSyncHandler and TextFieldHandler by @Luca-Guettinger in https://github.com/GTNewHorizons/ModularUI2/pull/133 (2.3.72-1.7.10)
>* Added fluid filter to FluidSlotSyncHandler by @TheYoingLad in https://github.com/GTNewHorizons/ModularUI2/pull/134 (2.3.71-1.7.10)
>* Lock PanelSyncManager before init by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/129 (2.3.70-1.7.10)
>* Textfield number input fixes. by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/131 (2.3.70-1.7.10)
>* add FAVORITE_EMPTY icon (hollow star) by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ModularUI2/pull/130 (2.3.69-1.7.10)
>* rename favorite_empty to favorite_outline by @Caedis in https://github.com/GTNewHorizons/ModularUI2/pull/132 (2.3.69-1.7.10)
>* Added per-row and per-column Grid alignment by @TheYoingLad in https://github.com/GTNewHorizons/ModularUI2/pull/127 (2.3.68-1.7.10)
...
>* Implement showSlotOverlay by @Ranzuu in https://github.com/GTNewHorizons/ModularUI2/pull/122 (2.3.63-1.7.10)
>* Fix Debug typo by @Ranzuu in https://github.com/GTNewHorizons/ModularUI2/pull/120 (2.3.62-1.7.10)
>* Fix fluid icon null causing a crash by @Luca-Guettinger in https://github.com/GTNewHorizons/ModularUI2/pull/119 (2.3.61-1.7.10)
>* Add cf and modrinth project ids by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/117 (2.3.60-1.7.10)
>* Improve screen close logic & fix text field focus by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/118 (2.3.60-1.7.10)
>* disable thaumcraft compat mixins with salis arcana by @Alexdoru in https://github.com/GTNewHorizons/ModularUI2/pull/116 (2.3.59-1.7.10)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ModularUI2/pull/115 (2.3.58-1.7.10)
>* Localize the Debug Screen / Add color config by @Ranzuu in https://github.com/GTNewHorizons/ModularUI2/pull/114 (2.3.57-1.7.10)
>* Added opacity to UITexture copy() method by @TheYoingLad in https://github.com/GTNewHorizons/ModularUI2/pull/112 (2.3.56-1.7.10)
>* Fix NPE when on unloading world by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/113 (2.3.56-1.7.10)
>* Sync Uptsream: Grid fixes by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/110 (2.3.55-1.7.10)
>* Split container stack to each player by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/111 (2.3.55-1.7.10)
>* Sync upstream by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/105 (2.3.54-1.7.10)
>* Lwjgl3ify compat by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/103 (2.3.53-1.7.10)
>* add nei overlay and underlay similar to mui1 by @Luca-Guettinger in https://github.com/GTNewHorizons/ModularUI2/pull/109 (2.3.52-1.7.10)
>* Fixed mod logo path in mcmodinfo by @JackOfNoneTrades in https://github.com/GTNewHorizons/ModularUI2/pull/108 (2.3.51-1.7.10)
>* Changed visibility of methods, added a null check by @TheYoingLad in https://github.com/GTNewHorizons/ModularUI2/pull/107 (2.3.50-1.7.10)
>* Added visibility for 0 sized fluid stacks by @TheYoingLad in https://github.com/GTNewHorizons/ModularUI2/pull/106 (2.3.49-1.7.10)
>* [Sub-PR] Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/ModularUI2/pull/99 (2.3.49-1.7.10)
>* Improve number field by @NeutronSelector in https://github.com/GTNewHorizons/ModularUI2/pull/101 (2.3.48-1.7.10)
>* Added short syncing by @TheYoingLad in https://github.com/GTNewHorizons/ModularUI2/pull/104 (2.3.47-1.7.10)
>* Fixes Red Slots on all mui2 guis by @Ranzuu in https://github.com/GTNewHorizons/ModularUI2/pull/102 (2.3.46-1.7.10)
>* Update Nea by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/100 (2.3.45-1.7.10)
>* Get NEA from curse maven instead of local files by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/98 (2.3.44-1.7.10)
>* Fix slot group not being applied to slots by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/97 (2.3.44-1.7.10)
>* Refactor fluid slot filling/draining logic & better support for IFluidContainerItem by @danyadev in https://github.com/GTNewHorizons/ModularUI2/pull/93 (2.3.43-1.7.10)
>* Sync upstream by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/96 (2.3.41-1.7.10)
>* Sync upstream by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/95 (2.3.39-1.7.10)
>* fix stacksizes<1 drawing on slots by @chrombread in https://github.com/GTNewHorizons/ModularUI2/pull/94 (2.3.37-1.7.10)
>* Sync upstream Christmas edition by @brachy84 in https://github.com/GTNewHorizons/ModularUI2/pull/86 (2.3.35-1.7.10)
>* Show tooltip about filling when you can fill the slot, not drain it by @danyadev in https://github.com/GTNewHorizons/ModularUI2/pull/92 (2.3.33-1.7.10)
>* Add method that allows slots to override stack amount rendering by @RecursivePineapple in https://github.com/GTNewHorizons/ModularUI2/pull/89 (2.3.31-1.7.10)
>* Add getItemStackForRendering method to ItemSlot by @Kogepan229 in https://github.com/GTNewHorizons/ModularUI2/pull/90 (2.3.28-1.7.10)
>* getContainerForFilledItem return null when container.drain returns null by @SuperSoupr in https://github.com/GTNewHorizons/ModularUI2/pull/88 (2.3.25-1.7.10)
>* DropDownMenu: Align text properly by @DarkShadow44 in https://github.com/GTNewHorizons/ModularUI2/pull/55 (2.3.24-1.7.10)
>* Add NEI integration by @Shigure-Ruiseki in https://github.com/GTNewHorizons/ModularUI2/pull/85 (2.3.24-1.7.10)
...
>* DropDownMenu: Don't allow click through for items by @DarkShadow44 in https://github.com/GTNewHorizons/ModularUI2/pull/51 (2.3.9-1.7.10)
>* DropDownMenu: Put a bit of space between arrow and right side by @DarkShadow44 in https://github.com/GTNewHorizons/ModularUI2/pull/53 (2.3.9-1.7.10)
>* StyledText: Use getTextColor instead of getColor by @DarkShadow44 in https://github.com/GTNewHorizons/ModularUI2/pull/52 (2.3.9-1.7.10)
>* Make dropdown use the same background as the main item by @DarkShadow44 in https://github.com/GTNewHorizons/ModularUI2/pull/54 (2.3.9-1.7.10)
>* Add click sound override to Toggle and Cycle buttons by @serenibyss in https://github.com/GTNewHorizons/ModularUI2/pull/61 (2.3.9-1.7.10)
>* add the ability to scroll to change values for Numeric text fields by @chrombread in https://github.com/GTNewHorizons/ModularUI2/pull/60 (2.3.9-1.7.10)
...
# New Mod - MouseTweaks:2.5.2-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/MouseTweaks/compare/2.4.5-GTNH...2.5.2-GTNH

## What's Changed:
>* fix dragSplitting by @0hwx in https://github.com/GTNewHorizons/MouseTweaks/pull/16 (2.5.2-GTNH)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/MouseTweaks/pull/15 (2.5.1-GTNH)
>* Update BS + Deps + Move Out Of InventoryBogoSorter by @Caedis in https://github.com/GTNewHorizons/MouseTweaks/pull/14 (2.5.0-GTNH)
...
# Updated - NEI-Integration - 1.5.0 --> 1.5.3
**Full Changelog**: https://github.com/GTNewHorizons/NEI-Integration/compare/1.5.0...1.5.3

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/NEI-Integration/pull/13 (1.5.3)
...
# Updated - Natura - 2.8.9 --> 2.8.19
**Full Changelog**: https://github.com/GTNewHorizons/Natura/compare/2.8.9...2.8.19

## What's Changed:
>* Fix issues with tree generation by @DarkShadow44 in https://github.com/GTNewHorizons/Natura/pull/42 (2.8.19)
>* fix world server memory leak in Tree Generators by @Alexdoru in https://github.com/GTNewHorizons/Natura/pull/41 (2.8.18)
>* Make silk touch drop full bark bloodwood by @LooseEthics in https://github.com/GTNewHorizons/Natura/pull/40 (2.8.17)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Natura/pull/39 (2.8.16)
>* Update Buildscript by @Ruling-0 in https://github.com/GTNewHorizons/Natura/pull/38 (2.8.15)
>* Prevent mobs from spawning on Topiary Blocks by @zacharylott94 in https://github.com/GTNewHorizons/Natura/pull/35 (2.8.15)
...
# Updated - Navigator - 1.0.17 --> 1.1.3
**Full Changelog**: https://github.com/GTNewHorizons/Navigator/compare/1.0.17...1.1.3

## What's Changed:
>* Fix search bar cursor blinking too fast by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Navigator/pull/16 (1.1.3)
>* fix: render navigator waypoint beacons without distance fade by @Eldrinn-Elantey in https://github.com/GTNewHorizons/Navigator/pull/14 (1.1.2)
...
# Updated - NewHorizonsCoreMod - 2.7.268 --> 2.8.276
**Full Changelog**: https://github.com/GTNewHorizons/NewHorizonsCoreMod/compare/2.7.268...2.8.276

## What's Changed:
>* Add Computation and Arithmetic Singularity Recipes + singularity deps by @Auynonymous in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1792 (2.8.276)
>* BEC Multi Controller and Hatch Recipes by @Ruling-0 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1791 (2.8.276)
>* remove co2 output from cast iron -> steel by @Pxx500 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1793 (2.8.276)
>* Ore dict Cover Screen by @Eldrinn-Elantey in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1789 (2.8.276)
>* Blackstone decorative recipes by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1790 (2.8.275)
>* fix window not closing after confirming on macos by @danyadev in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1662 (2.8.274)
>* Use oredict for project red illumar by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1785 (2.8.273)
>* Split coin icon and background textures by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1787 (2.8.273)
>* use recipe not tier by @LazyFleshWasTaken in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1783 (2.8.272)
>* Add recipes for the Vending Machine Casing by @YannickMG in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1782 (2.8.272)
...
>* Add Assembler Recipes for Volcanus and Cryogenic Freezer Controllers by @Auynonymous in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1764 (2.8.255)
>* Xenoxene culture recipe in Beamcrafter after initial xenoxene by @ham-corp in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1760 (2.8.253)
>* Adds missing singularities to BHC by @OTPANNIEXD in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1761 (2.8.252)
>* Change plasmaArcFurnaceRecipes to normal maps by @kuba6000 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1705 (2.8.252)
>* Fix RemoteIO location chip recipe by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1754 (2.8.250)
>* Update dislocation stat in thaumonomicon by @koolkrafter5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1753 (2.8.249)
>* Changes antimatter tier from UMV to UIV by @OTPANNIEXD in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1755 (2.8.249)
>* Update 3 recipes post structure rework by @Yoshy2002 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1756 (2.8.249)
>* Add Assembler & Beamcrafter Unstable (Mobius Stable) Ingot Recipes by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1758 (2.8.249)
>* Replace Aspect.getAspect with direct references to aspect objects for thaum aspects by @koolkrafter5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1748 (2.8.248)
...
>* Make sulfur from cloud recipe less restrictive (3x3 into 2x2) by @Algent in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1750 (2.8.245)
>* Fix Quick and Dirty Portal Gen recipe by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1751 (2.8.245)
>* Add Recipes to Title Screen Music Discs by @Auynonymous in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1746 (2.8.244)
>* added oredict tags by @MLGfruitshoot in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1747 (2.8.244)
>* Rotated Blood Channel recipe 90 degrees by @MarloGr in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1745 (2.8.242)
...
>* Update Turbine Recipes for Sttructure Rework by @Yoshy2002 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1730 (2.8.236)
>* Fix Dirty Portal Generator Recipe to Use OreDict Diamond by @liryril1 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1734 (2.8.236)
...
>* Fix ore dictionary for extra utils color blocks by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1716 (2.8.218)
>* Add sulfur block by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1706 (2.8.216)
>* Aquasalus recipe by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1703 (2.8.216)
>* Fix supreme pizza gloves not preventing fire hazard item damage by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1718 (2.8.215)
>* Adds ore dict entries for BOP wooden fences and fence gates by @tiffit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1717 (2.8.215)
>* New power IC integration by @GDCloudstrike in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1713 (2.8.213)
>* fix BeamcraftingRecipes throwing a no such method error following changes in gt5u by @Alexdoru in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1715 (2.8.213)
...
>* Add circ 1 to chisel recipes by @LazyFleshWasTaken in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1702 (2.8.205)
>* Minor NEI debloat by @TotallyNotOndre in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1699 (2.8.204)
>* Fix vanilla only drawers in Upgrade Template craft by @TotallyNotOndre in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1697 (2.8.204)
>* Adds Mixer Casing recipe in Assembler by @KleinGrrmpf in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1696 (2.8.204)
>* Add a Machine Recipe for Coated Circuit Boards by @NotKaizul in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1689 (2.8.203)
>* Add planck-scale circuit by @GDCloudstrike in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1692 (2.8.203)
>* Adds Recipe for Pattern Repeater by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1674 (2.8.202)
>* simplify fluid heater recipes by @KleinGrrmpf in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1690 (2.8.202)
>* Adds radox step back to ICO by @StaffiX in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1691 (2.8.202)
>* Convert configs from YamCore to GTNHLib by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1652 (2.8.200)
>* Revert #1554: New -> Old Coin Textures by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1685 (2.8.200)
>* Nuke duplicate pyro recipes by @TotallyNotOndre in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1687 (2.8.200)
>* Redo some of Ender's QOL/decorative recipes by @LazyFleshWasTaken in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1686 (2.8.200)
>* Replace ic2 solar panel with ULV Solar Panel by @thehoblit in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1682 (2.8.198)
>* fix(babychest): prevent fuel duplication by @Eldrinn-Elantey in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1683 (2.8.198)
>* Add translation keys to NHCore fluids by @iouter in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1680 (2.8.196)
...
>* Fixes Conflict Between ThaumicBases & Exploration Loader by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1673 (2.8.193)
>* Fix Diamond Lattice Forming Press Recipe by @Yoshy2002 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1671 (2.8.192)
>* Crucible leather armor backprocessing by @LooseEthics in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1647 (2.8.192)
>* Fix Format Error of Wire/Cable by @iouter in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1670 (2.8.191)
>* Remove old, unused IDEA project file. by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1668 (2.8.190)
>* Make metal bars placeable & remove unused bars by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1667 (2.8.190)
>* Dead wood recipe by @LooseEthics in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1669 (2.8.190)
>* Replacement recipes for those that used particles by @ham-corp in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1665 (2.8.190)
>* Equalise Botania-TC integration with Base Thaumcraft by @LazyFleshWasTaken in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1352 (2.8.190)
>* [Sub-PR] Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1608 (2.8.190)
>* Assembler Recipe for Wireless Access Point Assembler by @WhyDoLogic2 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1664 (2.8.189)
>* Reduced cost of collider casing by @ham-corp in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1663 (2.8.187)
>* Remove IC2 Furnace From Recipes by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1659 (2.8.185)
>* Beamcrafting missing and updated recipes by @ham-corp in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1661 (2.8.185)
>* Use already existing GT5U debug flags instead of custom ones by @boubou19 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1657 (2.8.184)
>* Add isModLoaded around Chisel API calls in natura script by @C0bra5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1658 (2.8.184)
>* Update GT5-Unofficial dependency version by @Dream-Master in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1655 (2.8.183)
>* LHC/Beamcrafting recipes by @ham-corp in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1498 (2.8.183)
>* Make the CustomToolTips use Minecraft Lang by @iouter in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1620 (2.8.183)
>* Add food and food-adjacent items to the smoker by @LooseEthics in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1650 (2.8.182)
>* Bump Postea & GT5u by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1654 (2.8.182)
>* Fix Improper ItemIds by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1653 (2.8.181)
...
>* Redirect the Wiki button link to the Chinese GTNH Wiki when the Minecraft language is 'zh_CN', 'zh_TW', 'zh_HK' by @ABKQPO in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1640 (2.8.167)
>* succumb to cloudflare security policies by spoofing a UA during dependency downloads by @Glease in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1611 (2.8.167)
>* Single Piston Recipe by @Caedis in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1637 (2.8.166)
>* Switchout Stone Dust/Plate From CropsNH to Coremod by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1636 (2.8.165)
>* Switch GT machines to OreDictItemStack by @Caedis in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1634 (2.8.164)
>* Balancing botania infinite mana. Reduced the cost of Asgardandelion to fit more with the guilty pool by @kopatych3348 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1635 (2.8.164)
>* Add Vis-Regulated Maintenance Hatch Recipe by @jude123412 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1623 (2.8.162)
>* Image Optimization & Add IO Workflow by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1632 (2.8.162)
...
>* Add Dust -> Rock Compression for Tuff by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1626 (2.8.157)
>* Change Pam's Harvest the Nether script to Fether by @glowredman in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1622 (2.8.157)
>* Adds Assembler Recipe For Engine Intake by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1624 (2.8.157)
>* Update Postea dependency version to 1.2.3 and gt to 324 by @C0bra5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1625 (2.8.156)
>* CropsNH Integration/IC2 Depreciation by @C0bra5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1604 (2.8.155)
>* Update postea handlers for new version. by @C0bra5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1591 (2.8.154)
>* Add Recipe for Pattern Provider by @asquared31415 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1621 (2.8.153)
...
>* Fix Water Singularity Recipe by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1616 (2.8.149)
>* reduce the egregious amount of superconductor uhv plates in the firewall nac recipe by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1617 (2.8.149)
>* make nac research a cpu instead of a processor to avoid conflict by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1613 (2.8.148)
>* Make actually appropriate recipes by @LazyFleshWasTaken in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1609 (2.8.148)
>* Fix copper grate oxidization recipe by @ls-r in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1610 (2.8.147)
>* Nanochip Assembly Complex coremod changes by @serenibyss in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1589 (2.8.147)
...
>* Ender-io QoL by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1533 (2.8.140)
>* Remove server synchronization for Custom Tooltips by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1597 (2.8.139)
>* Fix Gradle deprecation warnings by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1603 (2.8.138)
...
>* Remove unused config entries by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1595 (2.8.125)
>* Remove Unused Code by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1581 (2.8.125)
...
>* Replace Yamcl `LogHelper` with Log4j `Logger` by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1577 (2.8.113)
>* Add GTNH Music Discs by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1575 (2.8.112)
>* Undo Electric Jukebox jank by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1578 (2.8.112)
>* De-Yamcl-ify the `BlockList` by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1576 (2.8.112)
>* adapt to spinmatron internal rename (and fix compilation due to other gt5 pr) by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1574 (2.8.111)
>* Replace Fluid Packet w/ Water Singularity in Water Cell by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1573 (2.8.110)
>* Fixed EV Field Gen Circuit & Re-Implements Microchip Fix by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1572 (2.8.110)
...
>* move foundry recipes to its own script by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1556 (2.8.96)
>* remove all methods to produce wire extrusion shapes in coremod by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1548 (2.8.95)
>* Coremod changes for GT5u #5672 by @serenibyss in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1549 (2.8.95)
>* integrate boiled water into recipes by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1550 (2.8.95)
>* move foundry recipes to coremod by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1551 (2.8.95)
...
>* Added additional recipes for making wood planks(GT) with higher-tier glues by @loenaaaa in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1529 (2.8.82)
...
>* Fix Creosote Slab Count by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1518 (2.8.68)
...
>* Fix stained glass pane recipe conflicts by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1494 (2.8.62)
>* Script for Random Boubles by @Ethryan in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1495 (2.8.62)
>* Add Obsidian Plate Bender Recipe For TCon Obsidian Ingots by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1492 (2.8.62)
...
>* Changes EIO Crystal Dust Maceration Tier by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1484 (2.8.60)
>* Slightly Delay Compressed Chest in Progression by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1487 (2.8.60)
>* Added Red sand and Red Sandstone Recipies by @TKDMzq in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1403 (2.8.59)
>* fix crash referencing useless cell item by @chrombread in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1477 (2.8.58)
>* Sunnarium recipe cleanup and improvements by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1475 (2.8.58)
...
>* Rewrite Luggage's Thaumonomicon Entry by @koolkrafter5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1469 (2.8.54)
...
>* Alternate infusion matrix recipe by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1459 (2.8.50)
>* Added Stone tool recipes by @captainjolt in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1461 (2.8.50)
...
>* Hide Avaritia Neutronium Compressor by @UltraProdigy in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1445 (2.8.40)
...
# New Mod - NoHotbarNeeded:0.0.5
**Full Changelog**: https://github.com/GTNewHorizons/NoHotbarNeeded/compare/0.0.3...0.0.5

## What's Changed:
>* Fix the mod by @Alexdoru in https://github.com/GTNewHorizons/NoHotbarNeeded/pull/2 (0.0.5)
>* fix npe when slot null by @lc-1337 in https://github.com/GTNewHorizons/NoHotbarNeeded/pull/1 (0.0.4)
...
## What's Changed:
>* Revert BM Dep by @UltraProdigy in https://github.com/GTNewHorizons/Nodal-Mechanics/pull/14 (1.3.4-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Nodal-Mechanics/pull/15 (1.3.4-GTNH)
...
# Updated - NotEnoughEnergistics - 1.7.14 --> 1.7.29
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughEnergistics/compare/1.7.14...1.7.29

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/66 (1.7.29)
...
>* Update PacketCraftingRequest.java by @Eldrinn-Elantey in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/61 (1.7.24)
>* fix order missing ingredients & adapt to native essentia / stack type api by @lc-1337 in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/60 (1.7.23)
>* Ore dict scrolling not resets stack size by @Kogepan229 in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/59 (1.7.22)
>* Fix crafting gui open in non-hand slot by @Kogepan229 in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/58 (1.7.21)
>* Fix GUI not returning when order crafting with no preview by @Kogepan229 in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/56 (1.7.20)
>* Fix primary gui by @Kogepan229 in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/57 (1.7.20)
>* restore keybinds, update hard deps by @lc-1337 in https://github.com/GTNewHorizons/NotEnoughEnergistics/pull/54 (1.7.19)
...
# Updated - NotEnoughItems - 2.8.44-GTNH --> 2.8.100-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughItems/compare/2.8.44-GTNH...2.8.100-GTNH

## What's Changed:
>* Guard loadTransferRects against plugin init errors by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/939 (2.8.100-GTNH)
>* Fix ItemStack load from NBT with short overflow by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/938 (2.8.99-GTNH)
>* Smart-Fallback & Alchemic Chemistry Set Fix by @MassAnarchyy in https://github.com/GTNewHorizons/NotEnoughItems/pull/935 (2.8.99-GTNH)
>* Fix Recipe Page Area by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/932 (2.8.98-GTNH)
>* GuiRecipe: Add scrollPages Option by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/929 (2.8.97-GTNH)
>* Fix mui2 screen capture by @sisyphussy in https://github.com/GTNewHorizons/NotEnoughItems/pull/930 (2.8.97-GTNH)
...
>* Fix Collapsed Recipes in Bookmarks by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/915 (2.8.91-GTNH)
>* Rollback PR#913 by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/916 (2.8.91-GTNH)
>* Fix Autocrafting NPE by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/917 (2.8.91-GTNH)
>* fix client -> server sync in creative gui by @lc-1337 in https://github.com/GTNewHorizons/NotEnoughItems/pull/913 (2.8.90-GTNH)
>* Don't block slot click if canCheatItem is false by @Kogepan229 in https://github.com/GTNewHorizons/NotEnoughItems/pull/912 (2.8.89-GTNH)
>* Refactor recipe profiler by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/911 (2.8.88-GTNH)
>* Improve Recipe Badge by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/909 (2.8.87-GTNH)
>* Fix Repair Handler with broken ItemStack by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/910 (2.8.87-GTNH)
>* Disable badge by default by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/907 (2.8.86-GTNH)
>* Chance tooltip by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/906 (2.8.85-GTNH)
>* Fix Collapsed Recipes in Bookmarks by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/905 (2.8.84-GTNH)
>* Improve image exporter data dumper by @koolkrafter5 in https://github.com/GTNewHorizons/NotEnoughItems/pull/902 (2.8.83-GTNH)
>* Add recipe chance to bookmarks by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/903 (2.8.83-GTNH)
>* Add Reset to Debug Handler by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/901 (2.8.82-GTNH)
>* Refactor DebugHandlerWidget by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/900 (2.8.81-GTNH)
>* Add Repair Handler by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/899 (2.8.80-GTNH)
...
>* fix glColor4f; disabled generateSingleRecipeFavorites by default by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/884 (2.8.74-GTNH)
>* Optimize images by @UltraProdigy in https://github.com/GTNewHorizons/NotEnoughItems/pull/883 (2.8.73-GTNH)
...
>* Removed GTNHLib from required dependency by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/866 (2.8.69-GTNH)
>* Change Bookmarks Panel Width by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/862 (2.8.68-GTNH)
...
>* Added Transparency Border to recipe-background and catalyst-tab by @timb8g in https://github.com/GTNewHorizons/NotEnoughItems/pull/822 (2.8.48-GTNH)
>* Hide Untranslator Subset when Untranslator disabled by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/827 (2.8.47-GTNH)
...
>* warn and skip on duplicate alarm sounds by @2ndDerivative in https://github.com/GTNewHorizons/Nuclear-Control/pull/34 (2.7.2)
>* Javadoc, Optimizations and Bugfixes by @guid118 in https://github.com/GTNewHorizons/Nuclear-Control/pull/33 (2.7.0)

# Updated - Nutrition - 0.1.3 --> 0.1.9
**Full Changelog**: https://github.com/GTNewHorizons/Nutrition/compare/0.1.3...0.1.9

## What's Changed:
>* Styling by @Ranzuu in https://github.com/GTNewHorizons/Nutrition/pull/34 (0.1.9)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Nutrition/pull/33 (0.1.8)
>* fix world server leak caused by EventWorldTick by @Alexdoru in https://github.com/GTNewHorizons/Nutrition/pull/32 (0.1.7)
...
# Updated - OCGlasses - 1.6.1-GTNH --> 1.6.7-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/OCGlasses/compare/1.6.1-GTNH...1.6.7-GTNH

## What's Changed:
>* feat(Computronics): add chatbox upgrade for glasses. by @hinyb in https://github.com/GTNewHorizons/OCGlasses/pull/22 (1.6.7-GTNH)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/OCGlasses/pull/24 (1.6.5-GTNH)
>* Update buildscript and Baubles dep by @Ruling-0 in https://github.com/GTNewHorizons/OCGlasses/pull/23 (1.6.3-GTNH)
>* Fixed black screen when rendering ItemIcon by @SvineruS in https://github.com/GTNewHorizons/OCGlasses/pull/21 (1.6.3-GTNH)

# Updated - OpenBlocks - 1.11.7-GTNH --> 1.12.14-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/OpenBlocks/compare/1.11.7-GTNH...1.12.14-GTNH

## What's Changed:
>* Add auto-equip on grave interaction by @Eldrinn-Elantey in https://github.com/GTNewHorizons/OpenBlocks/pull/48 (1.12.14-GTNH)
>* Fix block breaker pushing items to wrong inventory side by @Luca-Guettinger in https://github.com/GTNewHorizons/OpenBlocks/pull/46 (1.12.13-GTNH)
>* Fix two world client leaks in renderers by @Alexdoru in https://github.com/GTNewHorizons/OpenBlocks/pull/47 (1.12.12-GTNH)
>* Fix hang glider not usable from offhand by @Lyfts in https://github.com/GTNewHorizons/OpenBlocks/pull/44 (1.12.11-GTNH)
>* Fix compact chat messing up the grave message by @Alexdoru in https://github.com/GTNewHorizons/OpenBlocks/pull/45 (1.12.10-GTNH)
>* Fix riding issue with hang glider by @cargocats in https://github.com/GTNewHorizons/OpenBlocks/pull/43 (1.12.9-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/OpenBlocks/pull/42 (1.12.8-GTNH)
...
# Updated - OpenComputers - 1.11.20-GTNH --> 1.12.44-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/OpenComputers/compare/1.11.20-GTNH...1.12.44-GTNH

## What's Changed:
>* More server side optimizations by @Caedis in https://github.com/GTNewHorizons/OpenComputers/pull/195 (1.12.44-GTNH)
>* expose computer.realTime() to user programs by @Eldrinn-Elantey in https://github.com/GTNewHorizons/OpenComputers/pull/196 (1.12.43-GTNH)
>* fix font render with Angelica 2.1.x by @PinkYuDeer in https://github.com/GTNewHorizons/OpenComputers/pull/184 (1.12.42-GTNH)
>* [Memory-opti:fix leak] fix two world leaks by @Alexdoru in https://github.com/GTNewHorizons/OpenComputers/pull/189 (1.12.40-GTNH)
>* fix(appeng): isolate AE2 registration to prevent NoClassDefFoundError by @hinyb in https://github.com/GTNewHorizons/OpenComputers/pull/190 (1.12.39-GTNH)
>* feat(appeng): enhance appeng integration APIs by @hinyb in https://github.com/GTNewHorizons/OpenComputers/pull/188 (1.12.38-GTNH)
...
>* GeolyzerEvent.Analyze getMetaTileEntity metadata fix by @MarkinoTeck in https://github.com/GTNewHorizons/OpenComputers/pull/175 (1.12.26-GTNH)
>* feat(appeng): integrate StackApi for full fluid and essentia support. by @hinyb in https://github.com/GTNewHorizons/OpenComputers/pull/169 (1.12.24-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/OpenComputers/pull/181 (1.12.24-GTNH)
>* rewrite asm class transformer to java by @danyadev in https://github.com/GTNewHorizons/OpenComputers/pull/177 (1.12.22-GTNH)
>* Remove fluid canner handling by @FourIsTheNumber in https://github.com/GTNewHorizons/OpenComputers/pull/174 (1.12.16-GTNH)
>* Update buildscript to 2.0.9 by @eigenraven in https://github.com/GTNewHorizons/OpenComputers/pull/172 (1.12.12-GTNH)
>* fix coroutine.wrap in openOS by @asquared31415 in https://github.com/GTNewHorizons/OpenComputers/pull/168 (1.12.12-GTNH)
>* fix(render): adapt hodgepodge fixBottomFaceUV by @leagris in https://github.com/GTNewHorizons/OpenComputers/pull/171 (1.12.12-GTNH)
>* Add NBT decoder to Data Card by @zyf051520 in https://github.com/GTNewHorizons/OpenComputers/pull/167 (1.12.9-GTNH)
>* fix(blood-magic): getSacrificeMultiplier returned incorrect value. by @hinyb in https://github.com/GTNewHorizons/OpenComputers/pull/163 (1.12.8-GTNH)
>* use MinecraftServer instance instead of CofhCore#server by @Alexdoru in https://github.com/GTNewHorizons/OpenComputers/pull/164 (1.12.8-GTNH)
>* Adapt to AE universal GUI changes by @DarkShadow44 in https://github.com/GTNewHorizons/OpenComputers/pull/161 (1.12.8-GTNH)
>* Stop checking glGetError if the setting is disabled by @mitchej123 in https://github.com/GTNewHorizons/OpenComputers/pull/162 (1.12.6-GTNH)
...
# Updated - OpenModsLib - 0.10.11 --> 0.10.14
**Full Changelog**: https://github.com/GTNewHorizons/OpenModsLib/compare/0.10.11...0.10.14

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/OpenModsLib/pull/10 (0.10.14)
>* Add keybinding to directly open the calculator by @wlhlm in https://github.com/GTNewHorizons/OpenModsLib/pull/9 (0.10.13)

# Updated - OpenModularTurrets - 2.4.3 --> 2.4.5
**Full Changelog**: https://github.com/GTNewHorizons/OpenModularTurrets/compare/2.4.3...2.4.5

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/OpenModularTurrets/pull/11 (2.4.5)
>* Update / Localization of gui elements by @Ranzuu in https://github.com/GTNewHorizons/OpenModularTurrets/pull/10 (2.4.4)

# Updated - OpenPrinter - 0.3.0-GTNH --> 0.3.1-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/OpenPrinter/compare/0.3.0-GTNH...0.3.1-GTNH
...
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - PersonalSpace - 1.0.33 --> 1.0.39
**Full Changelog**: https://github.com/GTNewHorizons/PersonalSpace/compare/1.0.33...1.0.39

## What's Changed:
>* Add applyToAllSurfaceLayers generation option by @paulbatum in https://github.com/GTNewHorizons/PersonalSpace/pull/42 (1.0.39)
...
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/PersonalSpace/pull/38 (1.0.34)

# Updated - Postea - 1.1.3 --> 1.2.5
**Full Changelog**: https://github.com/GTNewHorizons/Postea/compare/1.1.3...1.2.5

## What's Changed:
>* Fix Incorrect Annotation on ChunkEvent by @UltraProdigy in https://github.com/GTNewHorizons/Postea/pull/23 (1.2.5)
>* Fix Chunk API Compatibility by @C0bra5 in https://github.com/GTNewHorizons/Postea/pull/22 (1.2.4)
>* Enforce non-nullability of return values for transformation handlers by @C0bra5 in https://github.com/GTNewHorizons/Postea/pull/21 (1.2.3)
>* Add support for multiple mods remapping the same item/block/tile entity. by @C0bra5 in https://github.com/GTNewHorizons/Postea/pull/18 (1.2.2)
...
# Updated - ProjectBlue - 1.2.1-GTNH --> 1.2.10-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/ProjectBlue/compare/1.2.1-GTNH...1.2.10-GTNH

## What's Changed:
>* remove some system.out logging by @Alexdoru in https://github.com/GTNewHorizons/ProjectBlue/pull/9 (1.2.10-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ProjectBlue/pull/8 (1.2.9-GTNH)
>* 2x2 and 3x3 Control Panels, and Recoloring by @DTK-MrRaccoon in https://github.com/GTNewHorizons/ProjectBlue/pull/6 (1.2.9-GTNH)
>* Update buildscript by @Ruling-0 in https://github.com/GTNewHorizons/ProjectBlue/pull/7 (1.2.4-GTNH)

# Updated - ProjectRed - 4.12.6-GTNH --> 4.12.38-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/ProjectRed/compare/4.12.6-GTNH...4.12.38-GTNH

## What's Changed:
>* Fix ProjectRed wires not providing redstone power by @Luca-Guettinger in https://github.com/GTNewHorizons/ProjectRed/pull/82 (4.12.38-GTNH)
>* Add IInventory to block breaker for pipe connectivity by @Luca-Guettinger in https://github.com/GTNewHorizons/ProjectRed/pull/79 (4.12.37-GTNH)
>* Change license to MIT by @xronin01 in https://github.com/GTNewHorizons/ProjectRed/pull/80 (4.12.36-GTNH)
>* Change license to MIT by @xronin01 in https://github.com/GTNewHorizons/ProjectRed/pull/80 (4.12.35-GTNH)
...
>* Improve interaction between locked drawers and dynamic item responder chip by @Dragovorn in https://github.com/GTNewHorizons/ProjectRed/pull/75 (4.12.30-GTNH)
>* Move moss spreading to mixin-based variant by @MalTeeez in https://github.com/GTNewHorizons/ProjectRed/pull/72 (4.12.29-GTNH)
>* Localization of GUI elements by @Ranzuu in https://github.com/GTNewHorizons/ProjectRed/pull/71 (4.12.28-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ProjectRed/pull/70 (4.12.27-GTNH)
...
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Railcraft/pull/115 (9.17.23)
>* cache EnumOre#values() by @Alexdoru in https://github.com/GTNewHorizons/Railcraft/pull/114 (9.17.21)
...
>* [Memory-opti:fix leak] Fix world leak in TileAnchorWorld by @Alexdoru in https://github.com/GTNewHorizons/Railcraft/pull/104 (9.17.9)
>* fix missing track names by @brandyyn in https://github.com/GTNewHorizons/Railcraft/pull/103 (9.17.6)
...
# Updated - Random-Things - 2.6.6 --> 2.7.7
**Full Changelog**: https://github.com/GTNewHorizons/Random-Things/compare/2.6.6...2.7.7

## What's Changed:
>* fix bloodmoon spawner mixin following changes in hodgepodge by @Alexdoru in https://github.com/GTNewHorizons/Random-Things/pull/20 (2.7.7)
>* Fix spectre teleportation by @Alexdoru in https://github.com/GTNewHorizons/Random-Things/pull/21 (2.7.6)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Random-Things/pull/19 (2.7.5)
>* Fix WorldServer memory leak by @Alexdoru in https://github.com/GTNewHorizons/Random-Things/pull/18 (2.7.4)
>* Localization of title and gui elemets (+gradle update) by @Ranzuu in https://github.com/GTNewHorizons/Random-Things/pull/16 (2.7.3)
...
# New Mod - RandomBoubles:1.1.6
**Full Changelog**: https://github.com/GTNewHorizons/RandomBoubles/compare/1.0.0...1.1.6

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/RandomBoubles/pull/9 (1.1.6)
...
# Updated - Realistic-World-Gen - alpha-1.5.0 --> alpha-1.5.2
**Full Changelog**: https://github.com/GTNewHorizons/Realistic-World-Gen/compare/alpha-1.5.0...alpha-1.5.2
...
# Updated - RemoteIO - 2.7.6 --> 2.7.9
**Full Changelog**: https://github.com/GTNewHorizons/RemoteIO/compare/2.7.6...2.7.9

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/RemoteIO/pull/28 (2.7.9)
>* fix client crash on dedicated server by @Alexdoru in https://github.com/GTNewHorizons/RemoteIO/pull/26 (2.7.8)
...
# Updated - SC2 - 2.3.12 --> 2.3.14
**Full Changelog**: https://github.com/GTNewHorizons/SC2/compare/2.3.12...2.3.14

## What's Changed:
>* Metal Textures by @koolkrafter5 in https://github.com/GTNewHorizons/SC2/pull/15 (2.3.14)
>* reduce memory usage caused by intensive call to `ComponentTypes.values()` by @boubou19 in https://github.com/GTNewHorizons/SC2/pull/16 (2.3.14)
...
>* Localization by @Ranzuu in https://github.com/GTNewHorizons/SGCraft/pull/24 (1.4.10-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/SGCraft/pull/25 (1.4.10-GTNH)
...
# Updated - Salis-Arcana - 1.1.33-GTNH --> 1.1.64-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Salis-Arcana/compare/1.1.33-GTNH...1.1.64-GTNH

## What's Changed:
>* Merge from main by @Dream-Master in https://github.com/GTNewHorizons/Salis-Arcana/pull/8 (1.1.60-GTNH)
>* Sync with upstream  by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/Salis-Arcana/pull/2 (1.1.59-GTNH)
>* merge main into gtnh by @Dream-Master in https://github.com/GTNewHorizons/Salis-Arcana/pull/3 (1.1.59-GTNH)
...
>* Replace custom config sync with gtnhlibs `@Config.Sync` by @Lyfts in https://github.com/GTNewHorizons/ServerUtilities/pull/288 (2.2.30)
>* Make farmland trampling preventable in claimed chunks by @Lyfts in https://github.com/GTNewHorizons/ServerUtilities/pull/283 (2.2.29)
>* make silent_backup work by @Algent in https://github.com/GTNewHorizons/ServerUtilities/pull/286 (2.2.29)
>* Add ability to flip specified game rules when server is empty by @Algent in https://github.com/GTNewHorizons/ServerUtilities/pull/284 (2.2.29)
...
>* Add title location option for notifications by @alppp in https://github.com/GTNewHorizons/ServerUtilities/pull/273 (2.2.23)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ServerUtilities/pull/275 (2.2.22)
>* Fixed typos in pregen command by @aidenfarley in https://github.com/GTNewHorizons/ServerUtilities/pull/272 (2.2.21)
>* Fix offline account merging by @Caedis in https://github.com/GTNewHorizons/ServerUtilities/pull/265 (2.2.20)
>* Fixed Right Click Coordinates Logging... by @StoneLegion in https://github.com/GTNewHorizons/ServerUtilities/pull/269 (2.2.19)
>* Update GUI textures to use local ones by @Ranzuu in https://github.com/GTNewHorizons/ServerUtilities/pull/266 (2.2.19)
...
>* Fix paths in README by @oddstr13 in https://github.com/GTNewHorizons/ServerUtilities/pull/252 (2.2.6)
...
# Updated - Share-Where-I-am - 2.1.4 --> 2.1.6
**Full Changelog**: https://github.com/GTNewHorizons/Share-Where-I-am/compare/2.1.4...2.1.6
...
## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/SimpleSkinBackport/pull/2 (1.0.2-GTNH)
>* Fix memory leak in ImageBufferDownloadPlayerSkin by @Alexdoru in https://github.com/GTNewHorizons/SimpleSkinBackport/pull/1 (1.0.1-GTNH)

# Updated - SleepingBags - 0.3.0 --> 0.3.1
**Full Changelog**: https://github.com/GTNewHorizons/SleepingBags/compare/0.3.0...0.3.1

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/SleepingBags/pull/8 (0.3.1)

# Updated - SpecialMobs - 3.6.3 --> 3.7.4
**Full Changelog**: https://github.com/GTNewHorizons/SpecialMobs/compare/3.6.3...3.7.4

## What's Changed:
>* add SpecialMobData data flag if mob is immune to all potions by @Alexdoru in https://github.com/GTNewHorizons/SpecialMobs/pull/31 (3.7.4)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/SpecialMobs/pull/30 (3.7.3)
...
# Updated - SpiceOfLife - 2.2.3-carrot --> 2.2.9-carrot
**Full Changelog**: https://github.com/GTNewHorizons/SpiceOfLife/compare/2.2.3-carrot...2.2.9-carrot

## What's Changed:
>* Update NEI tooltip cache when food is eaten by @Caedis in https://github.com/GTNewHorizons/SpiceOfLife/pull/55 (2.2.9-carrot)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/SpiceOfLife/pull/54 (2.2.8-carrot)
>* Lunchbox Crash Prevention by @UltraProdigy in https://github.com/GTNewHorizons/SpiceOfLife/pull/53 (2.2.7-carrot)

# Updated - Steve-s-Factory-Manager - 1.3.4-GTNH --> 1.3.12-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Steve-s-Factory-Manager/compare/1.3.4-GTNH...1.3.12-GTNH

## What's Changed:
>* Change fake player UUID to be non-null by @carbotaniuman in https://github.com/GTNewHorizons/Steve-s-Factory-Manager/pull/21 (1.3.12-GTNH)
>* Fix block breaker causing Block.breakBlock to be called twice by @DarkShadow44 in https://github.com/GTNewHorizons/Steve-s-Factory-Manager/pull/22 (1.3.11-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Steve-s-Factory-Manager/pull/20 (1.3.10-GTNH)
>* Increase max number of buckets by @YamiKami-Sama in https://github.com/GTNewHorizons/Steve-s-Factory-Manager/pull/19 (1.3.9-GTNH)
>* Added Optional command title localization by @Ranzuu in https://github.com/GTNewHorizons/Steve-s-Factory-Manager/pull/17 (1.3.8-GTNH)
>* Fix timer counting in Machine Inventory Manager by @Yoshy2002 in https://github.com/GTNewHorizons/Steve-s-Factory-Manager/pull/18 (1.3.6-GTNH)

# Updated - StevesAddons - 0.14.2 --> 0.15.5
**Full Changelog**: https://github.com/GTNewHorizons/StevesAddons/compare/0.14.2...0.15.5

## What's Changed:
>* Only send strings in LabelSyncMessage by @tiffit in https://github.com/GTNewHorizons/StevesAddons/pull/19 (0.15.5)
>* Update by @Dream-Master in https://github.com/GTNewHorizons/StevesAddons/pull/18 (0.15.4)
>* Fix Scala Check & Optimize Images by @UltraProdigy in https://github.com/GTNewHorizons/StevesAddons/pull/17 (0.15.3)
...
# Updated - StorageDrawers - 2.1.10-GTNH --> 2.2.25-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/StorageDrawers/compare/2.1.10-GTNH...2.2.25-GTNH

## What's Changed:
>* Add render distance config and facing check for render by @zach2039 in https://github.com/GTNewHorizons/StorageDrawers/pull/72 (2.2.25-GTNH)
>* Fix chisel recipes missing by @Alexdoru in https://github.com/GTNewHorizons/StorageDrawers/pull/71 (2.2.24-GTNH)
>* Move Module Loader to Pre-intialization by @NotKaizul in https://github.com/GTNewHorizons/StorageDrawers/pull/69 (2.2.23-GTNH)
...
# Updated - StructureLib - 1.4.23 --> 1.4.37
**Full Changelog**: https://github.com/GTNewHorizons/StructureLib/compare/1.4.23...1.4.37

## What's Changed:
>* Add Context Parameter to get Description by @Luca-Guettinger in https://github.com/GTNewHorizons/StructureLib/pull/60 (1.4.37)
...
# Updated - Super-TiC - 1.5.0 --> 1.5.4
**Full Changelog**: https://github.com/GTNewHorizons/Super-TiC/compare/1.5.0...1.5.4
...
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - TCNodeTracker - 1.4.0 --> 1.4.5
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/TCNodeTracker/compare/1.4.0...1.4.5

## What's Changed:
>* Add cleanup of TC files on world deletion & Refactor some Path handling by @Algent in https://github.com/GTNewHorizons/TCNodeTracker/pull/16 (1.4.5)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/TCNodeTracker/pull/15 (1.4.4)
>* Scholar's lens support by @simojoki in https://github.com/GTNewHorizons/TCNodeTracker/pull/14 (1.4.3)
>* Use original world name in SinglePlayer by @DarkShadow44 in https://github.com/GTNewHorizons/TCNodeTracker/pull/13 (1.4.2)

# Updated - TX-Loader - 1.8.5 --> 1.8.11
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/TX-Loader/compare/1.8.5...1.8.11

## What's Changed:
>* Improve performance of TXResourcePack.resourceExists by @tiffit in https://github.com/GTNewHorizons/TX-Loader/pull/23 (1.8.11)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/TX-Loader/pull/22 (1.8.10)
...
# Updated - Tainted-Magic - 7.6.26-GTNH --> 7.7.8-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/Tainted-Magic/compare/7.6.26-GTNH...7.7.8-GTNH

## What's Changed:
>* Remove spacesuit from fortress armor and voidmetal goggles by @FourIsTheNumber in https://github.com/GTNewHorizons/Tainted-Magic/pull/48 (7.7.8-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Tainted-Magic/pull/47 (7.7.7-GTNH)
>* [Tainted Magic] Fix Thaumic Disassembler not being able to break certain blocks. by @thenextelement in https://github.com/GTNewHorizons/Tainted-Magic/pull/46 (7.7.6-GTNH)
>* use bfs leaf decay from nh lib by @Alexdoru in https://github.com/GTNewHorizons/Tainted-Magic/pull/45 (7.7.5-GTNH)
>* fix typos by @Yoshy2002 in https://github.com/GTNewHorizons/Tainted-Magic/pull/44 (7.7.4-GTNH)
>* respect step assist config and make it on by default by @danyadev in https://github.com/GTNewHorizons/Tainted-Magic/pull/42 (7.7.3-GTNH)
>* yeet update checker by @danyadev in https://github.com/GTNewHorizons/Tainted-Magic/pull/43 (7.7.3-GTNH)
...
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - ThaumicBases - 1.8.13 --> 1.9.18
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicBases/compare/1.8.13...1.9.18

## What's Changed:
>* OVerenchanter Fix Crash insert by automation by @PLASMAchicken in https://github.com/GTNewHorizons/ThaumicBases/pull/67 (1.9.18)
>* Fix quicksilverBrick rendering over Draconic Evolution core effects by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicBases/pull/66 (1.9.17)
...
# Updated - ThaumicBoots - 1.4.14 --> 1.5.12
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicBoots/compare/1.4.14...1.5.12

## What's Changed:
>* Remove spacesuit from nano armor by @FourIsTheNumber in https://github.com/GTNewHorizons/ThaumicBoots/pull/54 (1.5.12)
>* Swap TCNEIAdditions for AspectRecipeIndex by @tiffit in https://github.com/GTNewHorizons/ThaumicBoots/pull/53 (1.5.11)
>* Fix `Config.gtnhLibActive` using wrong config name by @unilock in https://github.com/GTNewHorizons/ThaumicBoots/pull/52 (1.5.11)
>* Fix step assist not working for ThaumicBoots by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicBoots/pull/51 (1.5.10)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ThaumicBoots/pull/49 (1.5.9)
...
# Updated - ThaumicEnergistics - 1.7.14-GTNH --> 1.7.53-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicEnergistics/compare/1.7.14-GTNH...1.7.53-GTNH

## What's Changed:
>* Adapt to GUIColor changes by @Ranzuu in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/134 (1.7.53-GTNH)
>* ec2 compatibility by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/133 (1.7.52-GTNH)
>* adapt by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/131 (1.7.51-GTNH)
>* Fix crash with EndlessIds by @YannickMG in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/132 (1.7.50-GTNH)
>* Clean up by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/130 (1.7.49-GTNH)
>* Fix Cell Microscope drive scan by @Kogepan229 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/127 (1.7.48-GTNH)
>* Cell Restriction rework by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/129 (1.7.47-GTNH)
>* Fix NEP when read cell config by @Kogepan229 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/128 (1.7.46-GTNH)
>* Infusion Provider Lore by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/124 (1.7.45-GTNH)
>* Infusion Provider Lore by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/124 (1.7.44-GTNH)
>* add test stack by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/126 (1.7.43-GTNH)
>* Legacy stack type by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/123 (1.7.42-GTNH)
>* Fix Arcane Crafting Terminal Transfer Item BUG by @czqwq in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/121 (1.7.42-GTNH)
...
>* Drop items in slots when breaking Arcane Crafting Terminal by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/118 (1.7.37-GTNH)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/115 (1.7.36-GTNH)
>* Fix ARI support in Arcane Terminal by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/114 (1.7.36-GTNH)
>* Replace SlotArcaneCraftingGrid with SlotCraftingMatrix by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/113 (1.7.35-GTNH)
>* Distillation Pattern Encoder Fixes by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/112 (1.7.34-GTNH)
>* Add support for Aspect Recipe Index by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/111 (1.7.33-GTNH)
>* Fix sometimes arcana assembler can void by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/109 (1.7.32-GTNH)
>* pattern info color by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/110 (1.7.32-GTNH)
>* Allow swap wand caps in arcana terminal by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/107 (1.7.31-GTNH)
>* Replace Baubles dependency with Baubles-Expanded by @Nikolay-Sitnikov in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/108 (1.7.29-GTNH)
>* ExtraCells2 compatibility by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/105 (1.7.28-GTNH)
>* fix ghosts item, remove deprecated, update hard deps by @lc-1337 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/104 (1.7.28-GTNH)
>* Fix Encoder crash by @Kogepan229 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/106 (1.7.28-GTNH)
>* Native Essentia by @Kogepan229 in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/98 (1.7.27-GTNH)
...
# Updated - ThaumicHorizons - 1.7.9 --> 1.8.20
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicHorizons/compare/1.7.9...1.8.20

## What's Changed:
>* Fix null wand components by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicHorizons/pull/126 (1.8.20)
...
>* Fix vortex flicker on chunk reload and stabilizer sync by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicHorizons/pull/116 (1.8.16)
>* Fix remaining gateway portal texture bugs by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicHorizons/pull/119 (1.8.16)
>* Clean up decompiler artifacts in TileVortex files by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicHorizons/pull/117 (1.8.16)
>* Fix stabilizer restoring hungry node type when second stabilizer is still active by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicHorizons/pull/121 (1.8.16)
>* Fix pocket plane keystone binding, portal bugs and world saving by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ThaumicHorizons/pull/114 (1.8.15)
>* Fix NPE in generatePocketPlane during async vortex creation by @ROBERT-PARKOURCIVILIZATIONGOD in https://github.com/GTNewHorizons/ThaumicHorizons/pull/111 (1.8.14)
>* Fix two world leaks by @Alexdoru in https://github.com/GTNewHorizons/ThaumicHorizons/pull/110 (1.8.14)
>* Corrected guis bounds by @Ranzuu in https://github.com/GTNewHorizons/ThaumicHorizons/pull/109 (1.8.13)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ThaumicHorizons/pull/108 (1.8.12)
...
# Updated - ThaumicTinkerer - 2.11.27 --> 2.12.22
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicTinkerer/compare/2.11.27...2.12.22

## What's Changed:
>* Remove version checker by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/95 (2.12.22)
>* Fix infused crops dropping nothing or items with incorrect weights by @Tahkeh in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/90 (2.12.21)
>* Fix memory leak by @Alexdoru in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/91 (2.12.20)
>* Only spawn effects on client side by @DarkShadow44 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/89 (2.12.19)
>* Fix wrong stack sizes for ichor recipe by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/88 (2.12.18)
>* Fix infused seeds inheriting NBT tags of the previously broken crop by @Tahkeh in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/82 (2.12.17)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/87 (2.12.17)
>* Fix infused seeds inheriting NBT tags of the previously broken crop by @Tahkeh in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/82 (2.12.16)
>* Fix spellbinding cloth's recipe taking a size 0 itemstack as catalyst by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/86 (2.12.15)
>* en_GB localization by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/85 (2.12.15)
>* Fix ichor cap texture alignment by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/84 (2.12.14)
>* Final Strike now scales linearly with level by @thehoblit in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/83 (2.12.13)
>* Improve Wand Focus: Experience Drain by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/80 (2.12.12)
>* Better item registry by @sisyphussy in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/64 (2.12.9)
>* Infused Crop growth bugfix by @koolkrafter5 in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/81 (2.12.8)
...
# Updated - Tinkers-Defense - 1.3.2 --> 1.3.4
**Full Changelog**: https://github.com/GTNewHorizons/Tinkers-Defense/compare/1.3.2...1.3.4
...
>* Correctly loot registration by @slprime in https://github.com/GTNewHorizons/TinkersConstruct/pull/283 (1.14.68-GTNH)
>* fix(InventoryCraftingStation): add missing markDirty by @Worive in https://github.com/GTNewHorizons/TinkersConstruct/pull/284 (1.14.66-GTNH)
...
>* Fix smeltery fuel gauge to account for all lava tanks by @Eldrinn-Elantey in https://github.com/GTNewHorizons/TinkersConstruct/pull/273 (1.14.58-GTNH)
>* nei+toolforge bug fix by @ROBERT-PARKOURCIVILIZATIONGOD in https://github.com/GTNewHorizons/TinkersConstruct/pull/274 (1.14.56-GTNH)
>* Prevent tinkerer's glove from applying when initial mining speed is zero by @ImaMapleTree in https://github.com/GTNewHorizons/TinkersConstruct/pull/269 (1.14.54-GTNH)
>* Prevent tinkerer's glove from applying when initial mining speed is zero by @ImaMapleTree in https://github.com/GTNewHorizons/TinkersConstruct/pull/269 (1.14.52-GTNH)
>* fix: allows lumber axe to chop down trees with horizontal sections by @ohentis in https://github.com/GTNewHorizons/TinkersConstruct/pull/224 (1.14.50-GTNH)
>* Effects system for concentrated essence berries by @Gamingb3ast in https://github.com/GTNewHorizons/TinkersConstruct/pull/194 (1.14.48-GTNH)
>* fixed quartz modifier not adding attack due to overflow by @imTheSupremeOne in https://github.com/GTNewHorizons/TinkersConstruct/pull/250 (1.14.46-GTNH)
>* Reduce Certus Quartz Attack Boost from 24 -> 4 by @UltraProdigy in https://github.com/GTNewHorizons/TinkersConstruct/pull/268 (1.14.46-GTNH)
...
>* Added optional Nei color localization by @Ranzuu in https://github.com/GTNewHorizons/TinkersConstruct/pull/254 (1.14.32-GTNH)
...
>* Fix 3rd person translucency bug by @SuperSoupr in https://github.com/GTNewHorizons/TinkersConstruct/pull/237 (1.14.17-GTNH)
>* Sync changes to ammo in baubles inventory by @DarkShadow44 in https://github.com/GTNewHorizons/TinkersConstruct/pull/236 (1.14.17-GTNH)
>* delete unused event registration by @Alexdoru in https://github.com/GTNewHorizons/TinkersConstruct/pull/235 (1.14.15-GTNH)
...
# Updated - TinkersMechworks - 0.4.1 --> 0.4.2
**Full Changelog**: https://github.com/GTNewHorizons/TinkersMechworks/compare/0.4.1...0.4.2

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/TinkersMechworks/pull/9 (0.4.2)
...
# Updated - Translocators - 1.3.1 --> 1.4.4
**Full Changelog**: https://github.com/GTNewHorizons/Translocators/compare/1.3.1...1.4.4

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Translocators/pull/11 (1.4.4)
>* Make Fluid Translocator's rate can be update with GT fluid cover by @PinkYuDeer in https://github.com/GTNewHorizons/Translocators/pull/10 (1.4.3)

# Updated - UniLib - 1.1.1 --> 1.2.1
Mod is client-side only.
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
...
## What's Changed:
DreamAssemblerXXL wasn't able to find the changelog related to this update. It is usually caused by updates done outside of pull-requests or if the mod is maintained by a 3rd party.
# Updated - Universal-Singularities - 8.10.0 --> 8.15.1
**Full Changelog**: https://github.com/GTNewHorizons/Universal-Singularities/compare/8.10.0...8.15.1

## What's Changed:
>* fix typo in uhv singularity name by @Auynonymous in https://github.com/GTNewHorizons/Universal-Singularities/pull/19 (8.15.1)
>* Add Circuit Computation Singularities by @Auynonymous in https://github.com/GTNewHorizons/Universal-Singularities/pull/18 (8.15.0)
...
>* Tab icon hover animation by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/116 (0.4.72)
>* Add interaction sound effects by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/109 (0.4.71)
>* Reset color state in TradeItemDisplayWidget by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/113 (0.4.71)
>* Music volume pop-up panel by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/110 (0.4.71)
>* Animated coin displays by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/111 (0.4.71)
>* Updated wallet button icons by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/107 (0.4.70)
>* Scroll to top when searchbar changes by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/106 (0.4.70)
>* fix nei bookmarks covering the qol buttons and trade tabs by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/105 (0.4.69)
>* Cooldown scaling for teams by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/103 (0.4.68)
>* Vending Machine Music by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/99 (0.4.67)
>* Override getWailaBody for MTEVendingMachine by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/98 (0.4.67)
>* add wallet button icons by @tiffit in https://github.com/GTNewHorizons/VendingMachine/pull/100 (0.4.67)
...
>* fix no condition trades by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/90 (0.4.63)
>* Refactor styling by @Ranzuu in https://github.com/GTNewHorizons/VendingMachine/pull/86 (0.4.62)
>* Swap out slot labels and refactor deprecated methods by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/84 (0.4.61)
>* Add styling by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/82 (0.4.60)
>* Fix drops on vending machine break by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/81 (0.4.59)
>* chore(fix): prevent unwanted inventory hotkey caused gui close by @Nana-Sakura in https://github.com/GTNewHorizons/VendingMachine/pull/80 (0.4.58)
>* Fixed crash due to mui2 upstream sync by @TheYoingLad in https://github.com/GTNewHorizons/VendingMachine/pull/79 (0.4.57)
>* Fix server memory leak by @Alexdoru in https://github.com/GTNewHorizons/VendingMachine/pull/77 (0.4.56)
>* Show trades which share a cooldown by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/76 (0.4.55)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/VendingMachine/pull/75 (0.4.54)
>* Impr(Textures): Adapt GT5U OptionalResource by @leagris in https://github.com/GTNewHorizons/VendingMachine/pull/74 (0.4.53)
>* bump GT to account for https://github.com/GTNewHorizons/GT5-Unofficial/pull/5781 by @boubou19 in https://github.com/GTNewHorizons/VendingMachine/pull/73 (0.4.52)
>* Support all coins for NEI trade preview by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/70 (0.4.51)
>* Favourites tab by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/68 (0.4.50)
>* Fix item ejecting direction by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/67 (0.4.49)
>* Check if player is not accessing vending machine before reloading tradestate by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/66 (0.4.48)
...
>* Refactored commands by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/54 (0.4.33)
>* Add restock notifications by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/53 (0.4.32)
>* Add Oredict tooltips by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/49 (0.4.30)
>* Increased slot count to 8 by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/50 (0.4.30)
>* swap to getstacks by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/51 (0.4.30)
>* Fixed oredict crash by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/52 (0.4.30)
>* Trade Logic Fixes by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/47 (0.4.29)
>* [Chore] Pull inner classes that are used elsewhere out of their parent classes by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/46 (0.4.28)
>* Make Configs editable from in-game by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/45 (0.4.27)
>* Add author by @cubefury in https://github.com/GTNewHorizons/VendingMachine/pull/44 (0.4.26)
...
# New Mod - VillageNames:4.5.15-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/VillageNames/compare/4.5.0-GTNH-pre...4.5.15-GTNH

## What's Changed:
>* fix class cast crash in EntityMonitorHandler by @Alexdoru in https://github.com/GTNewHorizons/VillageNames/pull/13 (4.5.15-GTNH)
...
>* Add team sharing of players prospection findings using GTNHLib Teams by @Algent in https://github.com/GTNewHorizons/VisualProspecting/pull/85 (1.5.22)
>* Add cleanup of VP files on WorldDeletionEvent by @Algent in https://github.com/GTNewHorizons/VisualProspecting/pull/82 (1.5.21)
>* Fix registering vein on VeinGenerateEvent by @Algent in https://github.com/GTNewHorizons/VisualProspecting/pull/83 (1.5.21)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/VisualProspecting/pull/81 (1.5.20)
>* Prevent crash when search input is an invalid regex pattern by @Algent in https://github.com/GTNewHorizons/VisualProspecting/pull/80 (1.5.19)
>* [Sub-PR] Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/VisualProspecting/pull/79 (1.5.18)
>* Replace MTEScanner mixin with handler for scanner refactor PR by @C0bra5 in https://github.com/GTNewHorizons/VisualProspecting/pull/77 (1.5.17)
>* Fix ores being unscannable in spawn chunks, and incorrect cache-rebuilding logic. by @C0bra5 in https://github.com/GTNewHorizons/VisualProspecting/pull/78 (1.5.14)
...
# Updated - WAILAPlugins - 0.6.0 --> 0.7.2
**Full Changelog**: https://github.com/GTNewHorizons/WAILAPlugins/compare/0.6.0...0.7.2

## What's Changed:
>* Don't skip empty tanks for fluid bars by @MalTeeez in https://github.com/GTNewHorizons/WAILAPlugins/pull/23 (0.7.2)
...
# Updated - WAWLA - 1.3.1-GTNH --> 1.3.3-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/WAWLA/compare/1.3.1-GTNH...1.3.3-GTNH
...
# Updated - WailaHarvestability - 1.3.4-GTNH --> 1.3.6-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/WailaHarvestability/compare/1.3.4-GTNH...1.3.6-GTNH

## What's Changed:
>* Fix natural GT ores not showing mining level by @tiffit in https://github.com/GTNewHorizons/WailaHarvestability/pull/12 (1.3.6-GTNH)
>* Fix gregtech blocks showing incorrect harvest info by @tiffit in https://github.com/GTNewHorizons/WailaHarvestability/pull/11 (1.3.5-GTNH)

# Updated - WanionLib - 1.10.0 --> 1.10.1
**Full Changelog**: https://github.com/GTNewHorizons/WanionLib/compare/1.10.0...1.10.1
...
# Updated - WirelessCraftingTerminal - 1.12.7 --> 1.12.16
**Full Changelog**: https://github.com/GTNewHorizons/WirelessCraftingTerminal/compare/1.12.7...1.12.16

## What's Changed:
>* Fix item transfer by @Kogepan229 in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/51 (1.12.16)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/52 (1.12.15)
>* Fix magnet mode chat messages not translating on multiplayer servers by @Eldrinn-Elantey in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/50 (1.12.14)
>* fix log spam by @lc-1337 in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/49 (1.12.13)
>* Fix container interaction tooltip by @lc-1337 in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/48 (1.12.13)
>* fix terminal in baubles & update hard deps by @lc-1337 in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/46 (1.12.12)
>* Fix primary gui by @Kogepan229 in https://github.com/GTNewHorizons/WirelessCraftingTerminal/pull/47 (1.12.12)
...
# Updated - WirelessRedstone-CBE - 1.7.1 --> 1.7.6
**Full Changelog**: https://github.com/GTNewHorizons/WirelessRedstone-CBE/compare/1.7.1...1.7.6

## What's Changed:
>* fix receiver npe on chunk unload by @alppp in https://github.com/GTNewHorizons/WirelessRedstone-CBE/pull/19 (1.7.6)
...
>* Use correct mixin extras by @Alexdoru in https://github.com/GTNewHorizons/WitcheryExtras/pull/36 (1.4.9)
>* Add way to force disable blocks; disable silver vat by @Caedis in https://github.com/GTNewHorizons/WitcheryExtras/pull/33 (1.4.7)
>* Remove log spam by @Alexdoru in https://github.com/GTNewHorizons/WitcheryExtras/pull/32 (1.4.5)
>* Properly remap distillery mixin by @ah-OOG-ah in https://github.com/GTNewHorizons/WitcheryExtras/pull/31 (1.4.3)
...
>* CropsNH Integration/IC2 Depreciation by @C0bra5 in https://github.com/GTNewHorizons/WitchingGadgets/pull/120 (1.8.38-GTNH)
>* Update postea handlers for new version. by @C0bra5 in https://github.com/GTNewHorizons/WitchingGadgets/pull/115 (1.8.37-GTNH)
...
>* Don't make labels unstackable after insertion into the Aspect Library by @devpikachu in https://github.com/GTNewHorizons/WitchingGadgets/pull/109 (1.8.18-GTNH)
>* TileEntityLabelLibrary add proper isItemValidForSlot check by @PLASMAchicken in https://github.com/GTNewHorizons/WitchingGadgets/pull/105 (1.8.16-GTNH)
>* Rebalance Falling and Flying Speed by @SST-03 in https://github.com/GTNewHorizons/WitchingGadgets/pull/99 (1.8.14-GTNH)
>* Fix fallback behaviour of nugget tranmutation aspects by @Nockyx in https://github.com/GTNewHorizons/WitchingGadgets/pull/104 (1.8.13-GTNH)
...
# Updated - Yamcl - 0.7.1 --> 0.7.5
**Full Changelog**: https://github.com/GTNewHorizons/Yamcl/compare/0.7.1...0.7.5

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/Yamcl/pull/9 (0.7.5)
...
>* add isUseableByPlayer to TileEntityGravitation by @tiffit in https://github.com/GTNewHorizons/amunra/pull/43 (0.8.10)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/amunra/pull/40 (0.8.9)
>* Schematics by @Ranzuu in https://github.com/GTNewHorizons/amunra/pull/39 (0.8.8)
...
# Updated - gendustry - 1.9.4-GTNH --> 1.9.9-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/gendustry/compare/1.9.4-GTNH...1.9.9-GTNH

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/gendustry/pull/21 (1.9.9-GTNH)
>* Add info to tooltips by @Eldrinn-Elantey in https://github.com/GTNewHorizons/gendustry/pull/20 (1.9.8-GTNH)
>* Separated localization strings tile vs title by @Ranzuu in https://github.com/GTNewHorizons/gendustry/pull/19 (1.9.7-GTNH)

# Updated - harvestcraft - 1.3.2-GTNH --> 1.3.11-GTNH
**Full Changelog**: https://github.com/GTNewHorizons/harvestcraft/compare/1.3.2-GTNH...1.3.11-GTNH

## What's Changed:
>* Update NEI Handlers by @Ranzuu in https://github.com/GTNewHorizons/harvestcraft/pull/72 (1.3.11-GTNH)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/harvestcraft/pull/71 (1.3.10-GTNH)
>* Clean UI by @DrParadox7 in https://github.com/GTNewHorizons/harvestcraft/pull/69 (1.3.9-GTNH)
>* Brewing Microcrafting by @DrParadox7 in https://github.com/GTNewHorizons/harvestcraft/pull/67 (1.3.8-GTNH)
...
# Updated - ironchest - 6.1.6 --> 6.1.13
**Full Changelog**: https://github.com/GTNewHorizons/ironchest/compare/6.1.6...6.1.13

## What's Changed:
>* Fix Russian localization for Iron Chest items by @Eldrinn-Elantey in https://github.com/GTNewHorizons/ironchest/pull/41 (6.1.13)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/ironchest/pull/39 (6.1.12)
>* fix : don't sort the values array by @Alexdoru in https://github.com/GTNewHorizons/ironchest/pull/38 (6.1.11)
>* cache more IronChestType#values() by @Alexdoru in https://github.com/GTNewHorizons/ironchest/pull/37 (6.1.10)
>* cache IronChestType#values() by @Alexdoru in https://github.com/GTNewHorizons/ironchest/pull/36 (6.1.9)
...
>* Security: Add checksum validation to downloaded libraries by @FalsePattern in https://github.com/GTNewHorizons/lwjgl3ify/pull/333 (3.0.19)
>* Optimize shouldTransformClass by @danyadev in https://github.com/GTNewHorizons/lwjgl3ify/pull/331 (3.0.19)
>* Fixed Scrolling on Ubuntu  by @Redderpears in https://github.com/GTNewHorizons/lwjgl3ify/pull/330 (3.0.18)
>* Fix Chinese IME support for non-TextField GUIs (Signs, Books, Xaero's) by @qiuxtao in https://github.com/GTNewHorizons/lwjgl3ify/pull/321 (3.0.16)
...
>* Switch to stable lwjgl 3.4.0 by @eigenraven in https://github.com/GTNewHorizons/lwjgl3ify/pull/303 (3.0.7)
>* Don't use scancodes for certain keys by @sbancuz in https://github.com/GTNewHorizons/lwjgl3ify/pull/292 (3.0.5)
>* Fix key display names in the settings menu by @eigenraven in https://github.com/GTNewHorizons/lwjgl3ify/pull/287 (3.0.3)
>* Remove the gtnhlib dependency by @eigenraven in https://github.com/GTNewHorizons/lwjgl3ify/pull/288 (3.0.3)
>* Include the version number in the -api jar to fix curseforge publishing by @eigenraven in https://github.com/GTNewHorizons/lwjgl3ify/pull/289 (3.0.3)
>* Fix key input handling in OpenComputers monitors by @eigenraven in https://github.com/GTNewHorizons/lwjgl3ify/pull/290 (3.0.3)
...
>* Added discrete scrolling option. by @nullTheCoder in https://github.com/GTNewHorizons/lwjgl3ify/pull/251 (3.0.0)
>* Update LiteLoader compatibility section in README by @PLASMAchicken in https://github.com/GTNewHorizons/lwjgl3ify/pull/267 (3.0.0)
>* feat: Add java-runtime-epsilon to custom prism minecraft json by @DioEgizio in https://github.com/GTNewHorizons/lwjgl3ify/pull/279 (3.0.0)
>* Update LiteLoader compatibility section in README by @PLASMAchicken in https://github.com/GTNewHorizons/lwjgl3ify/pull/267 (3.0.0-beta.9)
>* Mention that runClient17 is a no-op by @wlhlm in https://github.com/GTNewHorizons/lwjgl3ify/pull/245 (3.0.0-beta.8)
>* Added discrete scrolling option. by @nullTheCoder in https://github.com/GTNewHorizons/lwjgl3ify/pull/251 (3.0.0-beta.8)
...
# Updated - nei-custom-diagram - 1.7.5 --> 1.8.29
**Full Changelog**: https://github.com/GTNewHorizons/nei-custom-diagram/compare/1.7.5...1.8.29

## What's Changed:
>* Remove Custom ScrollBar by @slprime in https://github.com/GTNewHorizons/nei-custom-diagram/pull/72 (1.8.29)
>* Localization by @Ranzuu in https://github.com/GTNewHorizons/nei-custom-diagram/pull/73 (1.8.27)
>* Create Worldgen Loot Diagram by @slprime in https://github.com/GTNewHorizons/nei-custom-diagram/pull/70 (1.8.26)
>* Optimize world load by @danyadev in https://github.com/GTNewHorizons/nei-custom-diagram/pull/67 (1.8.25)
>* Add new boards and pico, quantum and planck circuits by @GDCloudstrike in https://github.com/GTNewHorizons/nei-custom-diagram/pull/69 (1.8.21)
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/nei-custom-diagram/pull/68 (1.8.20)
>* [Sub-PR] Reduce the size of the GregTech.lang, and standardize the Line Break, etc. by @iouter in https://github.com/GTNewHorizons/nei-custom-diagram/pull/66 (1.8.19)
>* Refactored server support by @fengluo2 in https://github.com/GTNewHorizons/nei-custom-diagram/pull/56 (1.8.18)
>* Added documentation for previous pr by @TheYoingLad in https://github.com/GTNewHorizons/nei-custom-diagram/pull/65 (1.8.17)
>* Added missing components to the ore processing diagram by @TheYoingLad in https://github.com/GTNewHorizons/nei-custom-diagram/pull/63 (1.8.16)
>* cache enum values by @Alexdoru in https://github.com/GTNewHorizons/nei-custom-diagram/pull/64 (1.8.15)
>* Remove fluid canner map refs by @FourIsTheNumber in https://github.com/GTNewHorizons/nei-custom-diagram/pull/62 (1.8.12)
...
# Updated - neiaddons - 1.17.0 --> 1.18.1
**Full Changelog**: https://github.com/GTNewHorizons/neiaddons/compare/1.17.0...1.18.1

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/neiaddons/pull/13 (1.18.1)
>* Correctly detect active stack for tooltip by @slprime in https://github.com/GTNewHorizons/neiaddons/pull/12 (1.18.0)

# Updated - oauth - 1.3.3-GTNH --> 1.3.4-GTNH
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/oauth/compare/1.3.3-GTNH...1.3.4-GTNH

## What's Changed:
>* Optimize Images and Workflow by @UltraProdigy in https://github.com/GTNewHorizons/oauth/pull/9 (1.3.4-GTNH)

# Updated - supersolarpanels - 1.1.4 --> 1.1.5
**Full Changelog**: https://github.com/GTNewHorizons/supersolarpanels/compare/1.1.4...1.1.5

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/supersolarpanels/pull/2 (1.1.5)

# Updated - thaumcraft-research-tweaks - 1.3.0 --> 1.3.2
**Full Changelog**: https://github.com/GTNewHorizons/thaumcraft-research-tweaks/compare/1.3.0...1.3.2

## What's Changed:
>* Fix JUnit Platform launcher for Gradle 9 compatibility by @TheElan in https://github.com/GTNewHorizons/thaumcraft-research-tweaks/pull/19 (1.3.2)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/thaumcraft-research-tweaks/pull/17 (1.3.1)

# Updated - thaumicinsurgence - 0.4.0 --> 0.4.1
**Full Changelog**: https://github.com/GTNewHorizons/thaumicinsurgence/compare/0.4.0...0.4.1

## What's Changed:
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/thaumicinsurgence/pull/46 (0.4.1)

# Updated - twilightforest - 2.7.13 --> 2.7.33
**Full Changelog**: https://github.com/GTNewHorizons/twilightforest/compare/2.7.13...2.7.33

## What's Changed:
>* Optimizations by @mitchej123 in https://github.com/GTNewHorizons/twilightforest/pull/134 (2.7.33)
...
>* Larger twilight portals by @LooseEthics in https://github.com/GTNewHorizons/twilightforest/pull/133 (2.7.25)
>* Optimize Image & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/twilightforest/pull/132 (2.7.23)
>* Update Timewood Clock to better reflect its description by @Caedis in https://github.com/GTNewHorizons/twilightforest/pull/131 (2.7.21)
>* [TConstruct Integration] Register tool materials *before* registering tool parts by @Charsy89 in https://github.com/GTNewHorizons/twilightforest/pull/130 (2.7.19)
...
# Updated - waila - 1.8.15 --> 1.19.30
**Full Changelog**: https://github.com/GTNewHorizons/waila/compare/1.8.15...1.19.30

## What's Changed:
>* Add compat for fluid colors for non GT5u fluids by @C0bra5 in https://github.com/GTNewHorizons/waila/pull/69 (1.19.30)
>* fix comparator "substractor" mode spelling by @flamingowrangler2869 in https://github.com/GTNewHorizons/waila/pull/70 (1.19.29)
>* Allow Waila to handle bigger NBT packet by @Algent in https://github.com/GTNewHorizons/waila/pull/68 (1.19.28)
>* Prevent overflowing of bars in tooltip renderers by @MalTeeez in https://github.com/GTNewHorizons/waila/pull/66 (1.19.27)
>* [Memory-opti:fix leak] fix client leak from DataAccessorFMP by @Alexdoru in https://github.com/GTNewHorizons/waila/pull/65 (1.19.26)
>* Added GUI config factory by @JackOfNoneTrades in https://github.com/GTNewHorizons/waila/pull/63 (1.19.25)
>* Fix Deps by @UltraProdigy in https://github.com/GTNewHorizons/waila/pull/62 (1.19.24)
>* Styling of text and buttons by @Ranzuu in https://github.com/GTNewHorizons/waila/pull/64 (1.19.24)
>* Optimize Images & Workflow by @UltraProdigy in https://github.com/GTNewHorizons/waila/pull/61 (1.19.23)
...
>* Use progress bars to render IEnergyInfo RF content by @MalTeeez in https://github.com/GTNewHorizons/waila/pull/55 (1.9.15)
>* Allow showing empty tanks via Fluid Bars by @MalTeeez in https://github.com/GTNewHorizons/waila/pull/51 (1.9.15)
...
# Credits
Special thanks to @0hwx, @12411234, @2ndDerivative, @3ricbae, @52871299hzy, @54M44R, @6C-C6, @aabushnell, @AbdielKavash, @AbdoDayem, @ABKQPO, @Ableytner, @Aerindor-of-Arcane, @agreeable-frog, @ah-OOG-ah, @aidenfarley, @Alexdoru, @alfarelcynthesis, @Algent, @ALongStringOfNumbers, @alppp, @Ameobea, @and-reas-se, @Angry3vilbot, @AnsonYeung, @Apis035, @arch1t3cht, @arisado, @Ashen-sysadmin, @asquared31415, @assusdan, @asukaonly, @Auynonymous, @bencimp, @Bjdufre1, @bk5115545, @Blubstr, @BlueWeabo, @bombcar, @boubou19, @Brabb3l, @brachy84, @branan, @brandyyn, @Breviel, @BroFaceMcgee, @broscolotos, @bumbleBee945, @C-Remilian, @C0bra5, @Caedis, @CaelixOrbit, @Calvin304, @cambech, @captainjolt, @carbotaniuman, @Cardinalstars, @cargocats, @ChaosTheLegend, @Charsy89, @Chi31415, @chochem, @ChromaPIE, @chrombread, @clawdbot-silly-waddle, @Cleptomania, @CN132DAS, @combusterf, @Connor-Colenso, @copi143, @cubefury, @czerwonogrodzki, @czqwq, @danyadev, @DarkShadow44, @DatLycan, @daxsc, @DeathFuel, @Deviouslrd, @devpikachu, @dfddgge, @DialecticalMaterialist, @dibbydoda, @DioEgizio, @dipo33, @Discreater, @doshibadev, @dragongod100, @Dragovorn, @Dream-Master, @Dredonkey, @DrParadox7, @DTK-MrRaccoon, @dvdmandt, @DylanTaylor1, @echeese, @Eclipse-Sol, @EdenExecutive, @eigenraven, @Eldrinn-Elantey, @embeddedt, @Emilgardis, @EmperorSuper, @EnderProyects, @Engineer12798, @envoidia, @EricC808, @Erixonich, @Ethryan, @evgengoldwar, @FabienChatton, @FalsePattern, @Faltsolph, @Faotik, @felixfour, @fengluo2, @Firenezz, @Flakxo, @flamingowrangler2869, @Florexiz, @FourIsTheNumber, @fowdre, @FrostyFire1, @Gamingb3ast, @gaogao-qwq, @GDCloudstrike, @Georggi, @Ghezra, @ghostflyby, @GirixK, @github-actions[bot], @Glease, @glektarssza, @glowredman, @Goldenlion5648, @GribanovIvan, @grimly, @GTNH-Afx237v7, @guid118, @guneykabel, @guusw, @ham-corp, @hanben02, @harrynull, @hinyb, @hiroscho, @ImaMapleTree, @imTheSupremeOne, @iouter, @iR3turnZ, @IX-git, @JackOfNoneTrades, @jamiehu427, @JeromeBollinger, @JL2210, @JMan-Zx, @JohnButlerThird, @Johnnycyan, @jordanamr, @jude123412, @june-dev-username, @Junyan721113, @JustACasualDay, @Kai-Z-JP, @KenzoWVY, @khaskelbergTAU, @KleinGrrmpf, @ko-lja, @Kogepan229, @konkers, @konradmoesch, @koolkrafter5, @kopatych3348, @kotmatross28729, @Krakenrek, @Krepyn, @kuba6000, @Kuliiuu, @KwazziAus, @kx08, @Kynake, @LazyFleshWasTaken, @lc-1337, @leagris, @LeonidMem, @lesteenman, @leumasme, @liryril1, @Litten95, @loenaaaa, @lonei-G, @LooseEthics, @ls-r, @Luca-Guettinger, @LunarLambda, @luoyangyuli2001, @Lyfts, @lynxx131, @Majora320, @malabudi, @MalTeeez, @mamiemru, @MarkinoTeck, @MarloGr, @MassAnarchyy, @maxashen, @MaxLunar, @maybemattie, @MCTBL, @MeiTianyou, @MellowArpeggiation, @mhowell9, @michaeldoylecs, @mikkerlo, @Miklebe, @miozune, @mist475, @mitchej123, @MLGfruitshoot, @mM4ri, @ModularityEnjoyer, @Morilli, @MuXiu1997, @Nana-Sakura, @NealDeal34, @NeOzay, @NeutronSelector, @Nightyyi, @Nikolay-Sitnikov, @noah-cope-dev, @Nockyx, @NotAPenguin0, @NotKaizul, @NovanOfLowat, @nshark, @nullTheCoder, @nwmqpa, @oddstr13, @ohentis, @OmdaCZ, @Omgise, @OneEyeMaker, @openblocki, @OTPANNIEXD, @PantACRO4life, @paulbatum, @pierrei, @PinkYuDeer, @PLASMAchicken, @PlayfulPiano, @purebluez, @Pxx500, @qiuxtao, @querns, @Quollveth, @rainbowjose, @Ranzuu, @re7gog, @RealSilverMoon, @RecursivePineapple, @Redderpears, @ReignOfFROZE, @rhobold, @riggzh, @Rikka-Kitani, @Roadhog360, @ROBERT-PARKOURCIVILIZATIONGOD, @Roelof033, @RSCCV, @Ruling-0, @Sanduhr32, @sawyergt, @sbancuz, @sbwaz, @serenibyss, @seventh-june, @ShadowQFT, @SHARKY-au, @Sheodar, @Shigure-Ruiseki, @simojoki, @Sinerum, @sisyphussy, @SkorchedEU, @SKProCH, @slprime, @SmileYik, @SomeonePerson123, @Sopel97, @SpacEagle17, @Spaghetti-OberNub, @Spicierspace153, @SST-03, @StaffiX, @StoneLegion, @sudojunior, @Sunrunner37, @SuperSoupr, @SvineruS, @SwingURM, @system64MC, @Tahkeh, @Taskeren, @TechLord22, @Teteros, @TheElan, @thehoblit, @thenextelement, @ThePixelbrain, @TheYoingLad, @thiago-solfo, @tiffit, @timb8g, @TKDMzq, @tomprince, @TotallyNotOndre, @tuodekun, @TweksTY, @Tyronadre, @UltraProdigy, @unilock, @unix-supremacist, @Viptunbeqwfwew, @Vlamonster, @VortexSo4, @vulcandragi, @WanderingHero, @WayneYam, @WhyDoLogic2, @wlhlm, @WNP78, @Worive, @Xlr11, @xronin01, @YamiKami-Sama, @YannickMG, @Yoshy2002, @youkoaona, @zach2039, @zacharylott94, @zyf051520, for their code contributions listed above, and to everyone else who helped, including all of our beta testers! <3
